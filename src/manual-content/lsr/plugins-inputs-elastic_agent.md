...
For other versions, see the [Versioned plugin docs](/vpr/input-elastic_agent-index.md).
...
::::{note} 
As of version `7.0.0` of this plugin, a number of previously deprecated settings related to SSL have been removed. Please check out [Beats Input Obsolete Configuration Options](plugins-inputs-elastic_agent.md#plugins-inputs-elastic_agent-obsolete-options) for details.
::::
...
| Setting | Replaced by |
| --- | --- |
| cipher_suites | [`ssl_cipher_suites`](plugins-inputs-elastic_agent.md#plugins-inputs-elastic_agent-ssl_cipher_suites) |
| ssl | [`ssl_enabled`](plugins-inputs-elastic_agent.md#plugins-inputs-elastic_agent-ssl_enabled) |
| ssl_peer_metadata | [`enrich`](plugins-inputs-elastic_agent.md#plugins-inputs-elastic_agent-enrich) |
| ssl_verify_mode | [`ssl_client_authentication`](plugins-inputs-elastic_agent.md#plugins-inputs-elastic_agent-ssl_client_authentication) |
| tls_max_version | [`ssl_supported_protocols`](plugins-inputs-elastic_agent.md#plugins-inputs-elastic_agent-ssl_supported_protocols) |
| tls_min_version | [`ssl_supported_protocols`](plugins-inputs-elastic_agent.md#plugins-inputs-elastic_agent-ssl_supported_protocols) |
...
| Setting | Input type | Required |
| --- | --- | --- |
| [`add_field`](plugins-inputs-elastic_agent.md#plugins-inputs-elastic_agent-add_field) | [hash](logstash://reference/configuration-file-structure.md#hash) | No |
| [`codec`](plugins-inputs-elastic_agent.md#plugins-inputs-elastic_agent-codec) | [codec](logstash://reference/configuration-file-structure.md#codec) | No |
| [`enable_metric`](plugins-inputs-elastic_agent.md#plugins-inputs-elastic_agent-enable_metric) | [boolean](logstash://reference/configuration-file-structure.md#boolean) | No |
| [`id`](plugins-inputs-elastic_agent.md#plugins-inputs-elastic_agent-id) | [string](logstash://reference/configuration-file-structure.md#string) | No |
| [`tags`](plugins-inputs-elastic_agent.md#plugins-inputs-elastic_agent-tags) | [array](logstash://reference/configuration-file-structure.md#array) | No |
| [`type`](plugins-inputs-elastic_agent.md#plugins-inputs-elastic_agent-type) | [string](logstash://reference/configuration-file-structure.md#string) | No |
