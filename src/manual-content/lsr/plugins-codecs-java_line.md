...
Set the desired text format for encoding in [`sprintf`](https://www.elastic.co/guide/en/logstash/current/event-dependent-configuration.md#sprintf) format.
