...
export function introPages(versionData, stackVersion) {
  Object.keys(versionData[stackVersion]).forEach(type => {
    ...
    content += '|---|---|---|\n'
    Object.keys(versionData[stackVersion][type]).sort().forEach(name => {
