...
| [`validate_after_inactivity`](v5-3-1-plugins-inputs-http_poller.md#v5.3.1-plugins-inputs-http_poller-validate_after_inactivity) | [number](/lsr/value-types.md#number) | No |
