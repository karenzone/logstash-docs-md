...
This plugin supports the following configuration options plus the [Common options](v3-0-2-plugins-filters-translate.md#v3.0.2-plugins-filters-translate-common-options) described later.
