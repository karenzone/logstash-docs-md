...
| :- | :- | :- |
| [`base64encode`](v3-4-0-plugins-filters-fingerprint.md#v3.4.0-plugins-filters-fingerprint-base64encode) | [boolean](/lsr/value-types.md#boolean) | No |
| [`concatenate_sources`](v3-4-0-plugins-filters-fingerprint.md#v3.4.0-plugins-filters-fingerprint-concatenate_sources) | [boolean](/lsr/value-types.md#boolean) | No |
| [`concatenate_all_fields`](v3-4-0-plugins-filters-fingerprint.md#v3.4.0-plugins-filters-fingerprint-concatenate_all_fields) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ecs_compatibility`](v3-4-0-plugins-filters-fingerprint.md#v3.4.0-plugins-filters-fingerprint-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`key`](v3-4-0-plugins-filters-fingerprint.md#v3.4.0-plugins-filters-fingerprint-key) | [string](/lsr/value-types.md#string) | No |
| [`method`](v3-4-0-plugins-filters-fingerprint.md#v3.4.0-plugins-filters-fingerprint-method) | [string](/lsr/value-types.md#string), one of `["SHA1", "SHA256", "SHA384", "SHA512", "MD5", "MURMUR3", "MURMUR3_128", IPV4_NETWORK", "UUID", "PUNCTUATION"]` | Yes |
| [`source`](v3-4-0-plugins-filters-fingerprint.md#v3.4.0-plugins-filters-fingerprint-source) | [array](/lsr/value-types.md#array) | No |
| [`target`](v3-4-0-plugins-filters-fingerprint.md#v3.4.0-plugins-filters-fingerprint-target) | [string](/lsr/value-types.md#string) | No |
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/current). See [Event Metadata and the Elastic Common Schema (ECS)](v3-4-0-plugins-filters-fingerprint.md#v3.4.0-plugins-filters-fingerprint-ecs_metadata) for detailed information.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-4-0-plugins-filters-fingerprint.md#v3.4.0-plugins-filters-fingerprint-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v3-4-0-plugins-filters-fingerprint.md#v3.4.0-plugins-filters-fingerprint-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v3-4-0-plugins-filters-fingerprint.md#v3.4.0-plugins-filters-fingerprint-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-4-0-plugins-filters-fingerprint.md#v3.4.0-plugins-filters-fingerprint-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v3-4-0-plugins-filters-fingerprint.md#v3.4.0-plugins-filters-fingerprint-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v3-4-0-plugins-filters-fingerprint.md#v3.4.0-plugins-filters-fingerprint-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v3-4-0-plugins-filters-fingerprint.md#v3.4.0-plugins-filters-fingerprint-remove_tag) | [array](/lsr/value-types.md#array) | No |
