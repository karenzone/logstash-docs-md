---
navigation_title: "v7.2.5"
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v7.2.5-plugins-filters-geoip.html
---

# Geoip filter plugin v7.2.5 [v7.2.5-plugins-filters-geoip]

* Plugin version: v7.2.5
* Released on: 2021-11-10
* [Changelog](https://github.com/logstash-plugins/logstash-filter-geoip/blob/v7.2.5/CHANGELOG.md)
...
## Database License [v7.2.5-plugins-filters-geoip-database_license]
...
## Database Auto-update [v7.2.5-plugins-filters-geoip-database_auto]
...
## Manage your own database updates [v7.2.5-plugins-filters-geoip-manage_update]
...
## Database Metrics [v7.2.5-plugins-filters-geoip-metrics]
...
## Geoip Filter Configuration Options [v7.2.5-plugins-filters-geoip-options]

This plugin supports the following configuration options plus the [Common options](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`cache_size`](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-cache_size) | [number](/lsr/value-types.md#number) | No |
| [`database`](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-database) | a valid filesystem path | No |
| [`default_database_type`](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-default_database_type) | `City` or `ASN` | No |
| [`ecs_compatibility`](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`fields`](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-fields) | [array](/lsr/value-types.md#array) | No |
| [`source`](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-source) | [string](/lsr/value-types.md#string) | Yes |
| [`tag_on_failure`](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-tag_on_failure) | [array](/lsr/value-types.md#array) | No |
| [`target`](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-target) | [string](/lsr/value-types.md#string) | No |

Also see [Common options](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-common-options) for a list of options supported by all filter plugins.

### `cache_size` [v7.2.5-plugins-filters-geoip-cache_size]
...
### `database` [v7.2.5-plugins-filters-geoip-database]
...
Database auto-update applies to default distribution. When `database` points to user’s database path, auto-update will be disabled. See [Database License](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-database_license) for more information.

### `default_database_type` [v7.2.5-plugins-filters-geoip-default_database_type]
...
### `fields` [v7.2.5-plugins-filters-geoip-fields]
...
### `ecs_compatibility` [v7.2.5-plugins-filters-geoip-ecs_compatibility]
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/current). The value of this setting affects the *default* value of [`target`](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-target).

### `source` [v7.2.5-plugins-filters-geoip-source]
...
### `tag_on_failure` [v7.2.5-plugins-filters-geoip-tag_on_failure]
...
### `target` [v7.2.5-plugins-filters-geoip-target]

* This is an optional setting with condition.

* Value type is [string](/lsr/value-types.md#string)

* Default value depends on whether [`ecs_compatibility`](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-ecs_compatibility) is enabled:
...
## Common options [v7.2.5-plugins-filters-geoip-common-options]

These configuration options are supported by all filter plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v7-2-5-plugins-filters-geoip.md#v7.2.5-plugins-filters-geoip-remove_tag) | [array](/lsr/value-types.md#array) | No |

### `add_field` [v7.2.5-plugins-filters-geoip-add_field]
...
### `add_tag` [v7.2.5-plugins-filters-geoip-add_tag]
...
### `enable_metric` [v7.2.5-plugins-filters-geoip-enable_metric]
...
### `id` [v7.2.5-plugins-filters-geoip-id]
...
### `periodic_flush` [v7.2.5-plugins-filters-geoip-periodic_flush]
...
### `remove_field` [v7.2.5-plugins-filters-geoip-remove_field]
...
### `remove_tag` [v7.2.5-plugins-filters-geoip-remove_tag]
