...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v7.2.1-plugins-codecs-cloudfront.html
---

# Cloudfront codec plugin v7.2.1 [v7.2.1-plugins-codecs-cloudfront]
