...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v3.11.1-plugins-codecs-netflow.html
applies_to:
  stack: ga
---

# Netflow codec plugin v3.11.1 [v3.11.1-plugins-codecs-netflow]

* Plugin version: v3.11.1
* Released on: 2018-02-01
* [Changelog](https://github.com/logstash-plugins/logstash-codec-netflow/blob/v3.11.1/CHANGELOG.md)
...
## Netflow Codec Configuration Options [v3.11.1-plugins-codecs-netflow-options]

| Setting | Input type | Required |
| :- | :- | :- |
| [`cache_save_path`](v3-11-1-plugins-codecs-netflow.md#v3.11.1-plugins-codecs-netflow-cache_save_path) | a valid filesystem path | No |
| [`cache_ttl`](v3-11-1-plugins-codecs-netflow.md#v3.11.1-plugins-codecs-netflow-cache_ttl) | [number](/lsr/value-types.md#number) | No |
| [`include_flowset_id`](v3-11-1-plugins-codecs-netflow.md#v3.11.1-plugins-codecs-netflow-include_flowset_id) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ipfix_definitions`](v3-11-1-plugins-codecs-netflow.md#v3.11.1-plugins-codecs-netflow-ipfix_definitions) | a valid filesystem path | No |
| [`netflow_definitions`](v3-11-1-plugins-codecs-netflow.md#v3.11.1-plugins-codecs-netflow-netflow_definitions) | a valid filesystem path | No |
| [`target`](v3-11-1-plugins-codecs-netflow.md#v3.11.1-plugins-codecs-netflow-target) | [string](/lsr/value-types.md#string) | No |
| [`versions`](v3-11-1-plugins-codecs-netflow.md#v3.11.1-plugins-codecs-netflow-versions) | [array](/lsr/value-types.md#array) | No |

### `cache_save_path` [v3.11.1-plugins-codecs-netflow-cache_save_path]
...
### `cache_ttl` [v3.11.1-plugins-codecs-netflow-cache_ttl]
...
### `include_flowset_id` [v3.11.1-plugins-codecs-netflow-include_flowset_id]
...
### `ipfix_definitions` [v3.11.1-plugins-codecs-netflow-ipfix_definitions]
...
### `netflow_definitions` [v3.11.1-plugins-codecs-netflow-netflow_definitions]
...
### `target` [v3.11.1-plugins-codecs-netflow-target]
...
### `versions` [v3.11.1-plugins-codecs-netflow-versions]
