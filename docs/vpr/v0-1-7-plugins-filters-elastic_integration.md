---
navigation_title: "v0.1.7"
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v0.1.7-plugins-filters-elastic_integration.html
---

# Elastic Integration filter plugin v0.1.7 [v0.1.7-plugins-filters-elastic_integration]

* Plugin version: v0.1.7
* Released on: 2024-03-05
* [Changelog](https://github.com/elastic/logstash-filter-elastic_integration/blob/v0.1.7/CHANGELOG.md)
...
## Minimum Configuration [v0.1.7-plugins-filters-elastic_integration-minimum_configuration]
...
Read on for a guide to configuration, or jump to the [complete list of configuration options](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-options).

## Connecting to Elasticsearch [v0.1.7-plugins-filters-elastic_integration-connecting_to_elasticsearch]
...
* A Cloud Id (see [`cloud_id`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-cloud_id))
* A list of one or more host URLs (see [`hosts`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-hosts))
...
* A PEM-formatted list of trusted certificate authorities (see [`ssl_certificate_authorities`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_certificate_authorities))
* A JKS- or PKCS12-formatted Keystore containing trusted certificates (see [`ssl_truststore_path`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_truststore_path))

You can also configure which aspects of the proof-of-identity are verified (see [`ssl_verification_mode`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_verification_mode)).
...
* A PKCS8 Certificate/Key pair (see [`ssl_certificate`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_certificate))
* A JKS- or PKCS12-formatted Keystore (see [`ssl_keystore_path`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_keystore_path))
...
* ApiKey: (see [`api_key`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-api_key))
* Cloud Auth: (see [`cloud_auth`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-cloud_auth))
* HTTP Basic Auth: (see [`username`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-username) and [`password`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-password))
...
## Minimum required privileges [v0.1.7-plugins-filters-elastic_integration-minimum_required_privileges]
...
## Supported Ingest Processors [v0.1.7-plugins-filters-elastic_integration-supported_ingest_processors]
...
| **Redact** | `redact` | *none* |
| **GeoIp** | `geoip` | requires MaxMind GeoIP2 databases, which may be provided by Logstash’s Geoip Database Management *OR* configured using [`geoip_database_directory`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-geoip_database_directory) |

### Field Mappings [v0.1.7-plugins-filters-elastic_integration-field_mappings]
...
## Resolving Pipeline Definitions [v0.1.7-plugins-filters-elastic_integration-resolving]

This plugin uses Elasticsearch to resolve pipeline names into their pipeline definitions. When configured *without* an explicit [`pipeline_name`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-pipeline_name), or when a pipeline uses the Reroute Processor, it also uses Elasticsearch to establish mappings of data stream names to their respective default pipeline names.
...
## Elastic Integration Filter Configuration Options [v0.1.7-plugins-filters-elastic_integration-options]

This plugin supports the following configuration options plus the [Common options](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`api_key`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-api_key) | [password](/lsr/value-types.md#password) | No |
| [`cloud_auth`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-cloud_auth) | [password](/lsr/value-types.md#password) | No |
| [`cloud_id`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-cloud_id) | [string](/lsr/value-types.md#string) | No |
| [`geoip_database_directory`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-geoip_database_directory) | [path](/lsr/value-types.md#path) | No |
| [`hosts`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-hosts) | [array](/lsr/value-types.md#array) | No |
| [`password`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-password) | [password](/lsr/value-types.md#password) | No |
| [`pipeline_name`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-pipeline_name) | [string](/lsr/value-types.md#string) | No |
| [`ssl_certificate`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_certificate) | [path](/lsr/value-types.md#path) | No |
| [`ssl_certificate_authorities`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_certificate_authorities) | [array](/lsr/value-types.md#array) | No |
| [`ssl_enabled`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_enabled) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ssl_key`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_key) | [path](/lsr/value-types.md#path) | No |
| [`ssl_keystore_password`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_keystore_password) | [password](/lsr/value-types.md#password) | No |
| [`ssl_keystore_path`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_keystore_path) | [path](/lsr/value-types.md#path) | No |
| [`ssl_key_passphrase`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_key_passphrase) | [password](/lsr/value-types.md#password) | No |
| [`ssl_truststore_path`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_truststore_path) | [path](/lsr/value-types.md#path) | No |
| [`ssl_truststore_password`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_truststore_password) | [password](/lsr/value-types.md#password) | No |
| [`ssl_verification_mode`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_verification_mode) | [string](/lsr/value-types.md#string), one of `["full", "certificate", "none"]` | No |
| [`username`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-username) | [string](/lsr/value-types.md#string) | No |

### `api_key` [v0.1.7-plugins-filters-elastic_integration-api_key]
...
### `cloud_auth` [v0.1.7-plugins-filters-elastic_integration-cloud_auth]
...
### `cloud_id` [v0.1.7-plugins-filters-elastic_integration-cloud_id]

* Value type is [string](/lsr/value-types.md#string)
* There is no default value for this setting.
* Cannot be combined with \`[`ssl_enabled`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_enabled)⇒false\`.
...
### `geoip_database_directory` [v0.1.7-plugins-filters-elastic_integration-geoip_database_directory]
...
### `hosts` [v0.1.7-plugins-filters-elastic_integration-hosts]
...
* Constraints:
  ...
  * `https`-protocol hosts use HTTPS and cannot be combined with [`ssl_enabled => false`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_enabled).
  * `http`-protocol hosts use unsecured HTTP and cannot be combined with [`ssl_enabled => true`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_enabled).
...
### `password` [v0.1.7-plugins-filters-elastic_integration-password]

* Value type is [password](/lsr/value-types.md#password)
* There is no default value for this setting.
* Required when request auth is configured with [`username`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-username)

A password when using HTTP Basic Authentication to connect to Elasticsearch.

### `pipeline_name` [v0.1.7-plugins-filters-elastic_integration-pipeline_name]
...
### `ssl_certificate` [v0.1.7-plugins-filters-elastic_integration-ssl_certificate]

* Value type is [path](/lsr/value-types.md#path)
* There is no default value for this setting.
* When present, [`ssl_key`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_key) and [`ssl_key_passphrase`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_key_passphrase) are also required.
* Cannot be combined with configurations that disable SSL

Path to a PEM-encoded certificate or certificate chain with which to identify this plugin to Elasticsearch.

### `ssl_certificate_authorities` [v0.1.7-plugins-filters-elastic_integration-ssl_certificate_authorities]

* Value type is a list of [path](/lsr/value-types.md#path)s
* There is no default value for this setting.
* Cannot be combined with configurations that disable SSL
* Cannot be combined with \`[`ssl_verification_mode`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_verification_mode)⇒none\`.
...
### `ssl_enabled` [v0.1.7-plugins-filters-elastic_integration-ssl_enabled]
...
* it is implicitly disabled by providing `http`-protocol [`hosts`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-hosts).
...
### `ssl_key` [v0.1.7-plugins-filters-elastic_integration-ssl_key]

* Value type is [path](/lsr/value-types.md#path)
* There is no default value for this setting.
* Required when connection identity is configured with [`ssl_certificate`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_certificate)
* Cannot be combined with configurations that disable SSL

A path to a PKCS8-formatted SSL certificate key.

### `ssl_keystore_password` [v0.1.7-plugins-filters-elastic_integration-ssl_keystore_password]

* Value type is [password](/lsr/value-types.md#password)
* There is no default value for this setting.
* Required when connection identity is configured with [`ssl_keystore_path`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_keystore_path)
* Cannot be combined with configurations that disable SSL

Password for the [`ssl_keystore_path`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_keystore_path).

### `ssl_keystore_path` [v0.1.7-plugins-filters-elastic_integration-ssl_keystore_path]

* Value type is [path](/lsr/value-types.md#path)
* There is no default value for this setting.
* When present, [`ssl_keystore_password`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_keystore_password) is also required.
* Cannot be combined with configurations that disable SSL

A path to a JKS- or PKCS12-formatted keystore with which to identify this plugin to Elasticsearch.

### `ssl_key_passphrase` [v0.1.7-plugins-filters-elastic_integration-ssl_key_passphrase]
...
A password or passphrase of the [`ssl_key`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_key).

### `ssl_truststore_path` [v0.1.7-plugins-filters-elastic_integration-ssl_truststore_path]

* Value type is [path](/lsr/value-types.md#path)
* There is no default value for this setting.
* When present, [`ssl_truststore_password`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_truststore_password) is required.
* Cannot be combined with configurations that disable SSL
* Cannot be combined with \`[`ssl_verification_mode`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_verification_mode)⇒none\`.
...
### `ssl_truststore_password` [v0.1.7-plugins-filters-elastic_integration-ssl_truststore_password]

* Value type is [password](/lsr/value-types.md#password)
* There is no default value for this setting.
* Required when connection trust is configured with [`ssl_truststore_path`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_truststore_path)
* Cannot be combined with configurations that disable SSL

Password for the [`ssl_truststore_path`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-ssl_truststore_path).

### `ssl_verification_mode` [v0.1.7-plugins-filters-elastic_integration-ssl_verification_mode]
...
### `username` [v0.1.7-plugins-filters-elastic_integration-username]

* Value type is [string](/lsr/value-types.md#string)
* There is no default value for this setting.
* When present, [`password`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-password) is also required.

A user name when using HTTP Basic Authentication to connect to Elasticsearch.

## Common options [v0.1.7-plugins-filters-elastic_integration-common-options]

These configuration options are supported by all filter plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v0-1-7-plugins-filters-elastic_integration.md#v0.1.7-plugins-filters-elastic_integration-remove_tag) | [array](/lsr/value-types.md#array) | No |

### `add_field` [v0.1.7-plugins-filters-elastic_integration-add_field]
...
### `add_tag` [v0.1.7-plugins-filters-elastic_integration-add_tag]
...
### `enable_metric` [v0.1.7-plugins-filters-elastic_integration-enable_metric]
...
### `id` [v0.1.7-plugins-filters-elastic_integration-id]
...
### `periodic_flush` [v0.1.7-plugins-filters-elastic_integration-periodic_flush]
...
### `remove_field` [v0.1.7-plugins-filters-elastic_integration-remove_field]
...
### `remove_tag` [v0.1.7-plugins-filters-elastic_integration-remove_tag]
