...
Also see [Common options](v2-2-1-plugins-inputs-kinesis.md#v2.2.1-plugins-inputs-kinesis-common-options) for a list of options supported by all input plugins.
