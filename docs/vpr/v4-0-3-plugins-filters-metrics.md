...
| :- | :- | :- |
| [`clear_interval`](v4-0-3-plugins-filters-metrics.md#v4.0.3-plugins-filters-metrics-clear_interval) | [number](/lsr/value-types.md#number) | No |
| [`flush_interval`](v4-0-3-plugins-filters-metrics.md#v4.0.3-plugins-filters-metrics-flush_interval) | [number](/lsr/value-types.md#number) | No |
| [`ignore_older_than`](v4-0-3-plugins-filters-metrics.md#v4.0.3-plugins-filters-metrics-ignore_older_than) | [number](/lsr/value-types.md#number) | No |
| [`meter`](v4-0-3-plugins-filters-metrics.md#v4.0.3-plugins-filters-metrics-meter) | [array](/lsr/value-types.md#array) | No |
| [`percentiles`](v4-0-3-plugins-filters-metrics.md#v4.0.3-plugins-filters-metrics-percentiles) | [array](/lsr/value-types.md#array) | No |
| [`rates`](v4-0-3-plugins-filters-metrics.md#v4.0.3-plugins-filters-metrics-rates) | [array](/lsr/value-types.md#array) | No |
| [`timer`](v4-0-3-plugins-filters-metrics.md#v4.0.3-plugins-filters-metrics-timer) | [hash](/lsr/value-types.md#hash) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-0-3-plugins-filters-metrics.md#v4.0.3-plugins-filters-metrics-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v4-0-3-plugins-filters-metrics.md#v4.0.3-plugins-filters-metrics-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v4-0-3-plugins-filters-metrics.md#v4.0.3-plugins-filters-metrics-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v4-0-3-plugins-filters-metrics.md#v4.0.3-plugins-filters-metrics-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v4-0-3-plugins-filters-metrics.md#v4.0.3-plugins-filters-metrics-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v4-0-3-plugins-filters-metrics.md#v4.0.3-plugins-filters-metrics-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v4-0-3-plugins-filters-metrics.md#v4.0.3-plugins-filters-metrics-remove_tag) | [array](/lsr/value-types.md#array) | No |
