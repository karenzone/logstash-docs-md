...
| [`use_ssl_auth`](v3-0-3-plugins-outputs-webhdfs.md#v3.0.3-plugins-outputs-webhdfs-use_ssl_auth) | [boolean](/lsr/value-types.md#boolean) | No |
...
### `path` [v3.0.3-plugins-outputs-webhdfs-path]
