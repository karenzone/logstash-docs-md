...
If you are shipping events that span multiple lines, you need to use the configuration options available in Filebeat to handle multiline events before sending the event data to Logstash. You cannot use the [multiline codec plugin](https://www.elastic.co/guide/en/logstash/current/plugins-codecs-multiline.html) codec to handle multiline events. Doing so may result in the mixing of streams and corrupted event data.
...
| :- | :- | :- |
| [`cipher_suites`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-cipher_suites) | [array](/lsr/value-types.md#array) | No |
| [`client_inactivity_timeout`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-client_inactivity_timeout) | [number](/lsr/value-types.md#number) | No |
| [`host`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-host) | [string](/lsr/value-types.md#string) | No |
| [`include_codec_tag`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-include_codec_tag) | [boolean](/lsr/value-types.md#boolean) | No |
| [`port`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-port) | [number](/lsr/value-types.md#number) | Yes |
| [`ssl`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-ssl) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ssl_certificate`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-ssl_certificate) | a valid filesystem path | No |
| [`ssl_certificate_authorities`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-ssl_certificate_authorities) | [array](/lsr/value-types.md#array) | No |
| [`ssl_handshake_timeout`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-ssl_handshake_timeout) | [number](/lsr/value-types.md#number) | No |
| [`ssl_key`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-ssl_key) | a valid filesystem path | No |
| [`ssl_key_passphrase`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-ssl_key_passphrase) | [password](/lsr/value-types.md#password) | No |
| [`ssl_verify_mode`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-ssl_verify_mode) | [string](/lsr/value-types.md#string), one of `["none", "peer", "force_peer"]` | No |
| [`tls_max_version`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-tls_max_version) | [number](/lsr/value-types.md#number) | No |
| [`tls_min_version`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-tls_min_version) | [number](/lsr/value-types.md#number) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v3-1-17-plugins-inputs-beats.md#v3.1.17-plugins-inputs-beats-type) | [string](/lsr/value-types.md#string) | No |

### `add_field` [v3.1.17-plugins-inputs-beats-add_field]
