...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v3.3.1-plugins-inputs-jms.html
applies_to:
  stack: ga
---

# Jms input plugin v3.3.1 [v3.3.1-plugins-inputs-jms]
...
## Compatibility with the Elastic Common Schema (ECS) [v3.3.1-plugins-inputs-jms-ecs]

JMS data is application specific. ECS compliance for fields depends on the use case. The plugin includes sensible defaults that change based on [ECS compatibility mode](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-ecs_compatibility). When ECS compatibility is disabled, headers, properties, and payload are targeted at the root level of the event to maintain compatibility with legacy usage of this plugin. When targeting an ECS version, headers and properties target `@metadata` sub-fields unless configured otherwise in order to avoid conflict with ECS fields. See [`headers_target`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-headers_target), [`properties_target`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-properties_target) and [`target`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-target).
...
## Jms Input Configuration Options [v3.3.1-plugins-inputs-jms-options]

This plugin supports the following configuration options plus the [Common options](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`broker_url`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-broker_url) | [string](/lsr/value-types.md#string) | No |
| [`destination`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-destination) | [string](/lsr/value-types.md#string) | Yes |
| [`durable_subscriber`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-durable_subscriber) | [boolean](/lsr/value-types.md#boolean) | No |
| [`durable_subscriber_client_id`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-durable_subscriber_client_id) | [string](/lsr/value-types.md#string) | No |
| [`durable_subscriber_name`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-durable_subscriber_name) | [string](/lsr/value-types.md#string) | No |
| [`ecs_compatibility`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`factory`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-factory) | [string](/lsr/value-types.md#string) | No |
| [`factory_settings`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-factory_settings) | [hash](/lsr/value-types.md#hash) | No |
| [`headers_target`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-headers_target) | [string](/lsr/value-types.md#string) | No |
| [`include_body`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-include_body) | [boolean](/lsr/value-types.md#boolean) | No |
| [`include_header`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-include_header) | [boolean](/lsr/value-types.md#boolean) | No |
| [`include_headers`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-include_headers) | [boolean](/lsr/value-types.md#boolean) | No |
| [`include_properties`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-include_properties) | [boolean](/lsr/value-types.md#boolean) | No |
| [`interval`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-interval) | [number](/lsr/value-types.md#number) | No |
| [`jndi_context`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-jndi_context) | [hash](/lsr/value-types.md#hash) | No |
| [`jndi_name`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-jndi_name) | [string](/lsr/value-types.md#string) | No |
| [`keystore`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-keystore) | a valid filesystem path | No |
| [`keystore_password`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-keystore_password) | [password](/lsr/value-types.md#password) | No |
| [`oracle_aq_buffered_messages`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-oracle_aq_buffered_messages) | [boolean](/lsr/value-types.md#boolean) | No |
| [`password`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-password) | [string](/lsr/value-types.md#string) | No |
| [`properties_target`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-properties_target) | [string](/lsr/value-types.md#string) | No |
| [`pub_sub`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-pub_sub) | [boolean](/lsr/value-types.md#boolean) | No |
| [`require_jars`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-require_jars) | [array](/lsr/value-types.md#array) | No |
| [`runner`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-runner) | [string](/lsr/value-types.md#string) | *Deprecated* |
| [`selector`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-selector) | [string](/lsr/value-types.md#string) | No |
| [`skip_headers`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-skip_headers) | [array](/lsr/value-types.md#array) | No |
| [`skip_properties`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-skip_properties) | [array](/lsr/value-types.md#array) | No |
| [`system_properties`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-system_properties) | [hash](/lsr/value-types.md#hash) | No |
| [`target`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-target) | [string](/lsr/value-types.md#string) | No |
| [`threads`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-threads) | [number](/lsr/value-types.md#number) | No |
| [`timeout`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-timeout) | [number](/lsr/value-types.md#number) | No |
| [`truststore`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-truststore) | a valid filesystem path | No |
| [`truststore_password`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-truststore_password) | [password](/lsr/value-types.md#password) | No |
| [`use_jms_timestamp`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-use_jms_timestamp) | [boolean](/lsr/value-types.md#boolean) | No |
| [`username`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-username) | [string](/lsr/value-types.md#string) | No |
| [`yaml_file`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-yaml_file) | [string](/lsr/value-types.md#string) | No |
| [`yaml_section`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-yaml_section) | [string](/lsr/value-types.md#string) | No |

Also see [Common options](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-common-options) for a list of options supported by all input plugins.

### `broker_url` [v3.3.1-plugins-inputs-jms-broker_url]
...
### `destination` [v3.3.1-plugins-inputs-jms-destination]
...
### `durable_subscriber` [v3.3.1-plugins-inputs-jms-durable_subscriber]
...
### `durable_subscriber_client_id` [v3.3.1-plugins-inputs-jms-durable_subscriber_client_id]
...
### `durable_subscriber_name` [v3.3.1-plugins-inputs-jms-durable_subscriber_name]
...
### `ecs_compatibility` [v3.3.1-plugins-inputs-jms-ecs_compatibility]
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/current). The value of this setting affects the *default* value of [`headers_target`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-headers_target) and [`properties_target`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-properties_target).

### `factory` [v3.3.1-plugins-inputs-jms-factory]
...
### `factory_settings` [v3.3.1-plugins-inputs-jms-factory_settings]
...
### `headers_target` [v3.3.1-plugins-inputs-jms-headers_target]

* Value type is [string](/lsr/value-types.md#string)

* Default value depends on whether [`ecs_compatibility`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-ecs_compatibility) is enabled:

  * ECS Compatibility disabled: no default value for this setting
  * ECS Compatibility enabled: \`"[@metadata][input][jms][headers]"

The name of the field under which JMS headers will be added, if [`include_headers`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-include_headers) is set.

### `include_body` [v3.3.1-plugins-inputs-jms-include_body]
...
### `include_headers` [v3.3.1-plugins-inputs-jms-include_headers]
...
### `include_properties` [v3.3.1-plugins-inputs-jms-include_properties]
...
### `interval` [v3.3.1-plugins-inputs-jms-interval]
...
### `jndi_context` [v3.3.1-plugins-inputs-jms-jndi_context]
...
### `jndi_name` [v3.3.1-plugins-inputs-jms-jndi_name]
...
### `keystore` [v3.3.1-plugins-inputs-jms-keystore]
...
### `keystore_password` [v3.3.1-plugins-inputs-jms-keystore_password]
...
### `oracle_aq_buffered_messages` [v3.3.1-plugins-inputs-jms-oracle_aq_buffered_messages]
...
### `password` [v3.3.1-plugins-inputs-jms-password]
...
### `properties_target` [v3.3.1-plugins-inputs-jms-properties_target]
...
The name of the field under which JMS properties will be added, if [`include_properties`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-include_properties) is set.

### `pub_sub` [v3.3.1-plugins-inputs-jms-pub_sub]
...
### `require_jars` [v3.3.1-plugins-inputs-jms-require_jars]
...
### `runner` [v3.3.1-plugins-inputs-jms-runner]

* DEPRECATED WARNING: This configuration item is deprecated and may not be available in future versions.

### `selector` [v3.3.1-plugins-inputs-jms-selector]
...
### `skip_headers` [v3.3.1-plugins-inputs-jms-skip_headers]
...
### `skip_properties` [v3.3.1-plugins-inputs-jms-skip_properties]
...
### `system_properties` [v3.3.1-plugins-inputs-jms-system_properties]
...
### `target` [v3.3.1-plugins-inputs-jms-target]
...
### `threads` [v3.3.1-plugins-inputs-jms-threads]
...
### `timeout` [v3.3.1-plugins-inputs-jms-timeout]
...
### `truststore` [v3.3.1-plugins-inputs-jms-truststore]
...
### `truststore_password` [v3.3.1-plugins-inputs-jms-truststore_password]
...
### `use_jms_timestamp` [v3.3.1-plugins-inputs-jms-use_jms_timestamp]
...
### `username` [v3.3.1-plugins-inputs-jms-username]
...
### `yaml_file` [v3.3.1-plugins-inputs-jms-yaml_file]
...
### `yaml_section` [v3.3.1-plugins-inputs-jms-yaml_section]
...
## Common options [v3.3.1-plugins-inputs-jms-common-options]

These configuration options are supported by all input plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v3-3-1-plugins-inputs-jms.md#v3.3.1-plugins-inputs-jms-type) | [string](/lsr/value-types.md#string) | No |

### `add_field` [v3.3.1-plugins-inputs-jms-add_field]
...
### `codec` [v3.3.1-plugins-inputs-jms-codec]
...
### `enable_metric` [v3.3.1-plugins-inputs-jms-enable_metric]
...
### `id` [v3.3.1-plugins-inputs-jms-id]
...
### `tags` [v3.3.1-plugins-inputs-jms-tags]
...
### `type` [v3.3.1-plugins-inputs-jms-type]
