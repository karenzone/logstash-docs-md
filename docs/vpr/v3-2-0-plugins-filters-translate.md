...
| :- | :- | :- |
| [`destination`](v3-2-0-plugins-filters-translate.md#v3.2.0-plugins-filters-translate-destination) | [string](/lsr/value-types.md#string) | No |
| [`dictionary`](v3-2-0-plugins-filters-translate.md#v3.2.0-plugins-filters-translate-dictionary) | [hash](/lsr/value-types.md#hash) | No |
...
| [`exact`](v3-2-0-plugins-filters-translate.md#v3.2.0-plugins-filters-translate-exact) | [boolean](/lsr/value-types.md#boolean) | No |
| [`fallback`](v3-2-0-plugins-filters-translate.md#v3.2.0-plugins-filters-translate-fallback) | [string](/lsr/value-types.md#string) | No |
| [`field`](v3-2-0-plugins-filters-translate.md#v3.2.0-plugins-filters-translate-field) | [string](/lsr/value-types.md#string) | Yes |
| [`iterate_on`](v3-2-0-plugins-filters-translate.md#v3.2.0-plugins-filters-translate-iterate_on) | [string](/lsr/value-types.md#string) | No |
| [`override`](v3-2-0-plugins-filters-translate.md#v3.2.0-plugins-filters-translate-override) | [boolean](/lsr/value-types.md#boolean) | No |
| [`refresh_interval`](v3-2-0-plugins-filters-translate.md#v3.2.0-plugins-filters-translate-refresh_interval) | [number](/lsr/value-types.md#number) | No |
| [`regex`](v3-2-0-plugins-filters-translate.md#v3.2.0-plugins-filters-translate-regex) | [boolean](/lsr/value-types.md#boolean) | No |
| [`refresh_behaviour`](v3-2-0-plugins-filters-translate.md#v3.2.0-plugins-filters-translate-refresh_behaviour) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-2-0-plugins-filters-translate.md#v3.2.0-plugins-filters-translate-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v3-2-0-plugins-filters-translate.md#v3.2.0-plugins-filters-translate-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v3-2-0-plugins-filters-translate.md#v3.2.0-plugins-filters-translate-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-2-0-plugins-filters-translate.md#v3.2.0-plugins-filters-translate-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v3-2-0-plugins-filters-translate.md#v3.2.0-plugins-filters-translate-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v3-2-0-plugins-filters-translate.md#v3.2.0-plugins-filters-translate-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v3-2-0-plugins-filters-translate.md#v3.2.0-plugins-filters-translate-remove_tag) | [array](/lsr/value-types.md#array) | No |

### `add_field` [v3.2.0-plugins-filters-translate-add_field]
