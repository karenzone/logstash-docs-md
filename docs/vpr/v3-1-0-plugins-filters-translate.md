...
This plugin supports the following configuration options plus the [Common options](v3-1-0-plugins-filters-translate.md#v3.1.0-plugins-filters-translate-common-options) described later.
