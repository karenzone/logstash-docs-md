...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v10.7.1-plugins-integrations-kafka.html
---

# Kafka Integration Plugin v10.7.1 [v10.7.1-plugins-integrations-kafka]

* Plugin version: v10.7.1
