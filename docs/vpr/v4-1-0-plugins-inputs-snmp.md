...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v4.1.0-plugins-inputs-snmp.html
applies_to:
  stack: ga
---

# SNMP input plugin v4.1.0 [v4.1.0-plugins-inputs-snmp]
...
## Compatibility with the Elastic Common Schema (ECS) [v4.1.0-plugins-inputs-snmp-ecs]

Because SNMP data has specific field names based on OIDs, we recommend setting a [`target`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-target). Metadata fields follow a specific naming convention when [ECS compatibility mode](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-ecs_compatibility) is enabled.
...
## Importing MIBs [v4.1.0-plugins-inputs-snmp-import-mibs]
...
## SNMP Input Configuration Options [v4.1.0-plugins-inputs-snmp-options]

This plugin supports the following configuration options plus the [Common options](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`ecs_compatibility`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`get`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-get) | [array](/lsr/value-types.md#array) | No |
| [`hosts`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-hosts) | [array](/lsr/value-types.md#array) | No |
| [`interval`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-interval) | [number](/lsr/value-types.md#number) | No |
| [`local_engine_id`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-local_engine_id) | [string](/lsr/value-types.md#string) | No |
| [`mib_paths`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-mib_paths) | [path](/lsr/value-types.md#path) | No |
| [`oid_mapping_format`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-oid_mapping_format) | [string](/lsr/value-types.md#string), one of `["default", "ruby_snmp", "dotted_string"]` | No |
| [`oid_map_field_values`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-oid_map_field_values) | [boolean](/lsr/value-types.md#boolean) | No |
| [`oid_path_length`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-oid_path_length) | [number](/lsr/value-types.md#number) | No |
| [`oid_root_skip`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-oid_root_skip) | [number](/lsr/value-types.md#number) | No |
| [`poll_hosts_timeout`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-poll_hosts_timeout) | [number](/lsr/value-types.md#number) | No |
| [`walk`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-walk) | [array](/lsr/value-types.md#array) | No |
| [`tables`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-tables) | [array](/lsr/value-types.md#array) | No |
| [`target`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-target) | [string](/lsr/value-types.md#string) | No |
| [`threads`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-threads) | [number](/lsr/value-types.md#number) | No |
| [`use_provided_mibs`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-use_provided_mibs) | [boolean](/lsr/value-types.md#boolean) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`auth_pass`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-auth_pass) | [password](/lsr/value-types.md#password) | No |
| [`auth_protocol`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-auth_protocol) | [string](/lsr/value-types.md#string), one of `["md5", "sha", "sha2", "hmac128sha224", "hmac192sha256", "hmac256sha384", "hmac384sha512"]` | No |
| [`priv_pass`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-priv_pass) | [password](/lsr/value-types.md#password) | No |
| [`priv_protocol`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-priv_protocol) | [string](/lsr/value-types.md#string), one of `["des", "3des", "aes", "aes128", "aes192", "aes256"]` | No |
| [`security_level`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-security_level) | [string](/lsr/value-types.md#string), one of `["noAuthNoPriv", "authNoPriv", "authPriv"]` | No |
| [`security_name`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-security_name) | [string](/lsr/value-types.md#string) | No |

## SNMP Input Configuration Options [_snmp_input_configuration_options]

Also see [Common options](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-common-options) for a list of options supported by all input plugins.

### `ecs_compatibility` [v4.1.0-plugins-inputs-snmp-ecs_compatibility]
...
### `get` [v4.1.0-plugins-inputs-snmp-get]
...
### `hosts` [v4.1.0-plugins-inputs-snmp-hosts]
...
### `interval` [v4.1.0-plugins-inputs-snmp-interval]
...
### `local_engine_id` [v4.1.0-plugins-inputs-snmp-local_engine_id]
...
### `mib_paths` [v4.1.0-plugins-inputs-snmp-mib_paths]
...
This plugin includes the IETF MIBs. If you require other MIBs, you need to import them. See [Importing MIBs](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-import-mibs).

### `oid_mapping_format` [v4.1.0-plugins-inputs-snmp-oid_mapping_format]
...
### `oid_map_field_values` [v4.1.0-plugins-inputs-snmp-oid_map_field_values]

* Value type is [boolean](/lsr/value-types.md#boolean)
* Default value is `false`

Defines if the Logstash event fields values, which types are `OID`, are mapped using the configured OID textual representation set on the [`oid_mapping_format`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-oid_mapping_format) option.

### `oid_root_skip` [v4.1.0-plugins-inputs-snmp-oid_root_skip]
...
* You can use this setting or [`oid_path_length`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-oid_path_length), but not both at the same time.
* Use this setting only if [`oid_mapping_format`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-oid_mapping_format) is set to `default`.

### `oid_path_length` [v4.1.0-plugins-inputs-snmp-oid_path_length]
...
* You can use this setting or [`oid_root_skip`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-oid_root_skip), but not both at the same time.
* This setting can be used only if [`oid_mapping_format`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-oid_mapping_format) is set to `default`.

### `poll_hosts_timeout` [v4.1.0-plugins-inputs-snmp-poll_hosts_timeout]

* Value type is [number](/lsr/value-types.md#number)
* There is no default value for this setting

Specifies the maximum amount of time in milliseconds the polling client will wait for all [`hosts`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-hosts) responses. If all responses are not received before the timeout elapses, the client will fail and some hosts might not get polled during the current cycle.

By default, it uses the highest value between `1 hour`, the maximum [`hosts`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-hosts) configured `timeout`, and the [`interval`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-interval) value.

### `walk` [v4.1.0-plugins-inputs-snmp-walk]
...
### `tables` [v4.1.0-plugins-inputs-snmp-tables]
...
### `target` [v4.1.0-plugins-inputs-snmp-target]
...
Setting a target is recommended when [`ecs_compatibility`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-ecs_compatibility) is enabled.

### `threads` [v4.1.0-plugins-inputs-snmp-threads]
...
### `use_provided_mibs` [v4.1.0-plugins-inputs-snmp-use_provided_mibs]
...
### `auth_pass` [v4.1.0-plugins-inputs-snmp-auth_pass]
...
### `auth_protocol` [v4.1.0-plugins-inputs-snmp-auth_protocol]
...
### `priv_pass` [v4.1.0-plugins-inputs-snmp-priv_pass]
...
### `priv_protocol` [v4.1.0-plugins-inputs-snmp-priv_protocol]
...
### `security_level` [v4.1.0-plugins-inputs-snmp-security_level]
...
### `security_name` [v4.1.0-plugins-inputs-snmp-security_name]
...
## Configuration examples [v4.1.0-plugins-inputs-snmp-examples]
...
## Common options [v4.1.0-plugins-inputs-snmp-common-options]

These configuration options are supported by all input plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`enable_metric`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v4-1-0-plugins-inputs-snmp.md#v4.1.0-plugins-inputs-snmp-type) | [string](/lsr/value-types.md#string) | No |

### `add_field` [v4.1.0-plugins-inputs-snmp-add_field]
...
### `enable_metric` [v4.1.0-plugins-inputs-snmp-enable_metric]
...
### `id` [v4.1.0-plugins-inputs-snmp-id]
...
### `tags` [v4.1.0-plugins-inputs-snmp-tags]
...
### `type` [v4.1.0-plugins-inputs-snmp-type]
