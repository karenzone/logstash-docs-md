...
| :- | :- | :- |
| [`host`](v3-1-1-plugins-inputs-gelf.md#v3.1.1-plugins-inputs-gelf-host) | [string](/lsr/value-types.md#string) | No |
| [`use_udp`](v3-1-1-plugins-inputs-gelf.md#v3.1.1-plugins-inputs-gelf-use_udp) | [boolean](/lsr/value-types.md#boolean) | No |
| [`use_tcp`](v3-1-1-plugins-inputs-gelf.md#v3.1.1-plugins-inputs-gelf-use_tcp) | [boolean](/lsr/value-types.md#boolean) | No |
| [`port`](v3-1-1-plugins-inputs-gelf.md#v3.1.1-plugins-inputs-gelf-port) | [number](/lsr/value-types.md#number) | No |
| [`port_tcp`](v3-1-1-plugins-inputs-gelf.md#v3.1.1-plugins-inputs-gelf-port_tcp) | [number](/lsr/value-types.md#number) | No |
| [`port_udp`](v3-1-1-plugins-inputs-gelf.md#v3.1.1-plugins-inputs-gelf-port_udp) | [number](/lsr/value-types.md#number) | No |
| [`remap`](v3-1-1-plugins-inputs-gelf.md#v3.1.1-plugins-inputs-gelf-remap) | [boolean](/lsr/value-types.md#boolean) | No |
| [`strip_leading_underscore`](v3-1-1-plugins-inputs-gelf.md#v3.1.1-plugins-inputs-gelf-strip_leading_underscore) | [boolean](/lsr/value-types.md#boolean) | No |

Also see [Common options](v3-1-1-plugins-inputs-gelf.md#v3.1.1-plugins-inputs-gelf-common-options) for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-1-1-plugins-inputs-gelf.md#v3.1.1-plugins-inputs-gelf-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v3-1-1-plugins-inputs-gelf.md#v3.1.1-plugins-inputs-gelf-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-1-1-plugins-inputs-gelf.md#v3.1.1-plugins-inputs-gelf-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-1-1-plugins-inputs-gelf.md#v3.1.1-plugins-inputs-gelf-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v3-1-1-plugins-inputs-gelf.md#v3.1.1-plugins-inputs-gelf-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v3-1-1-plugins-inputs-gelf.md#v3.1.1-plugins-inputs-gelf-type) | [string](/lsr/value-types.md#string) | No |
...
### `enable_metric` [v3.1.1-plugins-inputs-gelf-enable_metric]
