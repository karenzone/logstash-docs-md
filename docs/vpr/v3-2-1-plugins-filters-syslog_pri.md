...
Also see [Common options](v3-2-1-plugins-filters-syslog_pri.md#v3.2.1-plugins-filters-syslog_pri-common-options) for a list of options supported by all filter plugins.
