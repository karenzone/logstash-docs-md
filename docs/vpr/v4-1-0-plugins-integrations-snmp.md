...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v4.1.0-plugins-integrations-snmp.html
applies_to:
  stack: ga
---

# SNMP Integration Plugin v4.1.0 [v4.1.0-plugins-integrations-snmp]
...
* [Migrating to `logstash-integration-snmp` from individual plugins](v4-1-0-plugins-integrations-snmp.md#v4.1.0-plugins-integrations-snmp-migration)
* [Importing MIBs](v4-1-0-plugins-integrations-snmp.md#v4.1.0-plugins-integrations-snmp-import-mibs)

## Migrating to `logstash-integration-snmp` from individual plugins [v4.1.0-plugins-integrations-snmp-migration]
...
### Migration notes: `logstash-input-snmp` [v4.1.0-plugins-integrations-snmp-migration-input-snmp]
...
### Changes to mapping and error logging: `logstash-input-snmp` [v4.1.0-plugins-integrations-snmp-input-snmp-mapping]
...
### Migration notes: `logstash-input-snmptrap` [v4.1.0-plugins-integrations-snmp-migration-input-snmptrap]
...
### Changes to mapping and error logging: `logstash-input-snmptrap` [v4.1.0-plugins-integrations-snmp-input-snmptrap-mapping]
...
### Maintain maximum compatibility with previous implementation [v4.1.0-plugins-integrations-snmp-input-snmptrap-compat]
...
## Importing MIBs [v4.1.0-plugins-integrations-snmp-import-mibs]
...
### Preventing a `failed to locate MIB module` error [v4.1.0-plugins-integrations-snmp-locate-mibs]
...
### Option 1: Use an environment variable [v4.1.0-plugins-integrations-snmp-env-var]
...
### Option 2: Provide a configuration file [v4.1.0-plugins-integrations-snmp-mib-config]
