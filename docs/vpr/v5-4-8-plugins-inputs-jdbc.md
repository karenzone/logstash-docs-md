...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v5.4.8-plugins-inputs-jdbc.html
applies_to:
  stack: ga
---

# Jdbc input plugin v5.4.8 [v5.4.8-plugins-inputs-jdbc]

* A component of the [jdbc integration plugin](integration-jdbc-index.md)
* Integration version: v5.4.8
...
See the [`jdbc_driver_library`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-jdbc_driver_library) and [`jdbc_driver_class`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-jdbc_driver_class) options for more info.
...
| offset, size | Values used with manual paging mode to explicitly implement the paging. Supported only if [`jdbc_paging_enabled`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-jdbc_paging_enabled) is enabled and [`jdbc_paging_mode`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-jdbc_paging_mode) has the `explicit` value. |
...
## Jdbc Input Configuration Options [v5.4.8-plugins-inputs-jdbc-options]

This plugin supports the following configuration options plus the [Common options](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`clean_run`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-clean_run) | [boolean](/lsr/value-types.md#boolean) | No |
| [`columns_charset`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-columns_charset) | [hash](/lsr/value-types.md#hash) | No |
| [`connection_retry_attempts`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-connection_retry_attempts) | [number](/lsr/value-types.md#number) | No |
| [`connection_retry_attempts_wait_time`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-connection_retry_attempts_wait_time) | [number](/lsr/value-types.md#number) | No |
| [`jdbc_connection_string`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-jdbc_connection_string) | [string](/lsr/value-types.md#string) | Yes |
| [`jdbc_default_timezone`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-jdbc_default_timezone) | [string](/lsr/value-types.md#string) | No |
| [`jdbc_driver_class`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-jdbc_driver_class) | [string](/lsr/value-types.md#string) | Yes |
| [`jdbc_driver_library`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-jdbc_driver_library) | [string](/lsr/value-types.md#string) | No |
| [`jdbc_fetch_size`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-jdbc_fetch_size) | [number](/lsr/value-types.md#number) | No |
| [`jdbc_page_size`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-jdbc_page_size) | [number](/lsr/value-types.md#number) | No |
| [`jdbc_paging_enabled`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-jdbc_paging_enabled) | [boolean](/lsr/value-types.md#boolean) | No |
| [`jdbc_paging_mode`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-jdbc_paging_mode) | [string](/lsr/value-types.md#string), one of `["auto", "explicit"]` | No |
| [`jdbc_password`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-jdbc_password) | [password](/lsr/value-types.md#password) | No |
| [`jdbc_password_filepath`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-jdbc_password_filepath) | a valid filesystem path | No |
| [`jdbc_pool_timeout`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-jdbc_pool_timeout) | [number](/lsr/value-types.md#number) | No |
| [`jdbc_user`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-jdbc_user) | [string](/lsr/value-types.md#string) | Yes |
| [`jdbc_validate_connection`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-jdbc_validate_connection) | [boolean](/lsr/value-types.md#boolean) | No |
| [`jdbc_validation_timeout`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-jdbc_validation_timeout) | [number](/lsr/value-types.md#number) | No |
| [`last_run_metadata_path`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-last_run_metadata_path) | [string](/lsr/value-types.md#string) | No |
| [`lowercase_column_names`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-lowercase_column_names) | [boolean](/lsr/value-types.md#boolean) | No |
| [`parameters`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-parameters) | [hash](/lsr/value-types.md#hash) | No |
| [`plugin_timezone`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-plugin_timezone) | [string](/lsr/value-types.md#string), one of `["local", "utc"]` | No |
| [`prepared_statement_bind_values`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-prepared_statement_bind_values) | [array](/lsr/value-types.md#array) | No |
| [`prepared_statement_name`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-prepared_statement_name) | [string](/lsr/value-types.md#string) | No |
| [`record_last_run`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-record_last_run) | [boolean](/lsr/value-types.md#boolean) | No |
| [`schedule`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-schedule) | [string](/lsr/value-types.md#string) | No |
| [`sequel_opts`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-sequel_opts) | [hash](/lsr/value-types.md#hash) | No |
| [`sql_log_level`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-sql_log_level) | [string](/lsr/value-types.md#string), one of `["fatal", "error", "warn", "info", "debug"]` | No |
| [`statement`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-statement) | [string](/lsr/value-types.md#string) | No |
| [`statement_filepath`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-statement_filepath) | a valid filesystem path | No |
| [`target`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-target) | [field reference](https://www.elastic.co/guide/en/logstash/current/field-references-deepdive.html) | No |
| [`tracking_column`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-tracking_column) | [string](/lsr/value-types.md#string) | No |
| [`tracking_column_type`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-tracking_column_type) | [string](/lsr/value-types.md#string), one of `["numeric", "timestamp"]` | No |
| [`use_column_value`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-use_column_value) | [boolean](/lsr/value-types.md#boolean) | No |
| [`use_prepared_statements`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-use_prepared_statements) | [boolean](/lsr/value-types.md#boolean) | No |

Also see [Common options](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-common-options) for a list of options supported by all input plugins.

### `clean_run` [v5.4.8-plugins-inputs-jdbc-clean_run]
...
### `columns_charset` [v5.4.8-plugins-inputs-jdbc-columns_charset]
...
### `connection_retry_attempts` [v5.4.8-plugins-inputs-jdbc-connection_retry_attempts]
...
### `connection_retry_attempts_wait_time` [v5.4.8-plugins-inputs-jdbc-connection_retry_attempts_wait_time]
...
### `jdbc_connection_string` [v5.4.8-plugins-inputs-jdbc-jdbc_connection_string]
...
### `jdbc_default_timezone` [v5.4.8-plugins-inputs-jdbc-jdbc_default_timezone]
...
### Timezone conversion [v5.4.8-plugins-inputs-jdbc-jdbc_timezone_conv]
...
### Ambiguous timestamps [v5.4.8-plugins-inputs-jdbc-jdbc_ambiguous_timestamps]
...
### `plugin_timezone` [v5.4.8-plugins-inputs-jdbc-plugin_timezone]
...
### `jdbc_driver_class` [v5.4.8-plugins-inputs-jdbc-jdbc_driver_class]
...
### `jdbc_driver_library` [v5.4.8-plugins-inputs-jdbc-jdbc_driver_library]
...
### `jdbc_fetch_size` [v5.4.8-plugins-inputs-jdbc-jdbc_fetch_size]
...
### `jdbc_page_size` [v5.4.8-plugins-inputs-jdbc-jdbc_page_size]
...
### `jdbc_paging_enabled` [v5.4.8-plugins-inputs-jdbc-jdbc_paging_enabled]
...
### `jdbc_paging_mode` [v5.4.8-plugins-inputs-jdbc-jdbc_paging_mode]
...
### `jdbc_password` [v5.4.8-plugins-inputs-jdbc-jdbc_password]
...
### `jdbc_password_filepath` [v5.4.8-plugins-inputs-jdbc-jdbc_password_filepath]
...
### `jdbc_pool_timeout` [v5.4.8-plugins-inputs-jdbc-jdbc_pool_timeout]
...
### `jdbc_user` [v5.4.8-plugins-inputs-jdbc-jdbc_user]
...
### `jdbc_validate_connection` [v5.4.8-plugins-inputs-jdbc-jdbc_validate_connection]
...
### `jdbc_validation_timeout` [v5.4.8-plugins-inputs-jdbc-jdbc_validation_timeout]
...
### `last_run_metadata_path` [v5.4.8-plugins-inputs-jdbc-last_run_metadata_path]
...
### `lowercase_column_names` [v5.4.8-plugins-inputs-jdbc-lowercase_column_names]
...
### `parameters` [v5.4.8-plugins-inputs-jdbc-parameters]
...
### `prepared_statement_bind_values` [v5.4.8-plugins-inputs-jdbc-prepared_statement_bind_values]
...
### `prepared_statement_name` [v5.4.8-plugins-inputs-jdbc-prepared_statement_name]
...
### `record_last_run` [v5.4.8-plugins-inputs-jdbc-record_last_run]

* Value type is [boolean](/lsr/value-types.md#boolean)
* Default value is `true`

Whether to save state or not in [`last_run_metadata_path`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-last_run_metadata_path)

### `schedule` [v5.4.8-plugins-inputs-jdbc-schedule]
...
### `sequel_opts` [v5.4.8-plugins-inputs-jdbc-sequel_opts]
...
### `sql_log_level` [v5.4.8-plugins-inputs-jdbc-sql_log_level]
...
### `statement` [v5.4.8-plugins-inputs-jdbc-statement]
...
### `statement_filepath` [v5.4.8-plugins-inputs-jdbc-statement_filepath]
...
### `target` [v5.4.8-plugins-inputs-jdbc-target]
...
### `tracking_column` [v5.4.8-plugins-inputs-jdbc-tracking_column]
...
### `tracking_column_type` [v5.4.8-plugins-inputs-jdbc-tracking_column_type]
...
### `use_column_value` [v5.4.8-plugins-inputs-jdbc-use_column_value]

* Value type is [boolean](/lsr/value-types.md#boolean)
* Default value is `false`

When set to `true`, uses the defined [`tracking_column`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-tracking_column) value as the `:sql_last_value`. When set to `false`, `:sql_last_value` reflects the last time the query was executed.

### `use_prepared_statements` [v5.4.8-plugins-inputs-jdbc-use_prepared_statements]
...
## Common options [v5.4.8-plugins-inputs-jdbc-common-options]

These configuration options are supported by all input plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v5-4-8-plugins-inputs-jdbc.md#v5.4.8-plugins-inputs-jdbc-type) | [string](/lsr/value-types.md#string) | No |

### `add_field` [v5.4.8-plugins-inputs-jdbc-add_field]
...
### `codec` [v5.4.8-plugins-inputs-jdbc-codec]
...
### `enable_metric` [v5.4.8-plugins-inputs-jdbc-enable_metric]
...
### `id` [v5.4.8-plugins-inputs-jdbc-id]
...
### `tags` [v5.4.8-plugins-inputs-jdbc-tags]
...
### `type` [v5.4.8-plugins-inputs-jdbc-type]
