...
| [`server_side_encryption_algorithm`](v7-1-3-plugins-outputs-s3.md#v7.1.3-plugins-outputs-s3-server_side_encryption_algorithm) | [string](/lsr/value-types.md#string), one of `["AES256", "aws:kms"]` | No |
