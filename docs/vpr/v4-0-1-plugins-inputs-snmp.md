...
| :- | :- | :- |
| [`ecs_compatibility`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`get`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-get) | [array](/lsr/value-types.md#array) | No |
| [`hosts`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-hosts) | [array](/lsr/value-types.md#array) | No |
| [`interval`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-interval) | [number](/lsr/value-types.md#number) | No |
| [`local_engine_id`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-local_engine_id) | [string](/lsr/value-types.md#string) | No |
| [`mib_paths`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-mib_paths) | [path](/lsr/value-types.md#path) | No |
| [`oid_mapping_format`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-oid_mapping_format) | [string](/lsr/value-types.md#string), one of `["default", "ruby_snmp", "dotted_string"]` | No |
| [`oid_map_field_values`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-oid_map_field_values) | [boolean](/lsr/value-types.md#boolean) | No |
| [`oid_path_length`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-oid_path_length) | [number](/lsr/value-types.md#number) | No |
| [`oid_root_skip`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-oid_root_skip) | [number](/lsr/value-types.md#number) | No |
| [`poll_hosts_timeout`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-poll_hosts_timeout) | [number](/lsr/value-types.md#number) | No |
| [`walk`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-walk) | [array](/lsr/value-types.md#array) | No |
| [`tables`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-tables) | [array](/lsr/value-types.md#array) | No |
| [`target`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-target) | [string](/lsr/value-types.md#string) | No |
| [`threads`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-threads) | [number](/lsr/value-types.md#number) | No |
| [`use_provided_mibs`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-use_provided_mibs) | [boolean](/lsr/value-types.md#boolean) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`auth_pass`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-auth_pass) | [password](/lsr/value-types.md#password) | No |
| [`auth_protocol`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-auth_protocol) | [string](/lsr/value-types.md#string), one of `["md5", "sha", "sha2", "hmac128sha224", "hmac192sha256", "hmac256sha384", "hmac384sha512"]` | No |
| [`priv_pass`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-priv_pass) | [password](/lsr/value-types.md#password) | No |
| [`priv_protocol`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-priv_protocol) | [string](/lsr/value-types.md#string), one of `["des", "3des", "aes", "aes128", "aes192", "aes256"]` | No |
| [`security_level`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-security_level) | [string](/lsr/value-types.md#string), one of `["noAuthNoPriv", "authNoPriv", "authPriv"]` | No |
| [`security_name`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-security_name) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`enable_metric`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v4-0-1-plugins-inputs-snmp.md#v4.0.1-plugins-inputs-snmp-type) | [string](/lsr/value-types.md#string) | No |
