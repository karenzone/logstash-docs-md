...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v10.7.2-plugins-integrations-kafka.html
applies_to:
  stack: ga
---

# Kafka Integration Plugin v10.7.2 [v10.7.2-plugins-integrations-kafka]

* Plugin version: v10.7.2
