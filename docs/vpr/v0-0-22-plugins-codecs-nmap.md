---
navigation_title: v0.0.22
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v0.0.22-plugins-codecs-nmap.html
applies_to:
  stack: ga
---

# Nmap codec plugin v0.0.22 [v0.0.22-plugins-codecs-nmap]
...
## Nmap Codec Configuration Options [v0.0.22-plugins-codecs-nmap-options]

| Setting | Input type | Required |
| :- | :- | :- |
| [`emit_hosts`](v0-0-22-plugins-codecs-nmap.md#v0.0.22-plugins-codecs-nmap-emit_hosts) | [boolean](/lsr/value-types.md#boolean) | No |
| [`emit_ports`](v0-0-22-plugins-codecs-nmap.md#v0.0.22-plugins-codecs-nmap-emit_ports) | [boolean](/lsr/value-types.md#boolean) | No |
| [`emit_scan_metadata`](v0-0-22-plugins-codecs-nmap.md#v0.0.22-plugins-codecs-nmap-emit_scan_metadata) | [boolean](/lsr/value-types.md#boolean) | No |
| [`emit_traceroute_links`](v0-0-22-plugins-codecs-nmap.md#v0.0.22-plugins-codecs-nmap-emit_traceroute_links) | [boolean](/lsr/value-types.md#boolean) | No |

### `emit_hosts` [v0.0.22-plugins-codecs-nmap-emit_hosts]
...
### `emit_ports` [v0.0.22-plugins-codecs-nmap-emit_ports]
...
### `emit_scan_metadata` [v0.0.22-plugins-codecs-nmap-emit_scan_metadata]
...
### `emit_traceroute_links` [v0.0.22-plugins-codecs-nmap-emit_traceroute_links]
