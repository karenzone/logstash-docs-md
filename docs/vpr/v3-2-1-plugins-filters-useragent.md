...
| :- | :- | :- |
| [`lru_cache_size`](v3-2-1-plugins-filters-useragent.md#v3.2.1-plugins-filters-useragent-lru_cache_size) | [number](/lsr/value-types.md#number) | No |
| [`prefix`](v3-2-1-plugins-filters-useragent.md#v3.2.1-plugins-filters-useragent-prefix) | [string](/lsr/value-types.md#string) | No |
| [`regexes`](v3-2-1-plugins-filters-useragent.md#v3.2.1-plugins-filters-useragent-regexes) | [string](/lsr/value-types.md#string) | No |
| [`source`](v3-2-1-plugins-filters-useragent.md#v3.2.1-plugins-filters-useragent-source) | [string](/lsr/value-types.md#string) | Yes |
| [`target`](v3-2-1-plugins-filters-useragent.md#v3.2.1-plugins-filters-useragent-target) | [string](/lsr/value-types.md#string) | No |

Also see [Common options](v3-2-1-plugins-filters-useragent.md#v3.2.1-plugins-filters-useragent-common-options) for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-2-1-plugins-filters-useragent.md#v3.2.1-plugins-filters-useragent-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v3-2-1-plugins-filters-useragent.md#v3.2.1-plugins-filters-useragent-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v3-2-1-plugins-filters-useragent.md#v3.2.1-plugins-filters-useragent-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-2-1-plugins-filters-useragent.md#v3.2.1-plugins-filters-useragent-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v3-2-1-plugins-filters-useragent.md#v3.2.1-plugins-filters-useragent-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v3-2-1-plugins-filters-useragent.md#v3.2.1-plugins-filters-useragent-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v3-2-1-plugins-filters-useragent.md#v3.2.1-plugins-filters-useragent-remove_tag) | [array](/lsr/value-types.md#array) | No |
