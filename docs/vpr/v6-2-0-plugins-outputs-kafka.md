...
| [`sasl_kerberos_service_name`](v6-2-0-plugins-outputs-kafka.md#v6.2.0-plugins-outputs-kafka-sasl_kerberos_service_name) | [string](/lsr/value-types.md#string) | No |
