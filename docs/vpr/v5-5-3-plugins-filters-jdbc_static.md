...
* **lookups**
  ...
  2. Defines the columns, types, and indexes used to build the local database structure. The column names and types should match the external database. The order of table definitions is significant and should match that of the loader queries. See [Loader column and local_db_object order dependency](v5-5-3-plugins-filters-jdbc_static.md#v5.5.3-plugins-filters-jdbc_static-object_order).
...
Also see [Common options](v5-5-3-plugins-filters-jdbc_static.md#v5.5.3-plugins-filters-jdbc_static-common-options) for a list of options supported by all filter plugins.
...
### `add_field` [v5.5.3-plugins-filters-jdbc_static-add_field]
