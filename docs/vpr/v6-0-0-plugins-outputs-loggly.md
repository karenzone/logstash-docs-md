...
| :- | :- | :- |
| [`can_retry`](v6-0-0-plugins-outputs-loggly.md#v6.0.0-plugins-outputs-loggly-can_retry) | [boolean](/lsr/value-types.md#boolean) | No |
| [`convert_timestamp`](v6-0-0-plugins-outputs-loggly.md#v6.0.0-plugins-outputs-loggly-convert_timestamp) | [boolean](/lsr/value-types.md#boolean) | No |
| [`host`](v6-0-0-plugins-outputs-loggly.md#v6.0.0-plugins-outputs-loggly-host) | [string](/lsr/value-types.md#string) | No |
| [`key`](v6-0-0-plugins-outputs-loggly.md#v6.0.0-plugins-outputs-loggly-key) | [string](/lsr/value-types.md#string) | Yes |
| [`max_event_size`](v6-0-0-plugins-outputs-loggly.md#v6.0.0-plugins-outputs-loggly-max_event_size) | [bytes](/lsr/value-types.md#bytes) | Yes |
| [`max_payload_size`](v6-0-0-plugins-outputs-loggly.md#v6.0.0-plugins-outputs-loggly-max_payload_size) | [bytes](/lsr/value-types.md#bytes) | Yes |
| [`proto`](v6-0-0-plugins-outputs-loggly.md#v6.0.0-plugins-outputs-loggly-proto) | [string](/lsr/value-types.md#string) | No |
| [`proxy_host`](v6-0-0-plugins-outputs-loggly.md#v6.0.0-plugins-outputs-loggly-proxy_host) | [string](/lsr/value-types.md#string) | No |
| [`proxy_password`](v6-0-0-plugins-outputs-loggly.md#v6.0.0-plugins-outputs-loggly-proxy_password) | [password](/lsr/value-types.md#password) | No |
| [`proxy_port`](v6-0-0-plugins-outputs-loggly.md#v6.0.0-plugins-outputs-loggly-proxy_port) | [number](/lsr/value-types.md#number) | No |
| [`proxy_user`](v6-0-0-plugins-outputs-loggly.md#v6.0.0-plugins-outputs-loggly-proxy_user) | [string](/lsr/value-types.md#string) | No |
| [`retry_count`](v6-0-0-plugins-outputs-loggly.md#v6.0.0-plugins-outputs-loggly-retry_count) | [number](/lsr/value-types.md#number) | No |
| [`tag`](v6-0-0-plugins-outputs-loggly.md#v6.0.0-plugins-outputs-loggly-tag) | [string](/lsr/value-types.md#string) | No |
...
### `max_event_size` [v6.0.0-plugins-outputs-loggly-max_event_size]
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v6-0-0-plugins-outputs-loggly.md#v6.0.0-plugins-outputs-loggly-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v6-0-0-plugins-outputs-loggly.md#v6.0.0-plugins-outputs-loggly-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v6-0-0-plugins-outputs-loggly.md#v6.0.0-plugins-outputs-loggly-id) | [string](/lsr/value-types.md#string) | No |
