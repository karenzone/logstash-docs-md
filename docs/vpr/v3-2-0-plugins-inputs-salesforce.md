...
Also see [Common options](v3-2-0-plugins-inputs-salesforce.md#v3.2.0-plugins-inputs-salesforce-common-options) for a list of options supported by all input plugins.
