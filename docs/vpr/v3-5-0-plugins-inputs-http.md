...
| [`ssl`](v3-5-0-plugins-inputs-http.md#v3.5.0-plugins-inputs-http-ssl) | [boolean](/lsr/value-types.md#boolean) | No |
...
### `host` [v3.5.0-plugins-inputs-http-host]
...
### `add_field` [v3.5.0-plugins-inputs-http-add_field]
