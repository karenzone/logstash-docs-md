...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v3.0.4-plugins-codecs-gzip_lines.html
applies_to:
  stack: ga
---

# Gzip_lines codec plugin v3.0.4 [v3.0.4-plugins-codecs-gzip_lines]
