...
| [`docinfo`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-docinfo) | [boolean](/lsr/value-types.md#boolean) | No |
| [`docinfo_fields`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-docinfo_fields) | [array](/lsr/value-types.md#array) | No |
| [`docinfo_target`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-docinfo_target) | [string](/lsr/value-types.md#string) | No |
| [`hosts`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-hosts) | [array](/lsr/value-types.md#array) | No |
| [`index`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-index) | [string](/lsr/value-types.md#string) | No |
| [`password`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-password) | [password](/lsr/value-types.md#password) | No |
| [`query`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-query) | [string](/lsr/value-types.md#string) | No |
| [`schedule`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-schedule) | [string](/lsr/value-types.md#string) | No |
| [`scroll`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-scroll) | [string](/lsr/value-types.md#string) | No |
| [`size`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-size) | [number](/lsr/value-types.md#number) | No |
| [`slices`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-slices) | [number](/lsr/value-types.md#number) | No |
| [`ssl`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-ssl) | [boolean](/lsr/value-types.md#boolean) | No |
| [`user`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-user) | [string](/lsr/value-types.md#string) | No |

Also see [Common options](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-common-options) for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v4-3-1-plugins-inputs-elasticsearch.md#v4.3.1-plugins-inputs-elasticsearch-type) | [string](/lsr/value-types.md#string) | No |
