...
Also see [Common options](v2-0-7-plugins-filters-cipher.md#v2.0.7-plugins-filters-cipher-common-options) for a list of options supported by all filter plugins.
