...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v3.0.2-plugins-codecs-gzip_lines.html
---

# Gzip_lines codec plugin v3.0.2 [v3.0.2-plugins-codecs-gzip_lines]

* Plugin version: v3.0.2
* Released on: 2017-08-15
* [Changelog](https://github.com/logstash-plugins/logstash-codec-gzip_lines/blob/v3.0.2/CHANGELOG.md)
