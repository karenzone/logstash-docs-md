...
| :- | :- | :- |
| [`access_key_id`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-access_key_id) | [string](/lsr/value-types.md#string) | No |
| [`aws_credentials_file`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-aws_credentials_file) | [string](/lsr/value-types.md#string) | No |
| [`combined`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-combined) | [boolean](/lsr/value-types.md#boolean) | No |
| [`filters`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-filters) | [array](/lsr/value-types.md#array) | Yes |
| [`interval`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-interval) | [number](/lsr/value-types.md#number) | No |
| [`metrics`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-metrics) | [array](/lsr/value-types.md#array) | No |
| [`namespace`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-namespace) | [string](/lsr/value-types.md#string) | No |
| [`period`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-period) | [number](/lsr/value-types.md#number) | No |
| [`proxy_uri`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-proxy_uri) | [string](/lsr/value-types.md#string) | No |
| [`region`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-region) | [string](/lsr/value-types.md#string), one of `["us-east-1", "us-east-2", "us-west-1", "us-west-2", "eu-central-1", "eu-west-1", "eu-west-2", "ap-southeast-1", "ap-southeast-2", "ap-northeast-1", "ap-northeast-2", "sa-east-1", "us-gov-west-1", "cn-north-1", "ap-south-1", "ca-central-1"]` | No |
| [`secret_access_key`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-secret_access_key) | [string](/lsr/value-types.md#string) | No |
| [`session_token`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-session_token) | [string](/lsr/value-types.md#string) | No |
| [`statistics`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-statistics) | [array](/lsr/value-types.md#array) | No |
| [`use_ssl`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-use_ssl) | [boolean](/lsr/value-types.md#boolean) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v2-0-1-plugins-inputs-cloudwatch.md#v2.0.1-plugins-inputs-cloudwatch-type) | [string](/lsr/value-types.md#string) | No |

### `add_field` [v2.0.1-plugins-inputs-cloudwatch-add_field]
