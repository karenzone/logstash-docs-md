...
Also see [Common options](v3-1-0-plugins-filters-json.md#v3.1.0-plugins-filters-json-common-options) for a list of options supported by all filter plugins.
