...
Also see [Common options](v3-0-3-plugins-filters-csv.md#v3.0.3-plugins-filters-csv-common-options) for a list of options supported by all filter plugins.
...
### `add_field` [v3.0.3-plugins-filters-csv-add_field]
