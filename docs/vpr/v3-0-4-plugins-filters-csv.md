...
| :- | :- | :- |
| [`autodetect_column_names`](v3-0-4-plugins-filters-csv.md#v3.0.4-plugins-filters-csv-autodetect_column_names) | [boolean](/lsr/value-types.md#boolean) | No |
| [`autogenerate_column_names`](v3-0-4-plugins-filters-csv.md#v3.0.4-plugins-filters-csv-autogenerate_column_names) | [boolean](/lsr/value-types.md#boolean) | No |
| [`columns`](v3-0-4-plugins-filters-csv.md#v3.0.4-plugins-filters-csv-columns) | [array](/lsr/value-types.md#array) | No |
| [`convert`](v3-0-4-plugins-filters-csv.md#v3.0.4-plugins-filters-csv-convert) | [hash](/lsr/value-types.md#hash) | No |
| [`quote_char`](v3-0-4-plugins-filters-csv.md#v3.0.4-plugins-filters-csv-quote_char) | [string](/lsr/value-types.md#string) | No |
| [`separator`](v3-0-4-plugins-filters-csv.md#v3.0.4-plugins-filters-csv-separator) | [string](/lsr/value-types.md#string) | No |
| [`skip_empty_columns`](v3-0-4-plugins-filters-csv.md#v3.0.4-plugins-filters-csv-skip_empty_columns) | [boolean](/lsr/value-types.md#boolean) | No |
| [`source`](v3-0-4-plugins-filters-csv.md#v3.0.4-plugins-filters-csv-source) | [string](/lsr/value-types.md#string) | No |
| [`target`](v3-0-4-plugins-filters-csv.md#v3.0.4-plugins-filters-csv-target) | [string](/lsr/value-types.md#string) | No |

Also see [Common options](v3-0-4-plugins-filters-csv.md#v3.0.4-plugins-filters-csv-common-options) for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-4-plugins-filters-csv.md#v3.0.4-plugins-filters-csv-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v3-0-4-plugins-filters-csv.md#v3.0.4-plugins-filters-csv-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v3-0-4-plugins-filters-csv.md#v3.0.4-plugins-filters-csv-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-0-4-plugins-filters-csv.md#v3.0.4-plugins-filters-csv-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v3-0-4-plugins-filters-csv.md#v3.0.4-plugins-filters-csv-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v3-0-4-plugins-filters-csv.md#v3.0.4-plugins-filters-csv-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v3-0-4-plugins-filters-csv.md#v3.0.4-plugins-filters-csv-remove_tag) | [array](/lsr/value-types.md#array) | No |

### `add_field` [v3.0.4-plugins-filters-csv-add_field]
