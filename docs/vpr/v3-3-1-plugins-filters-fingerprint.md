...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v3.3.1-plugins-filters-fingerprint.html
applies_to:
  stack: ga
---

# Fingerprint filter plugin v3.3.1 [v3.3.1-plugins-filters-fingerprint]

* Plugin version: v3.3.1
* Released on: 2021-07-08
* [Changelog](https://github.com/logstash-plugins/logstash-filter-fingerprint/blob/v3.3.1/CHANGELOG.md)
...
## Event Metadata and the Elastic Common Schema (ECS) [v3.3.1-plugins-filters-fingerprint-ecs_metadata]
...
## Fingerprint Filter Configuration Options [v3.3.1-plugins-filters-fingerprint-options]

This plugin supports the following configuration options plus the [Common options](v3-3-1-plugins-filters-fingerprint.md#v3.3.1-plugins-filters-fingerprint-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`base64encode`](v3-3-1-plugins-filters-fingerprint.md#v3.3.1-plugins-filters-fingerprint-base64encode) | [boolean](/lsr/value-types.md#boolean) | No |
| [`concatenate_sources`](v3-3-1-plugins-filters-fingerprint.md#v3.3.1-plugins-filters-fingerprint-concatenate_sources) | [boolean](/lsr/value-types.md#boolean) | No |
| [`concatenate_all_fields`](v3-3-1-plugins-filters-fingerprint.md#v3.3.1-plugins-filters-fingerprint-concatenate_all_fields) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ecs_compatibility`](v3-3-1-plugins-filters-fingerprint.md#v3.3.1-plugins-filters-fingerprint-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`key`](v3-3-1-plugins-filters-fingerprint.md#v3.3.1-plugins-filters-fingerprint-key) | [string](/lsr/value-types.md#string) | No |
| [`method`](v3-3-1-plugins-filters-fingerprint.md#v3.3.1-plugins-filters-fingerprint-method) | [string](/lsr/value-types.md#string), one of `["SHA1", "SHA256", "SHA384", "SHA512", "MD5", "MURMUR3", "IPV4_NETWORK", "UUID", "PUNCTUATION"]` | Yes |
| [`source`](v3-3-1-plugins-filters-fingerprint.md#v3.3.1-plugins-filters-fingerprint-source) | [array](/lsr/value-types.md#array) | No |
| [`target`](v3-3-1-plugins-filters-fingerprint.md#v3.3.1-plugins-filters-fingerprint-target) | [string](/lsr/value-types.md#string) | No |

Also see [Common options](v3-3-1-plugins-filters-fingerprint.md#v3.3.1-plugins-filters-fingerprint-common-options) for a list of options supported by all filter plugins.

### `base64encode` [v3.3.1-plugins-filters-fingerprint-base64encode]
...
### `concatenate_sources` [v3.3.1-plugins-filters-fingerprint-concatenate_sources]
...
### `concatenate_all_fields` [v3.3.1-plugins-filters-fingerprint-concatenate_all_fields]
...
### `ecs_compatibility` [v3.3.1-plugins-filters-fingerprint-ecs_compatibility]
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/current). See [Event Metadata and the Elastic Common Schema (ECS)](v3-3-1-plugins-filters-fingerprint.md#v3.3.1-plugins-filters-fingerprint-ecs_metadata) for detailed information.

### `key` [v3.3.1-plugins-filters-fingerprint-key]
...
### `method` [v3.3.1-plugins-filters-fingerprint-method]
...
### `source` [v3.3.1-plugins-filters-fingerprint-source]
...
### `target` [v3.3.1-plugins-filters-fingerprint-target]
...
## Common options [v3.3.1-plugins-filters-fingerprint-common-options]

These configuration options are supported by all filter plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-3-1-plugins-filters-fingerprint.md#v3.3.1-plugins-filters-fingerprint-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v3-3-1-plugins-filters-fingerprint.md#v3.3.1-plugins-filters-fingerprint-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v3-3-1-plugins-filters-fingerprint.md#v3.3.1-plugins-filters-fingerprint-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-3-1-plugins-filters-fingerprint.md#v3.3.1-plugins-filters-fingerprint-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v3-3-1-plugins-filters-fingerprint.md#v3.3.1-plugins-filters-fingerprint-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v3-3-1-plugins-filters-fingerprint.md#v3.3.1-plugins-filters-fingerprint-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v3-3-1-plugins-filters-fingerprint.md#v3.3.1-plugins-filters-fingerprint-remove_tag) | [array](/lsr/value-types.md#array) | No |

### `add_field` [v3.3.1-plugins-filters-fingerprint-add_field]
...
### `add_tag` [v3.3.1-plugins-filters-fingerprint-add_tag]
...
### `enable_metric` [v3.3.1-plugins-filters-fingerprint-enable_metric]
...
### `id` [v3.3.1-plugins-filters-fingerprint-id]
...
### `periodic_flush` [v3.3.1-plugins-filters-fingerprint-periodic_flush]
...
### `remove_field` [v3.3.1-plugins-filters-fingerprint-remove_field]
...
### `remove_tag` [v3.3.1-plugins-filters-fingerprint-remove_tag]
