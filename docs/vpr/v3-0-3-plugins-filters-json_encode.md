...
| :- | :- | :- |
| [`source`](v3-0-3-plugins-filters-json_encode.md#v3.0.3-plugins-filters-json_encode-source) | [string](/lsr/value-types.md#string) | Yes |
| [`target`](v3-0-3-plugins-filters-json_encode.md#v3.0.3-plugins-filters-json_encode-target) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-3-plugins-filters-json_encode.md#v3.0.3-plugins-filters-json_encode-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v3-0-3-plugins-filters-json_encode.md#v3.0.3-plugins-filters-json_encode-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v3-0-3-plugins-filters-json_encode.md#v3.0.3-plugins-filters-json_encode-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-0-3-plugins-filters-json_encode.md#v3.0.3-plugins-filters-json_encode-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v3-0-3-plugins-filters-json_encode.md#v3.0.3-plugins-filters-json_encode-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v3-0-3-plugins-filters-json_encode.md#v3.0.3-plugins-filters-json_encode-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v3-0-3-plugins-filters-json_encode.md#v3.0.3-plugins-filters-json_encode-remove_tag) | [array](/lsr/value-types.md#array) | No |
