...
| :- | :- | :- |
| [`access_key_id`](v5-1-1-plugins-outputs-sqs.md#v5.1.1-plugins-outputs-sqs-access_key_id) | [string](/lsr/value-types.md#string) | No |
| [`aws_credentials_file`](v5-1-1-plugins-outputs-sqs.md#v5.1.1-plugins-outputs-sqs-aws_credentials_file) | [string](/lsr/value-types.md#string) | No |
| [`batch_events`](v5-1-1-plugins-outputs-sqs.md#v5.1.1-plugins-outputs-sqs-batch_events) | [number](/lsr/value-types.md#number) | No |
| [`endpoint`](v5-1-1-plugins-outputs-sqs.md#v5.1.1-plugins-outputs-sqs-endpoint) | [string](/lsr/value-types.md#string) | No |
| [`message_max_size`](v5-1-1-plugins-outputs-sqs.md#v5.1.1-plugins-outputs-sqs-message_max_size) | [bytes](/lsr/value-types.md#bytes) | No |
| [`proxy_uri`](v5-1-1-plugins-outputs-sqs.md#v5.1.1-plugins-outputs-sqs-proxy_uri) | [string](/lsr/value-types.md#string) | No |
| [`queue`](v5-1-1-plugins-outputs-sqs.md#v5.1.1-plugins-outputs-sqs-queue) | [string](/lsr/value-types.md#string) | Yes |
| [`region`](v5-1-1-plugins-outputs-sqs.md#v5.1.1-plugins-outputs-sqs-region) | [string](/lsr/value-types.md#string) | No |
| [`role_arn`](v5-1-1-plugins-outputs-sqs.md#v5.1.1-plugins-outputs-sqs-role_arn) | [string](/lsr/value-types.md#string) | No |
| [`role_session_name`](v5-1-1-plugins-outputs-sqs.md#v5.1.1-plugins-outputs-sqs-role_session_name) | [string](/lsr/value-types.md#string) | No |
| [`secret_access_key`](v5-1-1-plugins-outputs-sqs.md#v5.1.1-plugins-outputs-sqs-secret_access_key) | [string](/lsr/value-types.md#string) | No |
| [`session_token`](v5-1-1-plugins-outputs-sqs.md#v5.1.1-plugins-outputs-sqs-session_token) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v5-1-1-plugins-outputs-sqs.md#v5.1.1-plugins-outputs-sqs-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v5-1-1-plugins-outputs-sqs.md#v5.1.1-plugins-outputs-sqs-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v5-1-1-plugins-outputs-sqs.md#v5.1.1-plugins-outputs-sqs-id) | [string](/lsr/value-types.md#string) | No |
