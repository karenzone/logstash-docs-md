...
| :- | :- | :- |
| [`catch_all`](v3-0-6-plugins-inputs-irc.md#v3.0.6-plugins-inputs-irc-catch_all) | [boolean](/lsr/value-types.md#boolean) | No |
| [`channels`](v3-0-6-plugins-inputs-irc.md#v3.0.6-plugins-inputs-irc-channels) | [array](/lsr/value-types.md#array) | Yes |
| [`get_stats`](v3-0-6-plugins-inputs-irc.md#v3.0.6-plugins-inputs-irc-get_stats) | [boolean](/lsr/value-types.md#boolean) | No |
| [`host`](v3-0-6-plugins-inputs-irc.md#v3.0.6-plugins-inputs-irc-host) | [string](/lsr/value-types.md#string) | Yes |
| [`nick`](v3-0-6-plugins-inputs-irc.md#v3.0.6-plugins-inputs-irc-nick) | [string](/lsr/value-types.md#string) | No |
| [`password`](v3-0-6-plugins-inputs-irc.md#v3.0.6-plugins-inputs-irc-password) | [password](/lsr/value-types.md#password) | No |
| [`port`](v3-0-6-plugins-inputs-irc.md#v3.0.6-plugins-inputs-irc-port) | [number](/lsr/value-types.md#number) | No |
| [`real`](v3-0-6-plugins-inputs-irc.md#v3.0.6-plugins-inputs-irc-real) | [string](/lsr/value-types.md#string) | No |
| [`secure`](v3-0-6-plugins-inputs-irc.md#v3.0.6-plugins-inputs-irc-secure) | [boolean](/lsr/value-types.md#boolean) | No |
| [`stats_interval`](v3-0-6-plugins-inputs-irc.md#v3.0.6-plugins-inputs-irc-stats_interval) | [number](/lsr/value-types.md#number) | No |
| [`user`](v3-0-6-plugins-inputs-irc.md#v3.0.6-plugins-inputs-irc-user) | [string](/lsr/value-types.md#string) | No |

Also see [Common options](v3-0-6-plugins-inputs-irc.md#v3.0.6-plugins-inputs-irc-common-options) for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-6-plugins-inputs-irc.md#v3.0.6-plugins-inputs-irc-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v3-0-6-plugins-inputs-irc.md#v3.0.6-plugins-inputs-irc-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-0-6-plugins-inputs-irc.md#v3.0.6-plugins-inputs-irc-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-0-6-plugins-inputs-irc.md#v3.0.6-plugins-inputs-irc-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v3-0-6-plugins-inputs-irc.md#v3.0.6-plugins-inputs-irc-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v3-0-6-plugins-inputs-irc.md#v3.0.6-plugins-inputs-irc-type) | [string](/lsr/value-types.md#string) | No |

### `add_field` [v3.0.6-plugins-inputs-irc-add_field]
