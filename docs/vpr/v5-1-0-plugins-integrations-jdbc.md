...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v5.1.0-plugins-integrations-jdbc.html
---

# JDBC Integration Plugin v5.1.0 [v5.1.0-plugins-integrations-jdbc]
