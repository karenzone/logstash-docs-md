...
| :- | :- | :- |
| [`every`](v3-0-4-plugins-filters-sleep.md#v3.0.4-plugins-filters-sleep-every) | [string](/lsr/value-types.md#string) | No |
| [`replay`](v3-0-4-plugins-filters-sleep.md#v3.0.4-plugins-filters-sleep-replay) | [boolean](/lsr/value-types.md#boolean) | No |
| [`time`](v3-0-4-plugins-filters-sleep.md#v3.0.4-plugins-filters-sleep-time) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-4-plugins-filters-sleep.md#v3.0.4-plugins-filters-sleep-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v3-0-4-plugins-filters-sleep.md#v3.0.4-plugins-filters-sleep-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v3-0-4-plugins-filters-sleep.md#v3.0.4-plugins-filters-sleep-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-0-4-plugins-filters-sleep.md#v3.0.4-plugins-filters-sleep-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v3-0-4-plugins-filters-sleep.md#v3.0.4-plugins-filters-sleep-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v3-0-4-plugins-filters-sleep.md#v3.0.4-plugins-filters-sleep-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v3-0-4-plugins-filters-sleep.md#v3.0.4-plugins-filters-sleep-remove_tag) | [array](/lsr/value-types.md#array) | No |
