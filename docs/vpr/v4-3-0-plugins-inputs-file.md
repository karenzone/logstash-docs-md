...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v4.3.0-plugins-inputs-file.html
applies_to:
  stack: ga
---

# File input plugin v4.3.0 [v4.3.0-plugins-inputs-file]

* Plugin version: v4.3.0
* Released on: 2021-04-30
* [Changelog](https://github.com/logstash-plugins/logstash-input-file/blob/v4.3.0/CHANGELOG.md)
...
In some cases it is useful to be able to control which files are read first, sorting, and whether files are read completely or banded/striped. Complete reading is **all of** file A then file B then file C and so on. Banded or striped reading is **some of** file A then file B then file C and so on looping around to file A again until all files are read. Banded reading is specified by changing [`file_chunk_count`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-file_chunk_count) and perhaps [`file_chunk_size`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-file_chunk_size). Banding and sorting may be useful if you want some events from all files to appear in Kibana as early as possible.
...
## Compatibility with the Elastic Common Schema (ECS) [v4.3.0-plugins-inputs-file-ecs]

This plugin adds metadata about event’s source, and can be configured to do so in an [ECS-compatible](https://www.elastic.co/guide/en/ecs/current) way with [`ecs_compatibility`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-ecs_compatibility). This metadata is added after the event has been decoded by the appropriate codec, and will never overwrite existing values.
...
## File Input Configuration Options [v4.3.0-plugins-inputs-file-options]

This plugin supports the following configuration options plus the [Common options](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-common-options) described later.

Duration settings can be specified in text form e.g. "250 ms", this string will be converted into decimal seconds. There are quite a few supported natural and abbreviated durations, see [string_duration](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-string_duration) for the details.

| Setting | Input type | Required |
| :- | :- | :- |
| [`check_archive_validity`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-check_archive_validity) | [boolean](/lsr/value-types.md#boolean) | No |
| [`close_older`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-close_older) | [number](/lsr/value-types.md#number) or [string_duration](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-string_duration) | No |
| [`delimiter`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-delimiter) | [string](/lsr/value-types.md#string) | No |
| [`discover_interval`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-discover_interval) | [number](/lsr/value-types.md#number) | No |
| [`ecs_compatibility`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`exclude`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-exclude) | [array](/lsr/value-types.md#array) | No |
| [`exit_after_read`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-exit_after_read) | [boolean](/lsr/value-types.md#boolean) | No |
| [`file_chunk_count`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-file_chunk_count) | [number](/lsr/value-types.md#number) | No |
| [`file_chunk_size`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-file_chunk_size) | [number](/lsr/value-types.md#number) | No |
| [`file_completed_action`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-file_completed_action) | [string](/lsr/value-types.md#string), one of `["delete", "log", "log_and_delete"]` | No |
| [`file_completed_log_path`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-file_completed_log_path) | [string](/lsr/value-types.md#string) | No |
| [`file_sort_by`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-file_sort_by) | [string](/lsr/value-types.md#string), one of `["last_modified", "path"]` | No |
| [`file_sort_direction`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-file_sort_direction) | [string](/lsr/value-types.md#string), one of `["asc", "desc"]` | No |
| [`ignore_older`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-ignore_older) | [number](/lsr/value-types.md#number) or [string_duration](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-string_duration) | No |
| [`max_open_files`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-max_open_files) | [number](/lsr/value-types.md#number) | No |
| [`mode`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-mode) | [string](/lsr/value-types.md#string), one of `["tail", "read"]` | No |
| [`path`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-path) | [array](/lsr/value-types.md#array) | Yes |
| [`sincedb_clean_after`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-sincedb_clean_after) | [number](/lsr/value-types.md#number) or [string_duration](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-string_duration) | No |
| [`sincedb_path`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-sincedb_path) | [string](/lsr/value-types.md#string) | No |
| [`sincedb_write_interval`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-sincedb_write_interval) | [number](/lsr/value-types.md#number) or [string_duration](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-string_duration) | No |
| [`start_position`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-start_position) | [string](/lsr/value-types.md#string), one of `["beginning", "end"]` | No |
| [`stat_interval`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-stat_interval) | [number](/lsr/value-types.md#number) or [string_duration](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-string_duration) | No |

Also see [Common options](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-common-options) for a list of options supported by all input plugins.

### `check_archive_validity` [v4.3.0-plugins-inputs-file-check_archive_validity]
...
### `close_older` [v4.3.0-plugins-inputs-file-close_older]

* Value type is [number](/lsr/value-types.md#number) or [string_duration](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-string_duration)
...
### `delimiter` [v4.3.0-plugins-inputs-file-delimiter]
...
### `discover_interval` [v4.3.0-plugins-inputs-file-discover_interval]
...
### `ecs_compatibility` [v4.3.0-plugins-inputs-file-ecs_compatibility]
...
### `exclude` [v4.3.0-plugins-inputs-file-exclude]
...
### `exit_after_read` [v4.3.0-plugins-inputs-file-exit_after_read]
...
### `file_chunk_count` [v4.3.0-plugins-inputs-file-file_chunk_count]
...
### `file_chunk_size` [v4.3.0-plugins-inputs-file-file_chunk_size]

* Value type is [number](/lsr/value-types.md#number)
* Default value is `32768` (32KB)

File content is read off disk in blocks or chunks and lines are extracted from the chunk. See [`file_chunk_count`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-file_chunk_count) to see why and when to change this setting from the default.

### `file_completed_action` [v4.3.0-plugins-inputs-file-file_completed_action]
...
### `file_completed_log_path` [v4.3.0-plugins-inputs-file-file_completed_log_path]
...
### `file_sort_by` [v4.3.0-plugins-inputs-file-file_sort_by]
...
### `file_sort_direction` [v4.3.0-plugins-inputs-file-file_sort_direction]
...
### `ignore_older` [v4.3.0-plugins-inputs-file-ignore_older]
...
### `max_open_files` [v4.3.0-plugins-inputs-file-max_open_files]
...
### `mode` [v4.3.0-plugins-inputs-file-mode]
...
### `path` [v4.3.0-plugins-inputs-file-path]
...
### `sincedb_clean_after` [v4.3.0-plugins-inputs-file-sincedb_clean_after]
...
### `sincedb_path` [v4.3.0-plugins-inputs-file-sincedb_path]
...
### `sincedb_write_interval` [v4.3.0-plugins-inputs-file-sincedb_write_interval]
...
### `start_position` [v4.3.0-plugins-inputs-file-start_position]
...
### `stat_interval` [v4.3.0-plugins-inputs-file-stat_interval]
...
## Common options [v4.3.0-plugins-inputs-file-common-options]

These configuration options are supported by all input plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v4-3-0-plugins-inputs-file.md#v4.3.0-plugins-inputs-file-type) | [string](/lsr/value-types.md#string) | No |

### `add_field` [v4.3.0-plugins-inputs-file-add_field]
...
### `codec` [v4.3.0-plugins-inputs-file-codec]
...
### `enable_metric` [v4.3.0-plugins-inputs-file-enable_metric]
...
### `id` [v4.3.0-plugins-inputs-file-id]
...
### `tags` [v4.3.0-plugins-inputs-file-tags]
...
### `type` [v4.3.0-plugins-inputs-file-type]
...
## String Durations [v4.3.0-plugins-inputs-file-string_duration]
