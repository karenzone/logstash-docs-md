...
## Date Filter Configuration Options [v3.1.15-plugins-filters-date-options]

This plugin supports the following configuration options plus the [Common options](v3-1-15-plugins-filters-date.md#v3.1.15-plugins-filters-date-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`locale`](v3-1-15-plugins-filters-date.md#v3.1.15-plugins-filters-date-locale) | [string](/lsr/value-types.md#string) | No |
| [`match`](v3-1-15-plugins-filters-date.md#v3.1.15-plugins-filters-date-match) | [array](/lsr/value-types.md#array) | No |
| [`tag_on_failure`](v3-1-15-plugins-filters-date.md#v3.1.15-plugins-filters-date-tag_on_failure) | [array](/lsr/value-types.md#array) | No |
| [`target`](v3-1-15-plugins-filters-date.md#v3.1.15-plugins-filters-date-target) | [string](/lsr/value-types.md#string) | No |
| [`timezone`](v3-1-15-plugins-filters-date.md#v3.1.15-plugins-filters-date-timezone) | [string](/lsr/value-types.md#string) | No |

Also see [Common options](v3-1-15-plugins-filters-date.md#v3.1.15-plugins-filters-date-common-options) for a list of options supported by all filter plugins.

### `locale` [v3.1.15-plugins-filters-date-locale]
...
### `match` [v3.1.15-plugins-filters-date-match]
...
### `tag_on_failure` [v3.1.15-plugins-filters-date-tag_on_failure]
...
### `target` [v3.1.15-plugins-filters-date-target]
...
### `timezone` [v3.1.15-plugins-filters-date-timezone]
...
## Common options [v3.1.15-plugins-filters-date-common-options]

These configuration options are supported by all filter plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-1-15-plugins-filters-date.md#v3.1.15-plugins-filters-date-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v3-1-15-plugins-filters-date.md#v3.1.15-plugins-filters-date-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v3-1-15-plugins-filters-date.md#v3.1.15-plugins-filters-date-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-1-15-plugins-filters-date.md#v3.1.15-plugins-filters-date-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v3-1-15-plugins-filters-date.md#v3.1.15-plugins-filters-date-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v3-1-15-plugins-filters-date.md#v3.1.15-plugins-filters-date-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v3-1-15-plugins-filters-date.md#v3.1.15-plugins-filters-date-remove_tag) | [array](/lsr/value-types.md#array) | No |

### `add_field` [v3.1.15-plugins-filters-date-add_field]
...
### `add_tag` [v3.1.15-plugins-filters-date-add_tag]
...
### `enable_metric` [v3.1.15-plugins-filters-date-enable_metric]
...
### `id` [v3.1.15-plugins-filters-date-id]
...
### `periodic_flush` [v3.1.15-plugins-filters-date-periodic_flush]
...
### `remove_field` [v3.1.15-plugins-filters-date-remove_field]
...
### `remove_tag` [v3.1.15-plugins-filters-date-remove_tag]
