...
| :- | :- | :- |
| [`facility_labels`](v3-4-4-plugins-inputs-syslog.md#v3.4.4-plugins-inputs-syslog-facility_labels) | [array](/lsr/value-types.md#array) | No |
| [`grok_pattern`](v3-4-4-plugins-inputs-syslog.md#v3.4.4-plugins-inputs-syslog-grok_pattern) | [string](/lsr/value-types.md#string) | No |
| [`host`](v3-4-4-plugins-inputs-syslog.md#v3.4.4-plugins-inputs-syslog-host) | [string](/lsr/value-types.md#string) | No |
| [`locale`](v3-4-4-plugins-inputs-syslog.md#v3.4.4-plugins-inputs-syslog-locale) | [string](/lsr/value-types.md#string) | No |
| [`port`](v3-4-4-plugins-inputs-syslog.md#v3.4.4-plugins-inputs-syslog-port) | [number](/lsr/value-types.md#number) | No |
| [`proxy_protocol`](v3-4-4-plugins-inputs-syslog.md#v3.4.4-plugins-inputs-syslog-proxy_protocol) | [boolean](/lsr/value-types.md#boolean) | No |
| [`severity_labels`](v3-4-4-plugins-inputs-syslog.md#v3.4.4-plugins-inputs-syslog-severity_labels) | [array](/lsr/value-types.md#array) | No |
| [`syslog_field`](v3-4-4-plugins-inputs-syslog.md#v3.4.4-plugins-inputs-syslog-syslog_field) | [string](/lsr/value-types.md#string) | No |
| [`timezone`](v3-4-4-plugins-inputs-syslog.md#v3.4.4-plugins-inputs-syslog-timezone) | [string](/lsr/value-types.md#string) | No |
| [`use_labels`](v3-4-4-plugins-inputs-syslog.md#v3.4.4-plugins-inputs-syslog-use_labels) | [boolean](/lsr/value-types.md#boolean) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-4-4-plugins-inputs-syslog.md#v3.4.4-plugins-inputs-syslog-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v3-4-4-plugins-inputs-syslog.md#v3.4.4-plugins-inputs-syslog-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-4-4-plugins-inputs-syslog.md#v3.4.4-plugins-inputs-syslog-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-4-4-plugins-inputs-syslog.md#v3.4.4-plugins-inputs-syslog-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v3-4-4-plugins-inputs-syslog.md#v3.4.4-plugins-inputs-syslog-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v3-4-4-plugins-inputs-syslog.md#v3.4.4-plugins-inputs-syslog-type) | [string](/lsr/value-types.md#string) | No |
