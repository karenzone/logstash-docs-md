...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v7.1.1-plugins-integrations-rabbitmq.html
---

# Rabbitmq Integration Plugin v7.1.1 [v7.1.1-plugins-integrations-rabbitmq]
