...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v4.3.3-plugins-filters-kv.html
---

# Kv filter plugin v4.3.3 [v4.3.3-plugins-filters-kv]

* Plugin version: v4.3.3
* Released on: 2019-06-21
* [Changelog](https://github.com/logstash-plugins/logstash-filter-kv/blob/v4.3.3/CHANGELOG.md)
...
## Kv Filter Configuration Options [v4.3.3-plugins-filters-kv-options]

This plugin supports the following configuration options plus the [Common options](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`allow_duplicate_values`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-allow_duplicate_values) | [boolean](/lsr/value-types.md#boolean) | No |
| [`default_keys`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-default_keys) | [hash](/lsr/value-types.md#hash) | No |
| [`exclude_keys`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-exclude_keys) | [array](/lsr/value-types.md#array) | No |
| [`field_split`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-field_split) | [string](/lsr/value-types.md#string) | No |
| [`field_split_pattern`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-field_split_pattern) | [string](/lsr/value-types.md#string) | No |
| [`include_brackets`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-include_brackets) | [boolean](/lsr/value-types.md#boolean) | No |
| [`include_keys`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-include_keys) | [array](/lsr/value-types.md#array) | No |
| [`prefix`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-prefix) | [string](/lsr/value-types.md#string) | No |
| [`recursive`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-recursive) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_char_key`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-remove_char_key) | [string](/lsr/value-types.md#string) | No |
| [`remove_char_value`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-remove_char_value) | [string](/lsr/value-types.md#string) | No |
| [`source`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-source) | [string](/lsr/value-types.md#string) | No |
| [`target`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-target) | [string](/lsr/value-types.md#string) | No |
| [`tag_on_failure`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-tag_on_failure) | [string](/lsr/value-types.md#string) | No |
| [`tag_on_timeout`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-tag_on_timeout) | [string](/lsr/value-types.md#string) | No |
| [`timeout_millis`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-timeout_millis) | [number](/lsr/value-types.md#number) | No |
| [`transform_key`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-transform_key) | [string](/lsr/value-types.md#string), one of `["lowercase", "uppercase", "capitalize"]` | No |
| [`transform_value`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-transform_value) | [string](/lsr/value-types.md#string), one of `["lowercase", "uppercase", "capitalize"]` | No |
| [`trim_key`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-trim_key) | [string](/lsr/value-types.md#string) | No |
| [`trim_value`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-trim_value) | [string](/lsr/value-types.md#string) | No |
| [`value_split`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-value_split) | [string](/lsr/value-types.md#string) | No |
| [`value_split_pattern`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-value_split_pattern) | [string](/lsr/value-types.md#string) | No |
| [`whitespace`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-whitespace) | [string](/lsr/value-types.md#string), one of `["strict", "lenient"]` | No |

Also see [Common options](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-common-options) for a list of options supported by all filter plugins.

### `allow_duplicate_values` [v4.3.3-plugins-filters-kv-allow_duplicate_values]
...
### `default_keys` [v4.3.3-plugins-filters-kv-default_keys]
...
### `exclude_keys` [v4.3.3-plugins-filters-kv-exclude_keys]
...
### `field_split` [v4.3.3-plugins-filters-kv-field_split]
...
### `field_split_pattern` [v4.3.3-plugins-filters-kv-field_split_pattern]
...
### `include_brackets` [v4.3.3-plugins-filters-kv-include_brackets]
...
### `include_keys` [v4.3.3-plugins-filters-kv-include_keys]
...
### `prefix` [v4.3.3-plugins-filters-kv-prefix]
...
### `recursive` [v4.3.3-plugins-filters-kv-recursive]
...
### `remove_char_key` [v4.3.3-plugins-filters-kv-remove_char_key]
...
### `remove_char_value` [v4.3.3-plugins-filters-kv-remove_char_value]
...
### `source` [v4.3.3-plugins-filters-kv-source]
...
### `target` [v4.3.3-plugins-filters-kv-target]
...
### `tag_on_failure` [v4.3.3-plugins-filters-kv-tag_on_failure]
...
### `tag_on_timeout` [v4.3.3-plugins-filters-kv-tag_on_timeout]

* Value type is [string](/lsr/value-types.md#string)
* The default value for this setting is `_kv_filter_timeout`.

When timeouts are enabled and a kv operation is aborted, the event is tagged with the provided value (see: [`timeout_millis`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-timeout_millis)).

### `timeout_millis` [v4.3.3-plugins-filters-kv-timeout_millis]

* Value type is [number](/lsr/value-types.md#number)
* The default value for this setting is 30000 (30 seconds).
* Set to zero (`0`) to disable timeouts

Timeouts provide a safeguard against inputs that are pathological against the regular expressions that are used to extract key/value pairs. When parsing an event exceeds this threshold the operation is aborted and the event is tagged in order to prevent the operation from blocking the pipeline (see: [`tag_on_timeout`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-tag_on_timeout)).

### `transform_key` [v4.3.3-plugins-filters-kv-transform_key]
...
### `transform_value` [v4.3.3-plugins-filters-kv-transform_value]
...
### `trim_key` [v4.3.3-plugins-filters-kv-trim_key]
...
### `trim_value` [v4.3.3-plugins-filters-kv-trim_value]
...
### `value_split` [v4.3.3-plugins-filters-kv-value_split]
...
### `value_split_pattern` [v4.3.3-plugins-filters-kv-value_split_pattern]
...
### `whitespace` [v4.3.3-plugins-filters-kv-whitespace]
...
## Common options [v4.3.3-plugins-filters-kv-common-options]

These configuration options are supported by all filter plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v4-3-3-plugins-filters-kv.md#v4.3.3-plugins-filters-kv-remove_tag) | [array](/lsr/value-types.md#array) | No |

### `add_field` [v4.3.3-plugins-filters-kv-add_field]
...
### `add_tag` [v4.3.3-plugins-filters-kv-add_tag]
...
### `enable_metric` [v4.3.3-plugins-filters-kv-enable_metric]
...
### `id` [v4.3.3-plugins-filters-kv-id]
...
### `periodic_flush` [v4.3.3-plugins-filters-kv-periodic_flush]
...
### `remove_field` [v4.3.3-plugins-filters-kv-remove_field]
...
### `remove_tag` [v4.3.3-plugins-filters-kv-remove_tag]
