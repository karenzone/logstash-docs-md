...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v3.0.1-plugins-codecs-gzip_lines.html
applies_to:
  stack: ga
---

# Gzip_lines codec plugin v3.0.1 [v3.0.1-plugins-codecs-gzip_lines]

* Plugin version: v3.0.1
* Released on: 2017-06-23
* [Changelog](https://github.com/logstash-plugins/logstash-codec-gzip_lines/blob/v3.0.1/CHANGELOG.md)
