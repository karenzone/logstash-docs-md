...
| [`value_serializer`](v6-2-4-plugins-outputs-kafka.md#v6.2.4-plugins-outputs-kafka-value_serializer) | [string](/lsr/value-types.md#string) | No |
...
### `ssl_keystore_type` [v6.2.4-plugins-outputs-kafka-ssl_keystore_type]
