...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v1.0.3-plugins-inputs-google_pubsub.html
applies_to:
  stack: ga
---

# Google_pubsub input plugin v1.0.3 [v1.0.3-plugins-inputs-google_pubsub]

* Plugin version: v1.0.3
* Released on: 2017-08-15
* [Changelog](https://github.com/logstash-plugins/logstash-input-google_pubsub/blob/v1.0.3/CHANGELOG.md)
...
## Google_pubsub Input Configuration Options [v1.0.3-plugins-inputs-google_pubsub-options]

This plugin supports the following configuration options plus the [Common options](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`json_key_file`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-json_key_file) | a valid filesystem path | No |
| [`max_messages`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-max_messages) | [number](/lsr/value-types.md#number) | Yes |
| [`project_id`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-project_id) | [string](/lsr/value-types.md#string) | Yes |
| [`subscription`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-subscription) | [string](/lsr/value-types.md#string) | Yes |
| [`topic`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-topic) | [string](/lsr/value-types.md#string) | Yes |

Also see [Common options](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-common-options) for a list of options supported by all input plugins.

### `json_key_file` [v1.0.3-plugins-inputs-google_pubsub-json_key_file]
...
### `max_messages` [v1.0.3-plugins-inputs-google_pubsub-max_messages]

* This is a required setting.
* Value type is [number](/lsr/value-types.md#number)
* Default value is `5`

### `project_id` [v1.0.3-plugins-inputs-google_pubsub-project_id]
...
### `subscription` [v1.0.3-plugins-inputs-google_pubsub-subscription]

* This is a required setting.
* Value type is [string](/lsr/value-types.md#string)
* There is no default value for this setting.

### `topic` [v1.0.3-plugins-inputs-google_pubsub-topic]
...
## Common options [v1.0.3-plugins-inputs-google_pubsub-common-options]

These configuration options are supported by all input plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v1-0-3-plugins-inputs-google_pubsub.md#v1.0.3-plugins-inputs-google_pubsub-type) | [string](/lsr/value-types.md#string) | No |

### `add_field` [v1.0.3-plugins-inputs-google_pubsub-add_field]
...
### `codec` [v1.0.3-plugins-inputs-google_pubsub-codec]
...
### `enable_metric` [v1.0.3-plugins-inputs-google_pubsub-enable_metric]
...
### `id` [v1.0.3-plugins-inputs-google_pubsub-id]
...
### `tags` [v1.0.3-plugins-inputs-google_pubsub-tags]
...
### `type` [v1.0.3-plugins-inputs-google_pubsub-type]
