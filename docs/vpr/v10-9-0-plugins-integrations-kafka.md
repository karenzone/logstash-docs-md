...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v10.9.0-plugins-integrations-kafka.html
---

# Kafka Integration Plugin v10.9.0 [v10.9.0-plugins-integrations-kafka]

* Plugin version: v10.9.0
