...
| :- | :- | :- |
| [`algorithm`](v3-0-6-plugins-filters-anonymize.md#v3.0.6-plugins-filters-anonymize-algorithm) | [string](/lsr/value-types.md#string), one of `["SHA1", "SHA256", "SHA384", "SHA512", "MD5", "MURMUR3", "IPV4_NETWORK"]` | Yes |
| [`fields`](v3-0-6-plugins-filters-anonymize.md#v3.0.6-plugins-filters-anonymize-fields) | [array](/lsr/value-types.md#array) | Yes |
| [`key`](v3-0-6-plugins-filters-anonymize.md#v3.0.6-plugins-filters-anonymize-key) | [string](/lsr/value-types.md#string) | Yes |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-6-plugins-filters-anonymize.md#v3.0.6-plugins-filters-anonymize-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v3-0-6-plugins-filters-anonymize.md#v3.0.6-plugins-filters-anonymize-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v3-0-6-plugins-filters-anonymize.md#v3.0.6-plugins-filters-anonymize-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-0-6-plugins-filters-anonymize.md#v3.0.6-plugins-filters-anonymize-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v3-0-6-plugins-filters-anonymize.md#v3.0.6-plugins-filters-anonymize-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v3-0-6-plugins-filters-anonymize.md#v3.0.6-plugins-filters-anonymize-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v3-0-6-plugins-filters-anonymize.md#v3.0.6-plugins-filters-anonymize-remove_tag) | [array](/lsr/value-types.md#array) | No |
