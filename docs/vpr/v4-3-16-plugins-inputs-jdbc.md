...
| [`prepared_statement_bind_values`](v4-3-16-plugins-inputs-jdbc.md#v4.3.16-plugins-inputs-jdbc-prepared_statement_bind_values) | [array](/lsr/value-types.md#array) | No |
