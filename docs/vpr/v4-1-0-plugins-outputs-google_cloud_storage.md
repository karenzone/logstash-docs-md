...
| :- | :- | :- |
| [`bucket`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-bucket) | [string](/lsr/value-types.md#string) | Yes |
| [`date_pattern`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-date_pattern) | [string](/lsr/value-types.md#string) | No |
| [`flush_interval_secs`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-flush_interval_secs) | [number](/lsr/value-types.md#number) | No |
| [`gzip`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-gzip) | [boolean](/lsr/value-types.md#boolean) | No |
| [`gzip_content_encoding`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-gzip_content_encoding) | [boolean](/lsr/value-types.md#boolean) | No |
| [`include_hostname`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-include_hostname) | [boolean](/lsr/value-types.md#boolean) | No |
| [`include_uuid`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-include_uuid) | [boolean](/lsr/value-types.md#boolean) | No |
| [`json_key_file`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-json_key_file) | [string](/lsr/value-types.md#string) | No |
| [`key_password`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-key_password) | [string](/lsr/value-types.md#string) | *Deprecated* |
| [`key_path`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-key_path) | [string](/lsr/value-types.md#string) | **Obsolete** |
| [`log_file_prefix`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-log_file_prefix) | [string](/lsr/value-types.md#string) | No |
| [`max_concurrent_uploads`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-max_concurrent_uploads) | [number](/lsr/value-types.md#number) | No |
| [`max_file_size_kbytes`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-max_file_size_kbytes) | [number](/lsr/value-types.md#number) | No |
| [`output_format`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-output_format) | [string](/lsr/value-types.md#string), one of `["json", "plain", nil]` | *Deprecated* |
| [`service_account`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-service_account) | [string](/lsr/value-types.md#string) | *Deprecated* |
| [`temp_directory`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-temp_directory) | [string](/lsr/value-types.md#string) | No |
| [`uploader_interval_secs`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-uploader_interval_secs) | [number](/lsr/value-types.md#number) | No |

Also see [Common options](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-common-options) for a list of options supported by all output plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v4-1-0-plugins-outputs-google_cloud_storage.md#v4.1.0-plugins-outputs-google_cloud_storage-id) | [string](/lsr/value-types.md#string) | No |
