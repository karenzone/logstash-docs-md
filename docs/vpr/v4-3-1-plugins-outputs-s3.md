...
| [`server_side_encryption_algorithm`](v4-3-1-plugins-outputs-s3.md#v4.3.1-plugins-outputs-s3-server_side_encryption_algorithm) | [string](/lsr/value-types.md#string), one of `["AES256", "aws:kms"]` | No |
