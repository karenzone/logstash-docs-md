...
**Configuring filebeat**Next, [install filebeat](https://www.elastic.co/guide/en/beats/filebeat/5.5/filebeat-installation.html). Based on the above log4j.properties, we can use this filebeat configuration:
...
| :- | :- | :- |
| [`host`](v3-0-6-plugins-inputs-log4j.md#v3.0.6-plugins-inputs-log4j-host) | [string](/lsr/value-types.md#string) | No |
| [`mode`](v3-0-6-plugins-inputs-log4j.md#v3.0.6-plugins-inputs-log4j-mode) | [string](/lsr/value-types.md#string), one of `["server", "client"]` | No |
| [`port`](v3-0-6-plugins-inputs-log4j.md#v3.0.6-plugins-inputs-log4j-port) | [number](/lsr/value-types.md#number) | No |
| [`proxy_protocol`](v3-0-6-plugins-inputs-log4j.md#v3.0.6-plugins-inputs-log4j-proxy_protocol) | [boolean](/lsr/value-types.md#boolean) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-6-plugins-inputs-log4j.md#v3.0.6-plugins-inputs-log4j-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v3-0-6-plugins-inputs-log4j.md#v3.0.6-plugins-inputs-log4j-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-0-6-plugins-inputs-log4j.md#v3.0.6-plugins-inputs-log4j-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-0-6-plugins-inputs-log4j.md#v3.0.6-plugins-inputs-log4j-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v3-0-6-plugins-inputs-log4j.md#v3.0.6-plugins-inputs-log4j-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v3-0-6-plugins-inputs-log4j.md#v3.0.6-plugins-inputs-log4j-type) | [string](/lsr/value-types.md#string) | No |
