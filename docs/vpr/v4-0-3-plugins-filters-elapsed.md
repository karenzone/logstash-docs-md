...
Also see [Common options](v4-0-3-plugins-filters-elapsed.md#v4.0.3-plugins-filters-elapsed-common-options) for a list of options supported by all filter plugins.
