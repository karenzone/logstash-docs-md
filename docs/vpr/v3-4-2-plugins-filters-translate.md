...
Also see [Common options](v3-4-2-plugins-filters-translate.md#v3.4.2-plugins-filters-translate-common-options) for a list of options supported by all filter plugins.
