...
Also see [Common options](v3-1-0-plugins-inputs-http.md#v3.1.0-plugins-inputs-http-common-options) for a list of options supported by all input plugins.
...
### `add_field` [v3.1.0-plugins-inputs-http-add_field]
