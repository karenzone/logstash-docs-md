...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v1.2.3-plugins-filters-dissect.html
---

# Dissect filter plugin v1.2.3 [v1.2.3-plugins-filters-dissect]

* Plugin version: v1.2.3
* Released on: 2021-12-18
* [Changelog](https://github.com/logstash-plugins/logstash-filter-dissect/blob/v1.2.3/CHANGELOG.md)
...
[Normal field notation](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-normal)

[Skip field notation](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-skip)

[Append field notation](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-append)

[Indirect field notation](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-indirect)
...
### Normal field notation [v1.2.3-plugins-filters-dissect-normal]
...
### Skip field notation [v1.2.3-plugins-filters-dissect-skip]
...
### Append field notation [v1.2.3-plugins-filters-dissect-append]
...
### Indirect field notation [v1.2.3-plugins-filters-dissect-indirect]
...
## Dissect Filter Configuration Options [v1.2.3-plugins-filters-dissect-options]

This plugin supports the following configuration options plus the [Common options](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`convert_datatype`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-convert_datatype) | [hash](/lsr/value-types.md#hash) | No |
| [`mapping`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-mapping) | [hash](/lsr/value-types.md#hash) | No |
| [`tag_on_failure`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-tag_on_failure) | [array](/lsr/value-types.md#array) | No |

Also see [Common options](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-common-options) for a list of options supported by all filter plugins.

### `convert_datatype` [v1.2.3-plugins-filters-dissect-convert_datatype]
...
### `mapping` [v1.2.3-plugins-filters-dissect-mapping]
...
### `tag_on_failure` [v1.2.3-plugins-filters-dissect-tag_on_failure]
...
## Common options [v1.2.3-plugins-filters-dissect-common-options]

These configuration options are supported by all filter plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v1-2-3-plugins-filters-dissect.md#v1.2.3-plugins-filters-dissect-remove_tag) | [array](/lsr/value-types.md#array) | No |

### `add_field` [v1.2.3-plugins-filters-dissect-add_field]
...
### `add_tag` [v1.2.3-plugins-filters-dissect-add_tag]
...
### `enable_metric` [v1.2.3-plugins-filters-dissect-enable_metric]
...
### `id` [v1.2.3-plugins-filters-dissect-id]
...
### `periodic_flush` [v1.2.3-plugins-filters-dissect-periodic_flush]
...
### `remove_field` [v1.2.3-plugins-filters-dissect-remove_field]
...
### `remove_tag` [v1.2.3-plugins-filters-dissect-remove_tag]
