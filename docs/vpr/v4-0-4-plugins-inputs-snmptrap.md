...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v4.0.4-plugins-inputs-snmptrap.html
---

# SNMP trap input plugin v4.0.4 [v4.0.4-plugins-inputs-snmptrap]
...
## Event Metadata and the Elastic Common Schema (ECS) [v4.0.4-plugins-inputs-snmptrap-ecs]

Because SNMP data has specific field names based on OIDs, we recommend setting a [`target`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-target). The source host field changes based on [`ecs_compatibility`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-ecs_compatibility).
...
## Importing MIBs [v4.0.4-plugins-inputs-snmptrap-import-mibs]
...
## SNMP Trap Input Configuration Options [v4.0.4-plugins-inputs-snmptrap-options]

This plugin supports the following configuration options plus the [Common options](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`community`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-community) | [array](/lsr/value-types.md#array) | No |
| [`ecs_compatibility`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`host`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-host) | [string](/lsr/value-types.md#string) | No |
| [`mib_paths`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-mib_paths) | [path](/lsr/value-types.md#path) | No |
| [`oid_mapping_format`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-oid_mapping_format) | [string](/lsr/value-types.md#string), one of `["default", "ruby_snmp", "dotted_string"]` | No |
| [`oid_map_field_values`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-oid_map_field_values) | [boolean](/lsr/value-types.md#boolean) | Yes |
| [`oid_path_length`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-oid_path_length) | [number](/lsr/value-types.md#number) | No |
| [`oid_root_skip`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-oid_root_skip) | [number](/lsr/value-types.md#number) | No |
| [`port`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-port) | [number](/lsr/value-types.md#number) | No |
| [`supported_transports`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-supported_transports) | [string](/lsr/value-types.md#string) | No |
| [`supported_versions`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-supported_versions) | [string](/lsr/value-types.md#string) | No |
| [`target`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-target) | [string](/lsr/value-types.md#string) | No |
| [`threads`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-threads) | [number](/lsr/value-types.md#number) | No |
| [`use_provided_mibs`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-use_provided_mibs) | [boolean](/lsr/value-types.md#boolean) | No |
| [`yamlmibdir`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-yamlmibdir) | [string](/lsr/value-types.md#string) | *Deprecated* |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`auth_pass`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-auth_pass) | [password](/lsr/value-types.md#password) | No |
| [`auth_protocol`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-auth_protocol) | [string](/lsr/value-types.md#string), one of `["md5", "sha", "sha2", "hmac128sha224", "hmac192sha256", "hmac256sha384", "hmac384sha512"]` | No |
| [`priv_pass`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-priv_pass) | [password](/lsr/value-types.md#password) | No |
| [`priv_protocol`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-priv_protocol) | [string](/lsr/value-types.md#string), one of `["des", "3des", "aes", "aes128", "aes192", "aes256"]` | No |
| [`security_level`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-security_level) | [string](/lsr/value-types.md#string), one of `["noAuthNoPriv", "authNoPriv", "authPriv"]` | No |
| [`security_name`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-security_name) | [string](/lsr/value-types.md#string) | No |

## SNMP Trap Input Configuration Options [_snmp_trap_input_configuration_options]

Also see [Common options](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-common-options) for a list of options supported by all input plugins.

### `community` [v4.0.4-plugins-inputs-snmptrap-community]
...
### `ecs_compatibility` [v4.0.4-plugins-inputs-snmptrap-ecs_compatibility]
...
### `host` [v4.0.4-plugins-inputs-snmptrap-host]
...
### `mib_paths` [v4.0.4-plugins-inputs-snmptrap-mib_paths]
...
### `oid_mapping_format` [v4.0.4-plugins-inputs-snmptrap-oid_mapping_format]
...
### `oid_map_field_values` [v4.0.4-plugins-inputs-snmptrap-oid_map_field_values]

* Value type is [boolean](/lsr/value-types.md#boolean)
* Default value is `false`

Defines if the Logstash event fields values, which types are `OID`, are mapped using the configured OID textual representation set on the [`oid_mapping_format`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-oid_mapping_format) option.

### `oid_root_skip` [v4.0.4-plugins-inputs-snmptrap-oid_root_skip]
...
* You can use this setting or [`oid_path_length`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-oid_path_length), but not both at the same time.
* Use this setting only if [`oid_mapping_format`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-oid_mapping_format) is set to `default`.

### `oid_path_length` [v4.0.4-plugins-inputs-snmptrap-oid_path_length]
...
* You can use this setting or [`oid_root_skip`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-oid_root_skip), but not both at the same time.
* Use this setting only if [`oid_mapping_format`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-oid_mapping_format) is set to `default`.

### `port` [v4.0.4-plugins-inputs-snmptrap-port]
...
### `supported_transports` [v4.0.4-plugins-inputs-snmptrap-supported_transports]
...
### `supported_versions` [v4.0.4-plugins-inputs-snmptrap-supported_versions]
...
### `target` [v4.0.4-plugins-inputs-snmptrap-target]
...
Setting a target is recommended when [`ecs_compatibility`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-ecs_compatibility) is enabled.

### `threads` [v4.0.4-plugins-inputs-snmptrap-threads]
...
### `use_provided_mibs` [v4.0.4-plugins-inputs-snmptrap-use_provided_mibs]
...
### `yamlmibdir` [v4.0.4-plugins-inputs-snmptrap-yamlmibdir]

Deprecated in 4.0.0.

Replaced by [`mib_paths`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-mib_paths)
...
### `auth_pass` [v4.0.4-plugins-inputs-snmptrap-auth_pass]
...
### `auth_protocol` [v4.0.4-plugins-inputs-snmptrap-auth_protocol]
...
### `priv_pass` [v4.0.4-plugins-inputs-snmptrap-priv_pass]
...
### `priv_protocol` [v4.0.4-plugins-inputs-snmptrap-priv_protocol]
...
### `security_level` [v4.0.4-plugins-inputs-snmptrap-security_level]
...
### `security_name` [v4.0.4-plugins-inputs-snmptrap-security_name]
...
## Common options [v4.0.4-plugins-inputs-snmptrap-common-options]

These configuration options are supported by all input plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v4-0-4-plugins-inputs-snmptrap.md#v4.0.4-plugins-inputs-snmptrap-type) | [string](/lsr/value-types.md#string) | No |

### `add_field` [v4.0.4-plugins-inputs-snmptrap-add_field]
...
### `codec` [v4.0.4-plugins-inputs-snmptrap-codec]
...
### `enable_metric` [v4.0.4-plugins-inputs-snmptrap-enable_metric]
...
### `id` [v4.0.4-plugins-inputs-snmptrap-id]
...
### `tags` [v4.0.4-plugins-inputs-snmptrap-tags]
...
### `type` [v4.0.4-plugins-inputs-snmptrap-type]
