...
| [`sasl_jaas_config`](v11-3-3-plugins-outputs-kafka.md#v11.3.3-plugins-outputs-kafka-sasl_jaas_config) | [string](/lsr/value-types.md#string) | No |
...
### `bootstrap_servers` [v11.3.3-plugins-outputs-kafka-bootstrap_servers]
