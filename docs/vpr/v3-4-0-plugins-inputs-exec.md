...
| :- | :- | :- |
| [`command`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-command) | [string](/lsr/value-types.md#string) | Yes |
| [`ecs_compatibility`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`interval`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-interval) | [number](/lsr/value-types.md#number) | No |
| [`schedule`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-schedule) | [string](/lsr/value-types.md#string) | No |
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/current). See [Compatibility with the Elastic Common Schema (ECS)](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-ecs) for detailed information.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v3-4-0-plugins-inputs-exec.md#v3.4.0-plugins-inputs-exec-type) | [string](/lsr/value-types.md#string) | No |
