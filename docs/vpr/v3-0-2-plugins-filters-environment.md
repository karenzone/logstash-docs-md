...
This plugin supports the following configuration options plus the [Common options](v3-0-2-plugins-filters-environment.md#v3.0.2-plugins-filters-environment-common-options) described later.
