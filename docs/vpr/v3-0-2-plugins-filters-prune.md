...
| :- | :- | :- |
| [`blacklist_names`](v3-0-2-plugins-filters-prune.md#v3.0.2-plugins-filters-prune-blacklist_names) | [array](/lsr/value-types.md#array) | No |
| [`blacklist_values`](v3-0-2-plugins-filters-prune.md#v3.0.2-plugins-filters-prune-blacklist_values) | [hash](/lsr/value-types.md#hash) | No |
| [`interpolate`](v3-0-2-plugins-filters-prune.md#v3.0.2-plugins-filters-prune-interpolate) | [boolean](/lsr/value-types.md#boolean) | No |
| [`whitelist_names`](v3-0-2-plugins-filters-prune.md#v3.0.2-plugins-filters-prune-whitelist_names) | [array](/lsr/value-types.md#array) | No |
| [`whitelist_values`](v3-0-2-plugins-filters-prune.md#v3.0.2-plugins-filters-prune-whitelist_values) | [hash](/lsr/value-types.md#hash) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-2-plugins-filters-prune.md#v3.0.2-plugins-filters-prune-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v3-0-2-plugins-filters-prune.md#v3.0.2-plugins-filters-prune-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v3-0-2-plugins-filters-prune.md#v3.0.2-plugins-filters-prune-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-0-2-plugins-filters-prune.md#v3.0.2-plugins-filters-prune-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v3-0-2-plugins-filters-prune.md#v3.0.2-plugins-filters-prune-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v3-0-2-plugins-filters-prune.md#v3.0.2-plugins-filters-prune-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v3-0-2-plugins-filters-prune.md#v3.0.2-plugins-filters-prune-remove_tag) | [array](/lsr/value-types.md#array) | No |
