...
Also see [Common options](v3-3-1-plugins-filters-translate.md#v3.3.1-plugins-filters-translate-common-options) for a list of options supported by all filter plugins.
