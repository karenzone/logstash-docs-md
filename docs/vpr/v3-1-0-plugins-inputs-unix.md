...
This plugin adds extra fields about the event’s source. Configure the [`ecs_compatibility`](v3-1-0-plugins-inputs-unix.md#v3.1.0-plugins-inputs-unix-ecs_compatibility) option if you want to ensure that these fields are compatible with [ECS](https://www.elastic.co/guide/en/ecs/current).
...
| :- | :- | :- |
| [`data_timeout`](v3-1-0-plugins-inputs-unix.md#v3.1.0-plugins-inputs-unix-data_timeout) | [number](/lsr/value-types.md#number) | No |
| [`ecs_compatibility`](v3-1-0-plugins-inputs-unix.md#v3.1.0-plugins-inputs-unix-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`force_unlink`](v3-1-0-plugins-inputs-unix.md#v3.1.0-plugins-inputs-unix-force_unlink) | [boolean](/lsr/value-types.md#boolean) | No |
| [`mode`](v3-1-0-plugins-inputs-unix.md#v3.1.0-plugins-inputs-unix-mode) | [string](/lsr/value-types.md#string), one of `["server", "client"]` | No |
| [`path`](v3-1-0-plugins-inputs-unix.md#v3.1.0-plugins-inputs-unix-path) | [string](/lsr/value-types.md#string) | Yes |
| [`socket_not_present_retry_interval_seconds`](v3-1-0-plugins-inputs-unix.md#v3.1.0-plugins-inputs-unix-socket_not_present_retry_interval_seconds) | [number](/lsr/value-types.md#number) | Yes |
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/current). See [Compatibility with the Elastic Common Schema (ECS)](v3-1-0-plugins-inputs-unix.md#v3.1.0-plugins-inputs-unix-ecs) for detailed information.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-1-0-plugins-inputs-unix.md#v3.1.0-plugins-inputs-unix-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v3-1-0-plugins-inputs-unix.md#v3.1.0-plugins-inputs-unix-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-1-0-plugins-inputs-unix.md#v3.1.0-plugins-inputs-unix-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-1-0-plugins-inputs-unix.md#v3.1.0-plugins-inputs-unix-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v3-1-0-plugins-inputs-unix.md#v3.1.0-plugins-inputs-unix-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v3-1-0-plugins-inputs-unix.md#v3.1.0-plugins-inputs-unix-type) | [string](/lsr/value-types.md#string) | No |

### `add_field` [v3.1.0-plugins-inputs-unix-add_field]
