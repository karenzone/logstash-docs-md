...
| :- | :- | :- |
| [`default_timezone`](v6-2-7-plugins-codecs-cef.md#v6.2.7-plugins-codecs-cef-default_timezone) | [string](/lsr/value-types.md#string) | No |
| [`delimiter`](v6-2-7-plugins-codecs-cef.md#v6.2.7-plugins-codecs-cef-delimiter) | [string](/lsr/value-types.md#string) | No |
| [`device`](v6-2-7-plugins-codecs-cef.md#v6.2.7-plugins-codecs-cef-device) | [string](/lsr/value-types.md#string) | No |
| [`ecs_compatibility`](v6-2-7-plugins-codecs-cef.md#v6.2.7-plugins-codecs-cef-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`fields`](v6-2-7-plugins-codecs-cef.md#v6.2.7-plugins-codecs-cef-fields) | [array](/lsr/value-types.md#array) | No |
| [`locale`](v6-2-7-plugins-codecs-cef.md#v6.2.7-plugins-codecs-cef-locale) | [string](/lsr/value-types.md#string) | No |
| [`name`](v6-2-7-plugins-codecs-cef.md#v6.2.7-plugins-codecs-cef-name) | [string](/lsr/value-types.md#string) | No |
| [`product`](v6-2-7-plugins-codecs-cef.md#v6.2.7-plugins-codecs-cef-product) | [string](/lsr/value-types.md#string) | No |
| [`reverse_mapping`](v6-2-7-plugins-codecs-cef.md#v6.2.7-plugins-codecs-cef-reverse_mapping) | [boolean](/lsr/value-types.md#boolean) | No |
| [`severity`](v6-2-7-plugins-codecs-cef.md#v6.2.7-plugins-codecs-cef-severity) | [string](/lsr/value-types.md#string) | No |
| [`signature`](v6-2-7-plugins-codecs-cef.md#v6.2.7-plugins-codecs-cef-signature) | [string](/lsr/value-types.md#string) | No |
| [`vendor`](v6-2-7-plugins-codecs-cef.md#v6.2.7-plugins-codecs-cef-vendor) | [string](/lsr/value-types.md#string) | No |
| [`version`](v6-2-7-plugins-codecs-cef.md#v6.2.7-plugins-codecs-cef-version) | [string](/lsr/value-types.md#string) | No |
