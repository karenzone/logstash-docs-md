...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v3.5.0-plugins-filters-translate.html
applies_to:
  stack: ga
---

# Translate filter plugin v3.5.0 [v3.5.0-plugins-filters-translate]
...
## Compatibility with the Elastic Common Schema (ECS) [v3.5.0-plugins-filters-translate-ecs_metadata]

The plugin acts as an in-place translator if `source` and `target` are the same and does not produce any new event fields. This is the default behavior in [ECS compatibility mode](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-ecs_compatibility).

## Translate Filter Configuration Options [v3.5.0-plugins-filters-translate-options]

This plugin supports the following configuration options plus the [Common options](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`destination`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-destination) | [string](/lsr/value-types.md#string) | No |
| [`dictionary`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-dictionary) | [hash](/lsr/value-types.md#hash) | No |
| [`dictionary_path`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-dictionary_path) | a valid filesystem path | No |
| [`ecs_compatibility`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`exact`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-exact) | [boolean](/lsr/value-types.md#boolean) | No |
| [`fallback`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-fallback) | [string](/lsr/value-types.md#string) | No |
| [`field`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-field) | [string](/lsr/value-types.md#string) | No |
| [`iterate_on`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-iterate_on) | [string](/lsr/value-types.md#string) | No |
| [`override`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-override) | [boolean](/lsr/value-types.md#boolean) | No |
| [`refresh_interval`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-refresh_interval) | [number](/lsr/value-types.md#number) | No |
| [`regex`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-regex) | [boolean](/lsr/value-types.md#boolean) | No |
| [`source`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-source) | [string](/lsr/value-types.md#string) | Yes |
| [`refresh_behaviour`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-refresh_behaviour) | [string](/lsr/value-types.md#string) | No |
| [`target`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-target) | [string](/lsr/value-types.md#string) | No |
| [`yaml_dictionary_code_point_limit`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-yaml_dictionary_code_point_limit) | [number](/lsr/value-types.md#number) | No |
| [`yaml_load_strategy`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-yaml_load_strategy) | [string](/lsr/value-types.md#string), one of `["one_shot", "streaming"]` | No |

Also see [Common options](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-common-options) for a list of options supported by all filter plugins.

### `destination` [v3.5.0-plugins-filters-translate-destination]

* Value type is [string](/lsr/value-types.md#string)
* Deprecated alias for [`target`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-target) setting.

Deprecated in 3.3.0.

Use [`target`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-target) instead. In 4.0 this setting will be removed.

### `dictionary` [v3.5.0-plugins-filters-translate-dictionary]
...
### `dictionary_path` [v3.5.0-plugins-filters-translate-dictionary_path]
...
### `ecs_compatibility` [v3.5.0-plugins-filters-translate-ecs_compatibility]
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/current). The value of this setting affects the *default* value of [`target`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-target).

### `exact` [v3.5.0-plugins-filters-translate-exact]
...
### `fallback` [v3.5.0-plugins-filters-translate-fallback]
...
### `field` [v3.5.0-plugins-filters-translate-field]

* Value type is [string](/lsr/value-types.md#string)
* Deprecated alias for [`source`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-source) setting.

Deprecated in 3.3.0.

Use [`source`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-source) instead. In 4.0 this setting will be removed.

### `iterate_on` [v3.5.0-plugins-filters-translate-iterate_on]
...
### `override` [v3.5.0-plugins-filters-translate-override]
...
In case of in-place translation, where `target` is the same as `source` (such as when [`ecs_compatibility`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-ecs_compatibility) is enabled), overwriting is allowed.

### `refresh_interval` [v3.5.0-plugins-filters-translate-refresh_interval]
...
### `regex` [v3.5.0-plugins-filters-translate-regex]
...
### `refresh_behaviour` [v3.5.0-plugins-filters-translate-refresh_behaviour]
...
### `source` [v3.5.0-plugins-filters-translate-source]
...
### `target` [v3.5.0-plugins-filters-translate-target]

* Value type is [string](/lsr/value-types.md#string)

* Default value depends on whether [`ecs_compatibility`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-ecs_compatibility) is enabled:
...
### `yaml_dictionary_code_point_limit` [v3.5.0-plugins-filters-translate-yaml_dictionary_code_point_limit]
...
### `yaml_load_strategy` [v3.5.0-plugins-filters-translate-yaml_load_strategy]
...
## Common options [v3.5.0-plugins-filters-translate-common-options]

These configuration options are supported by all filter plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v3-5-0-plugins-filters-translate.md#v3.5.0-plugins-filters-translate-remove_tag) | [array](/lsr/value-types.md#array) | No |

### `add_field` [v3.5.0-plugins-filters-translate-add_field]
...
### `add_tag` [v3.5.0-plugins-filters-translate-add_tag]
...
### `enable_metric` [v3.5.0-plugins-filters-translate-enable_metric]
...
### `id` [v3.5.0-plugins-filters-translate-id]
...
### `periodic_flush` [v3.5.0-plugins-filters-translate-periodic_flush]
...
### `remove_field` [v3.5.0-plugins-filters-translate-remove_field]
...
### `remove_tag` [v3.5.0-plugins-filters-translate-remove_tag]
