...
Also see [Common options](v9-0-1-plugins-inputs-kafka.md#v9.0.1-plugins-inputs-kafka-common-options) for a list of options supported by all input plugins.
