...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v7.1.7-plugins-integrations-aws.html
---

# AWS Integration Plugin v7.1.7 [v7.1.7-plugins-integrations-aws]

* Plugin version: v7.1.7
