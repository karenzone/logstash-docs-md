...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v11.3.4-plugins-integrations-kafka.html
applies_to:
  stack: ga
---

# Kafka Integration Plugin v11.3.4 [v11.3.4-plugins-integrations-kafka]

* Plugin version: v11.3.4
