...
| :- | :- | :- |
| [`access_key_id`](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-access_key_id) | [string](/lsr/value-types.md#string) | No |
| [`aws_credentials_file`](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-aws_credentials_file) | [string](/lsr/value-types.md#string) | No |
| [`id_field`](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-id_field) | [string](/lsr/value-types.md#string) | No |
| [`md5_field`](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-md5_field) | [string](/lsr/value-types.md#string) | No |
| [`polling_frequency`](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-polling_frequency) | [number](/lsr/value-types.md#number) | No |
| [`proxy_uri`](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-proxy_uri) | [string](/lsr/value-types.md#string) | No |
| [`queue`](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-queue) | [string](/lsr/value-types.md#string) | Yes |
| [`region`](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-region) | [string](/lsr/value-types.md#string), one of `["us-east-1", "us-east-2", "us-west-1", "us-west-2", "eu-central-1", "eu-west-1", "eu-west-2", "ap-southeast-1", "ap-southeast-2", "ap-northeast-1", "ap-northeast-2", "sa-east-1", "us-gov-west-1", "cn-north-1", "ap-south-1", "ca-central-1"]` | No |
| [`secret_access_key`](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-secret_access_key) | [string](/lsr/value-types.md#string) | No |
| [`sent_timestamp_field`](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-sent_timestamp_field) | [string](/lsr/value-types.md#string) | No |
| [`session_token`](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-session_token) | [string](/lsr/value-types.md#string) | No |
| [`threads`](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-threads) | [number](/lsr/value-types.md#number) | No |

Also see [Common options](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-common-options) for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v3-0-3-plugins-inputs-sqs.md#v3.0.3-plugins-inputs-sqs-type) | [string](/lsr/value-types.md#string) | No |
