...
| :- | :- | :- |
| [`nb_thread`](v3-0-2-plugins-inputs-jmx.md#v3.0.2-plugins-inputs-jmx-nb_thread) | [number](/lsr/value-types.md#number) | No |
| [`path`](v3-0-2-plugins-inputs-jmx.md#v3.0.2-plugins-inputs-jmx-path) | [string](/lsr/value-types.md#string) | Yes |
| [`polling_frequency`](v3-0-2-plugins-inputs-jmx.md#v3.0.2-plugins-inputs-jmx-polling_frequency) | [number](/lsr/value-types.md#number) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-2-plugins-inputs-jmx.md#v3.0.2-plugins-inputs-jmx-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v3-0-2-plugins-inputs-jmx.md#v3.0.2-plugins-inputs-jmx-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-0-2-plugins-inputs-jmx.md#v3.0.2-plugins-inputs-jmx-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-0-2-plugins-inputs-jmx.md#v3.0.2-plugins-inputs-jmx-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v3-0-2-plugins-inputs-jmx.md#v3.0.2-plugins-inputs-jmx-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v3-0-2-plugins-inputs-jmx.md#v3.0.2-plugins-inputs-jmx-type) | [string](/lsr/value-types.md#string) | No |
