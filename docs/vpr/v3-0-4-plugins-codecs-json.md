...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v3.0.4-plugins-codecs-json.html
---

# Json codec plugin v3.0.4 [v3.0.4-plugins-codecs-json]

* Plugin version: v3.0.4
* Released on: 2017-08-15
* [Changelog](https://github.com/logstash-plugins/logstash-codec-json/blob/v3.0.4/CHANGELOG.md)
