...
| [`partition_assignment_strategy`](v6-3-2-plugins-inputs-kafka.md#v6.3.2-plugins-inputs-kafka-partition_assignment_strategy) | [string](/lsr/value-types.md#string) | No |
