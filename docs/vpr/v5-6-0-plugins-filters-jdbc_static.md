...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v5.6.0-plugins-filters-jdbc_static.html
applies_to:
  stack: ga
---

# Jdbc_static filter plugin v5.6.0 [v5.6.0-plugins-filters-jdbc_static]
...
* **lookups**
  ...
  2. Defines the columns, types, and indexes used to build the local database structure. The column names and types should match the external database. The order of table definitions is significant and should match that of the loader queries. See [Loader column and local_db_object order dependency](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-object_order).
  ...
  6. When the user is not found in the database, an event is created using data from the [`local_lookups`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-local_lookups) `default hash` setting, and the event is tagged with the list set in [`tag_on_default_use`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-tag_on_default_use).
...
## Loader column and local_db_object order dependency [v5.6.0-plugins-filters-jdbc_static-object_order]
...
## Compatibility with the Elastic Common Schema (ECS) [v5.6.0-plugins-filters-jdbc_static-ecs]
...
## Jdbc_static filter configuration options [v5.6.0-plugins-filters-jdbc_static-options]

This plugin supports the following configuration options plus the [Common options](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`jdbc_connection_string`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-jdbc_connection_string) | [string](/lsr/value-types.md#string) | Yes |
| [`jdbc_driver_class`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-jdbc_driver_class) | [string](/lsr/value-types.md#string) | Yes |
| [`jdbc_driver_library`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-jdbc_driver_library) | a valid filesystem path | No |
| [`jdbc_password`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-jdbc_password) | [password](/lsr/value-types.md#password) | No |
| [`jdbc_user`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-jdbc_user) | [string](/lsr/value-types.md#string) | No |
| [`tag_on_failure`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-tag_on_failure) | [array](/lsr/value-types.md#array) | No |
| [`tag_on_default_use`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-tag_on_default_use) | [array](/lsr/value-types.md#array) | No |
| [`staging_directory`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-staging_directory) | [string](/lsr/value-types.md#string) | No |
| [`loader_schedule`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-loader_schedule) | [string](/lsr/value-types.md#string) | No |
| [`loaders`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-loaders) | [array](/lsr/value-types.md#array) | No |
| [`local_db_objects`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-local_db_objects) | [array](/lsr/value-types.md#array) | No |
| [`local_lookups`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-local_lookups) | [array](/lsr/value-types.md#array) | No |

Also see [Common options](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-common-options) for a list of options supported by all filter plugins.

### `jdbc_connection_string` [v5.6.0-plugins-filters-jdbc_static-jdbc_connection_string]
...
### `jdbc_driver_class` [v5.6.0-plugins-filters-jdbc_static-jdbc_driver_class]
...
### `jdbc_driver_library` [v5.6.0-plugins-filters-jdbc_static-jdbc_driver_library]
...
### `jdbc_password` [v5.6.0-plugins-filters-jdbc_static-jdbc_password]
...
### `jdbc_user` [v5.6.0-plugins-filters-jdbc_static-jdbc_user]
...
### `tag_on_default_use` [v5.6.0-plugins-filters-jdbc_static-tag_on_default_use]
...
### `tag_on_failure` [v5.6.0-plugins-filters-jdbc_static-tag_on_failure]
...
### `staging_directory` [v5.6.0-plugins-filters-jdbc_static-staging_directory]
...
### `loader_schedule` [v5.6.0-plugins-filters-jdbc_static-loader_schedule]
...
### `loaders` [v5.6.0-plugins-filters-jdbc_static-loaders]
...
### `local_db_objects` [v5.6.0-plugins-filters-jdbc_static-local_db_objects]
...
### `local_lookups` [v5.6.0-plugins-filters-jdbc_static-local_lookups]
...
## Common options [v5.6.0-plugins-filters-jdbc_static-common-options]

These configuration options are supported by all filter plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v5-6-0-plugins-filters-jdbc_static.md#v5.6.0-plugins-filters-jdbc_static-remove_tag) | [array](/lsr/value-types.md#array) | No |

### `add_field` [v5.6.0-plugins-filters-jdbc_static-add_field]
...
### `add_tag` [v5.6.0-plugins-filters-jdbc_static-add_tag]
...
### `enable_metric` [v5.6.0-plugins-filters-jdbc_static-enable_metric]
...
### `id` [v5.6.0-plugins-filters-jdbc_static-id]
...
### `periodic_flush` [v5.6.0-plugins-filters-jdbc_static-periodic_flush]
...
### `remove_field` [v5.6.0-plugins-filters-jdbc_static-remove_field]
...
### `remove_tag` [v5.6.0-plugins-filters-jdbc_static-remove_tag]
