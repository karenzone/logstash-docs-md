...
| [`threads`](v7-2-1-plugins-inputs-sqs.md#v7.2.1-plugins-inputs-sqs-threads) | [number](/lsr/value-types.md#number) | No |
...
### `threads` [v7.2.1-plugins-inputs-sqs-threads]
...
### `codec` [v7.2.1-plugins-inputs-sqs-codec]
