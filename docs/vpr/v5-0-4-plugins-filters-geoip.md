...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v5.0.4-plugins-filters-geoip.html
applies_to:
  stack: ga
---

# Geoip filter plugin v5.0.4 [v5.0.4-plugins-filters-geoip]

* Plugin version: v5.0.4
* Released on: 2021-12-18
* [Changelog](https://github.com/logstash-plugins/logstash-filter-geoip/blob/v5.0.4/CHANGELOG.md)
...
## Geoip Filter Configuration Options [v5.0.4-plugins-filters-geoip-options]

This plugin supports the following configuration options plus the [Common options](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`cache_size`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-cache_size) | [number](/lsr/value-types.md#number) | No |
| [`database`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-database) | a valid filesystem path | No |
| [`default_database_type`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-default_database_type) | `City` or `ASN` | No |
| [`fields`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-fields) | [array](/lsr/value-types.md#array) | No |
| [`source`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-source) | [string](/lsr/value-types.md#string) | Yes |
| [`tag_on_failure`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-tag_on_failure) | [array](/lsr/value-types.md#array) | No |
| [`target`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-target) | [string](/lsr/value-types.md#string) | No |

Also see [Common options](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-common-options) for a list of options supported by all filter plugins.

### `cache_size` [v5.0.4-plugins-filters-geoip-cache_size]
...
### `database` [v5.0.4-plugins-filters-geoip-database]
...
### `default_database_type` [v5.0.4-plugins-filters-geoip-default_database_type]
...
### `fields` [v5.0.4-plugins-filters-geoip-fields]
...
### `source` [v5.0.4-plugins-filters-geoip-source]
...
### `tag_on_failure` [v5.0.4-plugins-filters-geoip-tag_on_failure]
...
### `target` [v5.0.4-plugins-filters-geoip-target]
...
## Common options [v5.0.4-plugins-filters-geoip-common-options]

These configuration options are supported by all filter plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v5-0-4-plugins-filters-geoip.md#v5.0.4-plugins-filters-geoip-remove_tag) | [array](/lsr/value-types.md#array) | No |

### `add_field` [v5.0.4-plugins-filters-geoip-add_field]
...
### `add_tag` [v5.0.4-plugins-filters-geoip-add_tag]
...
### `enable_metric` [v5.0.4-plugins-filters-geoip-enable_metric]
...
### `id` [v5.0.4-plugins-filters-geoip-id]
...
### `periodic_flush` [v5.0.4-plugins-filters-geoip-periodic_flush]
...
### `remove_field` [v5.0.4-plugins-filters-geoip-remove_field]
...
### `remove_tag` [v5.0.4-plugins-filters-geoip-remove_tag]
