...
This plugin supports the following configuration options plus the [Common options](v1-1-1-plugins-filters-math.md#v1.1.1-plugins-filters-math-common-options) described later.
