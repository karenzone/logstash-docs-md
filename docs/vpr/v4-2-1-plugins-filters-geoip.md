...
| :- | :- | :- |
| [`cache_size`](v4-2-1-plugins-filters-geoip.md#v4.2.1-plugins-filters-geoip-cache_size) | [number](/lsr/value-types.md#number) | No |
| [`database`](v4-2-1-plugins-filters-geoip.md#v4.2.1-plugins-filters-geoip-database) | a valid filesystem path | No |
| [`fields`](v4-2-1-plugins-filters-geoip.md#v4.2.1-plugins-filters-geoip-fields) | [array](/lsr/value-types.md#array) | No |
| [`source`](v4-2-1-plugins-filters-geoip.md#v4.2.1-plugins-filters-geoip-source) | [string](/lsr/value-types.md#string) | Yes |
| [`tag_on_failure`](v4-2-1-plugins-filters-geoip.md#v4.2.1-plugins-filters-geoip-tag_on_failure) | [array](/lsr/value-types.md#array) | No |
| [`target`](v4-2-1-plugins-filters-geoip.md#v4.2.1-plugins-filters-geoip-target) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-2-1-plugins-filters-geoip.md#v4.2.1-plugins-filters-geoip-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v4-2-1-plugins-filters-geoip.md#v4.2.1-plugins-filters-geoip-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v4-2-1-plugins-filters-geoip.md#v4.2.1-plugins-filters-geoip-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v4-2-1-plugins-filters-geoip.md#v4.2.1-plugins-filters-geoip-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v4-2-1-plugins-filters-geoip.md#v4.2.1-plugins-filters-geoip-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v4-2-1-plugins-filters-geoip.md#v4.2.1-plugins-filters-geoip-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v4-2-1-plugins-filters-geoip.md#v4.2.1-plugins-filters-geoip-remove_tag) | [array](/lsr/value-types.md#array) | No |

### `add_field` [v4.2.1-plugins-filters-geoip-add_field]
