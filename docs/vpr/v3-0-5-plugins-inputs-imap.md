...
| :- | :- | :- |
| [`check_interval`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-check_interval) | [number](/lsr/value-types.md#number) | No |
| [`content_type`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-content_type) | [string](/lsr/value-types.md#string) | No |
| [`delete`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-delete) | [boolean](/lsr/value-types.md#boolean) | No |
| [`expunge`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-expunge) | [boolean](/lsr/value-types.md#boolean) | No |
| [`fetch_count`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-fetch_count) | [number](/lsr/value-types.md#number) | No |
| [`folder`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-folder) | [string](/lsr/value-types.md#string) | No |
| [`host`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-host) | [string](/lsr/value-types.md#string) | Yes |
| [`lowercase_headers`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-lowercase_headers) | [boolean](/lsr/value-types.md#boolean) | No |
| [`password`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-password) | [password](/lsr/value-types.md#password) | Yes |
| [`port`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-port) | [number](/lsr/value-types.md#number) | No |
| [`secure`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-secure) | [boolean](/lsr/value-types.md#boolean) | No |
| [`strip_attachments`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-strip_attachments) | [boolean](/lsr/value-types.md#boolean) | No |
| [`user`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-user) | [string](/lsr/value-types.md#string) | Yes |
| [`verify_cert`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-verify_cert) | [boolean](/lsr/value-types.md#boolean) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v3-0-5-plugins-inputs-imap.md#v3.0.5-plugins-inputs-imap-type) | [string](/lsr/value-types.md#string) | No |

### `add_field` [v3.0.5-plugins-inputs-imap-add_field]
