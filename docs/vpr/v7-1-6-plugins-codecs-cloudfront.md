...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v7.1.6-plugins-codecs-cloudfront.html
---

# Cloudfront codec plugin v7.1.6 [v7.1.6-plugins-codecs-cloudfront]
