...
Also see [Common options](v3-1-7-plugins-filters-mutate.md#v3.1.7-plugins-filters-mutate-common-options) for a list of options supported by all filter plugins.
