...
This plugin supports the following configuration options plus the [Common options](v3-0-6-plugins-inputs-http.md#v3.0.6-plugins-inputs-http-common-options) described later.
