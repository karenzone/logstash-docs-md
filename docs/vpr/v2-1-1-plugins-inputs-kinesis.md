...
Also see [Common options](v2-1-1-plugins-inputs-kinesis.md#v2.1.1-plugins-inputs-kinesis-common-options) for a list of options supported by all input plugins.
