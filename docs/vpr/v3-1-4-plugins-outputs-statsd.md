...
| :- | :- | :- |
| [`count`](v3-1-4-plugins-outputs-statsd.md#v3.1.4-plugins-outputs-statsd-count) | [hash](/lsr/value-types.md#hash) | No |
| [`decrement`](v3-1-4-plugins-outputs-statsd.md#v3.1.4-plugins-outputs-statsd-decrement) | [array](/lsr/value-types.md#array) | No |
| [`gauge`](v3-1-4-plugins-outputs-statsd.md#v3.1.4-plugins-outputs-statsd-gauge) | [hash](/lsr/value-types.md#hash) | No |
| [`host`](v3-1-4-plugins-outputs-statsd.md#v3.1.4-plugins-outputs-statsd-host) | [string](/lsr/value-types.md#string) | No |
| [`increment`](v3-1-4-plugins-outputs-statsd.md#v3.1.4-plugins-outputs-statsd-increment) | [array](/lsr/value-types.md#array) | No |
| [`namespace`](v3-1-4-plugins-outputs-statsd.md#v3.1.4-plugins-outputs-statsd-namespace) | [string](/lsr/value-types.md#string) | No |
| [`port`](v3-1-4-plugins-outputs-statsd.md#v3.1.4-plugins-outputs-statsd-port) | [number](/lsr/value-types.md#number) | No |
| [`sample_rate`](v3-1-4-plugins-outputs-statsd.md#v3.1.4-plugins-outputs-statsd-sample_rate) | [number](/lsr/value-types.md#number) | No |
| [`sender`](v3-1-4-plugins-outputs-statsd.md#v3.1.4-plugins-outputs-statsd-sender) | [string](/lsr/value-types.md#string) | No |
| [`set`](v3-1-4-plugins-outputs-statsd.md#v3.1.4-plugins-outputs-statsd-set) | [hash](/lsr/value-types.md#hash) | No |
| [`timing`](v3-1-4-plugins-outputs-statsd.md#v3.1.4-plugins-outputs-statsd-timing) | [hash](/lsr/value-types.md#hash) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-1-4-plugins-outputs-statsd.md#v3.1.4-plugins-outputs-statsd-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-1-4-plugins-outputs-statsd.md#v3.1.4-plugins-outputs-statsd-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-1-4-plugins-outputs-statsd.md#v3.1.4-plugins-outputs-statsd-id) | [string](/lsr/value-types.md#string) | No |
