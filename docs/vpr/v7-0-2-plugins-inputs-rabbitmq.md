...
| :- | :- | :- |
| [`ack`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-ack) | [boolean](/lsr/value-types.md#boolean) | No |
| [`arguments`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-arguments) | [array](/lsr/value-types.md#array) | No |
| [`auto_delete`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-auto_delete) | [boolean](/lsr/value-types.md#boolean) | No |
| [`automatic_recovery`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-automatic_recovery) | [boolean](/lsr/value-types.md#boolean) | No |
| [`connect_retry_interval`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-connect_retry_interval) | [number](/lsr/value-types.md#number) | No |
| [`connection_timeout`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-connection_timeout) | [number](/lsr/value-types.md#number) | No |
| [`durable`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-durable) | [boolean](/lsr/value-types.md#boolean) | No |
| [`exchange`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-exchange) | [string](/lsr/value-types.md#string) | No |
| [`exchange_type`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-exchange_type) | [string](/lsr/value-types.md#string) | No |
| [`exclusive`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-exclusive) | [boolean](/lsr/value-types.md#boolean) | No |
| [`heartbeat`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-heartbeat) | [number](/lsr/value-types.md#number) | No |
| [`host`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-host) | [string](/lsr/value-types.md#string) | Yes |
| [`key`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-key) | [string](/lsr/value-types.md#string) | No |
| [`metadata_enabled`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-metadata_enabled) | [boolean](/lsr/value-types.md#boolean) | No |
| [`passive`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-passive) | [boolean](/lsr/value-types.md#boolean) | No |
| [`password`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-password) | [password](/lsr/value-types.md#password) | No |
| [`port`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-port) | [number](/lsr/value-types.md#number) | No |
| [`prefetch_count`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-prefetch_count) | [number](/lsr/value-types.md#number) | No |
| [`queue`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-queue) | [string](/lsr/value-types.md#string) | No |
| [`ssl`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-ssl) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ssl_certificate_password`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-ssl_certificate_password) | [string](/lsr/value-types.md#string) | No |
...
| [`ssl_version`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-ssl_version) | [string](/lsr/value-types.md#string) | No |
| [`subscription_retry_interval_seconds`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-subscription_retry_interval_seconds) | [number](/lsr/value-types.md#number) | Yes |
| [`threads`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-threads) | [number](/lsr/value-types.md#number) | No |
| [`user`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-user) | [string](/lsr/value-types.md#string) | No |
| [`vhost`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-vhost) | [string](/lsr/value-types.md#string) | No |
...
### `port` [v7.0.2-plugins-inputs-rabbitmq-port]
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v7-0-2-plugins-inputs-rabbitmq.md#v7.0.2-plugins-inputs-rabbitmq-type) | [string](/lsr/value-types.md#string) | No |

### `add_field` [v7.0.2-plugins-inputs-rabbitmq-add_field]
