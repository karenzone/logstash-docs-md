...
| :- | :- | :- |
| [`acks`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-acks) | [string](/lsr/value-types.md#string), one of `["0", "1", "all"]` | No |
| [`batch_size`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-batch_size) | [number](/lsr/value-types.md#number) | No |
| [`bootstrap_servers`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-bootstrap_servers) | [string](/lsr/value-types.md#string) | No |
| [`buffer_memory`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-buffer_memory) | [number](/lsr/value-types.md#number) | No |
| [`client_dns_lookup`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-client_dns_lookup) | [string](/lsr/value-types.md#string) | No |
| [`client_id`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-client_id) | [string](/lsr/value-types.md#string) | No |
| [`compression_type`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-compression_type) | [string](/lsr/value-types.md#string), one of `["none", "gzip", "snappy", "lz4", "zstd"]` | No |
| [`connections_max_idle_ms`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-connections_max_idle_ms) | [number](/lsr/value-types.md#number) | No |
...
| [`key_serializer`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-key_serializer) | [string](/lsr/value-types.md#string) | No |
| [`linger_ms`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-linger_ms) | [number](/lsr/value-types.md#number) | No |
| [`max_request_size`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-max_request_size) | [number](/lsr/value-types.md#number) | No |
| [`message_headers`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-message_headers) | [hash](/lsr/value-types.md#hash) | No |
| [`message_key`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-message_key) | [string](/lsr/value-types.md#string) | No |
| [`metadata_fetch_timeout_ms`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-metadata_fetch_timeout_ms) | [number](/lsr/value-types.md#number) | No |
| [`metadata_max_age_ms`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-metadata_max_age_ms) | [number](/lsr/value-types.md#number) | No |
| [`partitioner`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-partitioner) | [string](/lsr/value-types.md#string) | No |
| [`receive_buffer_bytes`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-receive_buffer_bytes) | [number](/lsr/value-types.md#number) | No |
| [`reconnect_backoff_ms`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-reconnect_backoff_ms) | [number](/lsr/value-types.md#number) | No |
| [`request_timeout_ms`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-request_timeout_ms) | [number](/lsr/value-types.md#number) | No |
| [`retries`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-retries) | [number](/lsr/value-types.md#number) | No |
| [`retry_backoff_ms`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-retry_backoff_ms) | [number](/lsr/value-types.md#number) | No |
| [`sasl_client_callback_handler_class`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-sasl_client_callback_handler_class) | [string](/lsr/value-types.md#string) | No |
| [`sasl_jaas_config`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-sasl_jaas_config) | [string](/lsr/value-types.md#string) | No |
| [`sasl_kerberos_service_name`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-sasl_kerberos_service_name) | [string](/lsr/value-types.md#string) | No |
| [`sasl_mechanism`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-sasl_mechanism) | [string](/lsr/value-types.md#string) | No |
| [`security_protocol`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-security_protocol) | [string](/lsr/value-types.md#string), one of `["PLAINTEXT", "SSL", "SASL_PLAINTEXT", "SASL_SSL"]` | No |
| [`send_buffer_bytes`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-send_buffer_bytes) | [number](/lsr/value-types.md#number) | No |
| [`ssl_endpoint_identification_algorithm`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-ssl_endpoint_identification_algorithm) | [string](/lsr/value-types.md#string) | No |
| [`ssl_key_password`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-ssl_key_password) | [password](/lsr/value-types.md#password) | No |
...
| [`ssl_keystore_password`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-ssl_keystore_password) | [password](/lsr/value-types.md#password) | No |
| [`ssl_keystore_type`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-ssl_keystore_type) | [string](/lsr/value-types.md#string) | No |
...
| [`ssl_truststore_password`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-ssl_truststore_password) | [password](/lsr/value-types.md#password) | No |
| [`ssl_truststore_type`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-ssl_truststore_type) | [string](/lsr/value-types.md#string) | No |
| [`topic_id`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-topic_id) | [string](/lsr/value-types.md#string) | Yes |
| [`value_serializer`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-value_serializer) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v11-5-2-plugins-outputs-kafka.md#v11.5.2-plugins-outputs-kafka-id) | [string](/lsr/value-types.md#string) | No |
