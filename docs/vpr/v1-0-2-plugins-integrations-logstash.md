...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v1.0.2-plugins-integrations-logstash.html
applies_to:
  stack: ga
---

# Logstash Integration Plugin v1.0.2 [v1.0.2-plugins-integrations-logstash]
...
### High-level concepts [v1.0.2-plugins-integrations-logstash-concepts]
...
## Load Balancing [v1.0.2-plugins-integrations-logstash-load-balancing]
