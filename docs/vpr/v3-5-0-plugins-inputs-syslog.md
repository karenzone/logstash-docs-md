...
| [`severity_labels`](v3-5-0-plugins-inputs-syslog.md#v3.5.0-plugins-inputs-syslog-severity_labels) | [array](/lsr/value-types.md#array) | No |
...
### `add_field` [v3.5.0-plugins-inputs-syslog-add_field]
