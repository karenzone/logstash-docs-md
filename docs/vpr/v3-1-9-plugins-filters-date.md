...
Also see [Common options](v3-1-9-plugins-filters-date.md#v3.1.9-plugins-filters-date-common-options) for a list of options supported by all filter plugins.
