...
| :- | :- | :- |
| [`code`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-code) | [string](/lsr/value-types.md#string) | No |
| [`init`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-init) | [string](/lsr/value-types.md#string) | No |
| [`path`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-path) | [string](/lsr/value-types.md#string) | No |
| [`script_params`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-script_params) | [hash](/lsr/value-types.md#hash),{} | No |
| [`tag_on_exception`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-tag_on_exception) | [string](/lsr/value-types.md#string),_rubyexception | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v3-1-1-plugins-filters-ruby.md#v3.1.1-plugins-filters-ruby-remove_tag) | [array](/lsr/value-types.md#array) | No |

### `add_field` [v3.1.1-plugins-filters-ruby-add_field]
