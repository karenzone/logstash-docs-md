...
| [`max_messages`](v1-2-0-plugins-inputs-google_pubsub.md#v1.2.0-plugins-inputs-google_pubsub-max_messages) | [number](/lsr/value-types.md#number) | Yes |
| [`project_id`](v1-2-0-plugins-inputs-google_pubsub.md#v1.2.0-plugins-inputs-google_pubsub-project_id) | [string](/lsr/value-types.md#string) | Yes |
| [`subscription`](v1-2-0-plugins-inputs-google_pubsub.md#v1.2.0-plugins-inputs-google_pubsub-subscription) | [string](/lsr/value-types.md#string) | Yes |
| [`topic`](v1-2-0-plugins-inputs-google_pubsub.md#v1.2.0-plugins-inputs-google_pubsub-topic) | [string](/lsr/value-types.md#string) | Yes |
| [`include_metadata`](v1-2-0-plugins-inputs-google_pubsub.md#v1.2.0-plugins-inputs-google_pubsub-include_metadata) | [boolean](/lsr/value-types.md#boolean) | No |
| [`create_subscription`](v1-2-0-plugins-inputs-google_pubsub.md#v1.2.0-plugins-inputs-google_pubsub-create_subscription) | [boolean](/lsr/value-types.md#boolean) | No |
...
## Common options [v1.2.0-plugins-inputs-google_pubsub-common-options]

These configuration options are supported by all input plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v1-2-0-plugins-inputs-google_pubsub.md#v1.2.0-plugins-inputs-google_pubsub-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v1-2-0-plugins-inputs-google_pubsub.md#v1.2.0-plugins-inputs-google_pubsub-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v1-2-0-plugins-inputs-google_pubsub.md#v1.2.0-plugins-inputs-google_pubsub-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v1-2-0-plugins-inputs-google_pubsub.md#v1.2.0-plugins-inputs-google_pubsub-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v1-2-0-plugins-inputs-google_pubsub.md#v1.2.0-plugins-inputs-google_pubsub-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v1-2-0-plugins-inputs-google_pubsub.md#v1.2.0-plugins-inputs-google_pubsub-type) | [string](/lsr/value-types.md#string) | No |
