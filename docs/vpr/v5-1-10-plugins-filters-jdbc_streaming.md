...
Array of bind values for the prepared statement. Use field references and constants. See the section on [prepared_statements](v5-1-10-plugins-filters-jdbc_streaming.md#v5.1.10-plugins-filters-jdbc_streaming-prepared_statements) for more info.
