...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v7.1.7-plugins-codecs-cloudfront.html
applies_to:
  stack: ga
---

# Cloudfront codec plugin v7.1.7 [v7.1.7-plugins-codecs-cloudfront]
