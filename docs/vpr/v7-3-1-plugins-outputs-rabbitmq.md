...
| :- | :- | :- |
| [`arguments`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-arguments) | [array](/lsr/value-types.md#array) | No |
| [`automatic_recovery`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-automatic_recovery) | [boolean](/lsr/value-types.md#boolean) | No |
| [`connect_retry_interval`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-connect_retry_interval) | [number](/lsr/value-types.md#number) | No |
| [`connection_timeout`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-connection_timeout) | [number](/lsr/value-types.md#number) | No |
| [`durable`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-durable) | [boolean](/lsr/value-types.md#boolean) | No |
| [`exchange`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-exchange) | [string](/lsr/value-types.md#string) | Yes |
| [`exchange_type`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-exchange_type) | [string](/lsr/value-types.md#string), one of `["fanout", "direct", "topic", "x-consistent-hash", "x-modulus-hash"]` | Yes |
| [`heartbeat`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-heartbeat) | [number](/lsr/value-types.md#number) | No |
| [`host`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-host) | [string](/lsr/value-types.md#string) | Yes |
| [`key`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-key) | [string](/lsr/value-types.md#string) | No |
| [`message_properties`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-message_properties) | [hash](/lsr/value-types.md#hash) | No |
| [`passive`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-passive) | [boolean](/lsr/value-types.md#boolean) | No |
| [`password`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-password) | [password](/lsr/value-types.md#password) | No |
| [`persistent`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-persistent) | [boolean](/lsr/value-types.md#boolean) | No |
| [`port`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-port) | [number](/lsr/value-types.md#number) | No |
| [`ssl`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-ssl) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ssl_certificate_password`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-ssl_certificate_password) | [string](/lsr/value-types.md#string) | No |
...
| [`ssl_version`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-ssl_version) | [string](/lsr/value-types.md#string) | No |
| [`user`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-user) | [string](/lsr/value-types.md#string) | No |
| [`vhost`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-vhost) | [string](/lsr/value-types.md#string) | No |
...
### `ssl` [v7.3.1-plugins-outputs-rabbitmq-ssl]
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v7-3-1-plugins-outputs-rabbitmq.md#v7.3.1-plugins-outputs-rabbitmq-id) | [string](/lsr/value-types.md#string) | No |
