...
Also see [Common options](v0-1-1-plugins-filters-memcached.md#v0.1.1-plugins-filters-memcached-common-options) for a list of options supported by all filter plugins.
