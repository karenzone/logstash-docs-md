...
| :- | :- | :- |
| [`clones`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-clones) | [array](/lsr/value-types.md#array) | Yes |
| [`ecs_compatibility`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/current). The value of this setting affects the behavior of the [`clones`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-clones)
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v4-2-0-plugins-filters-clone.md#v4.2.0-plugins-filters-clone-remove_tag) | [array](/lsr/value-types.md#array) | No |
