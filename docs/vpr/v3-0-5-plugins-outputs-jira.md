...
Also see [Common options](v3-0-5-plugins-outputs-jira.md#v3.0.5-plugins-outputs-jira-common-options) for a list of options supported by all output plugins.
