...
| :- | :- | :- |
| [`aggregation_fields`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-aggregation_fields) | [hash](/lsr/value-types.md#hash) | No |
| [`api_key`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-api_key) | [password](/lsr/value-types.md#password) | No |
...
| [`ca_trusted_fingerprint`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-ca_trusted_fingerprint) | [string](/lsr/value-types.md#string) | No |
| [`cloud_auth`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-cloud_auth) | [password](/lsr/value-types.md#password) | No |
| [`cloud_id`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-cloud_id) | [string](/lsr/value-types.md#string) | No |
| [`docinfo_fields`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-docinfo_fields) | [hash](/lsr/value-types.md#hash) | No |
| [`enable_sort`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-enable_sort) | [boolean](/lsr/value-types.md#boolean) | No |
| [`fields`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-fields) | [array](/lsr/value-types.md#array) | No |
| [`hosts`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-hosts) | [array](/lsr/value-types.md#array) | No |
| [`index`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-index) | [string](/lsr/value-types.md#string) | No |
| [`password`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-password) | [password](/lsr/value-types.md#password) | No |
| [`proxy`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-proxy) | [uri](/lsr/value-types.md#uri) | No |
| [`query`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-query) | [string](/lsr/value-types.md#string) | No |
| [`query_template`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-query_template) | [string](/lsr/value-types.md#string) | No |
| [`result_size`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-result_size) | [number](/lsr/value-types.md#number) | No |
| [`sort`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-sort) | [string](/lsr/value-types.md#string) | No |
| [`ssl`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-ssl) | [boolean](/lsr/value-types.md#boolean) | No |
...
| [`keystore_password`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-keystore_password) | [password](/lsr/value-types.md#password) | No |
| [`tag_on_failure`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-tag_on_failure) | [array](/lsr/value-types.md#array) | No |
| [`user`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-user) | [string](/lsr/value-types.md#string) | No |

Also see [Common options](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-common-options) for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v3-13-0-plugins-filters-elasticsearch.md#v3.13.0-plugins-filters-elasticsearch-remove_tag) | [array](/lsr/value-types.md#array) | No |
