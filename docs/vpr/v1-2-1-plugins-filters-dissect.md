...
| :- | :- | :- |
| [`convert_datatype`](v1-2-1-plugins-filters-dissect.md#v1.2.1-plugins-filters-dissect-convert_datatype) | [hash](/lsr/value-types.md#hash) | No |
| [`mapping`](v1-2-1-plugins-filters-dissect.md#v1.2.1-plugins-filters-dissect-mapping) | [hash](/lsr/value-types.md#hash) | No |
| [`tag_on_failure`](v1-2-1-plugins-filters-dissect.md#v1.2.1-plugins-filters-dissect-tag_on_failure) | [array](/lsr/value-types.md#array) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v1-2-1-plugins-filters-dissect.md#v1.2.1-plugins-filters-dissect-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v1-2-1-plugins-filters-dissect.md#v1.2.1-plugins-filters-dissect-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v1-2-1-plugins-filters-dissect.md#v1.2.1-plugins-filters-dissect-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v1-2-1-plugins-filters-dissect.md#v1.2.1-plugins-filters-dissect-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v1-2-1-plugins-filters-dissect.md#v1.2.1-plugins-filters-dissect-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v1-2-1-plugins-filters-dissect.md#v1.2.1-plugins-filters-dissect-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v1-2-1-plugins-filters-dissect.md#v1.2.1-plugins-filters-dissect-remove_tag) | [array](/lsr/value-types.md#array) | No |
