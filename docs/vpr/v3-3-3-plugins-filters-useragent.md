...
| :- | :- | :- |
| [`ecs_compatibility`](v3-3-3-plugins-filters-useragent.md#v3.3.3-plugins-filters-useragent-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`lru_cache_size`](v3-3-3-plugins-filters-useragent.md#v3.3.3-plugins-filters-useragent-lru_cache_size) | [number](/lsr/value-types.md#number) | No |
| [`prefix`](v3-3-3-plugins-filters-useragent.md#v3.3.3-plugins-filters-useragent-prefix) | [string](/lsr/value-types.md#string) | No |
| [`regexes`](v3-3-3-plugins-filters-useragent.md#v3.3.3-plugins-filters-useragent-regexes) | [string](/lsr/value-types.md#string) | No |
| [`source`](v3-3-3-plugins-filters-useragent.md#v3.3.3-plugins-filters-useragent-source) | [string](/lsr/value-types.md#string) | Yes |
| [`target`](v3-3-3-plugins-filters-useragent.md#v3.3.3-plugins-filters-useragent-target) | [string](/lsr/value-types.md#string) | No |
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/current). The value of this setting affects the *default* value of [`target`](v3-3-3-plugins-filters-useragent.md#v3.3.3-plugins-filters-useragent-target).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-3-3-plugins-filters-useragent.md#v3.3.3-plugins-filters-useragent-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v3-3-3-plugins-filters-useragent.md#v3.3.3-plugins-filters-useragent-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v3-3-3-plugins-filters-useragent.md#v3.3.3-plugins-filters-useragent-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-3-3-plugins-filters-useragent.md#v3.3.3-plugins-filters-useragent-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v3-3-3-plugins-filters-useragent.md#v3.3.3-plugins-filters-useragent-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v3-3-3-plugins-filters-useragent.md#v3.3.3-plugins-filters-useragent-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v3-3-3-plugins-filters-useragent.md#v3.3.3-plugins-filters-useragent-remove_tag) | [array](/lsr/value-types.md#array) | No |
