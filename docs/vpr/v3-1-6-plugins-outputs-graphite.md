...
| :- | :- | :- |
| [`exclude_metrics`](v3-1-6-plugins-outputs-graphite.md#v3.1.6-plugins-outputs-graphite-exclude_metrics) | [array](/lsr/value-types.md#array) | No |
| [`fields_are_metrics`](v3-1-6-plugins-outputs-graphite.md#v3.1.6-plugins-outputs-graphite-fields_are_metrics) | [boolean](/lsr/value-types.md#boolean) | No |
| [`host`](v3-1-6-plugins-outputs-graphite.md#v3.1.6-plugins-outputs-graphite-host) | [string](/lsr/value-types.md#string) | No |
| [`include_metrics`](v3-1-6-plugins-outputs-graphite.md#v3.1.6-plugins-outputs-graphite-include_metrics) | [array](/lsr/value-types.md#array) | No |
| [`metrics`](v3-1-6-plugins-outputs-graphite.md#v3.1.6-plugins-outputs-graphite-metrics) | [hash](/lsr/value-types.md#hash) | No |
| [`metrics_format`](v3-1-6-plugins-outputs-graphite.md#v3.1.6-plugins-outputs-graphite-metrics_format) | [string](/lsr/value-types.md#string) | No |
| [`nested_object_separator`](v3-1-6-plugins-outputs-graphite.md#v3.1.6-plugins-outputs-graphite-nested_object_separator) | [string](/lsr/value-types.md#string) | No |
| [`port`](v3-1-6-plugins-outputs-graphite.md#v3.1.6-plugins-outputs-graphite-port) | [number](/lsr/value-types.md#number) | No |
| [`reconnect_interval`](v3-1-6-plugins-outputs-graphite.md#v3.1.6-plugins-outputs-graphite-reconnect_interval) | [number](/lsr/value-types.md#number) | No |
| [`resend_on_failure`](v3-1-6-plugins-outputs-graphite.md#v3.1.6-plugins-outputs-graphite-resend_on_failure) | [boolean](/lsr/value-types.md#boolean) | No |
| [`timestamp_field`](v3-1-6-plugins-outputs-graphite.md#v3.1.6-plugins-outputs-graphite-timestamp_field) | [string](/lsr/value-types.md#string) | No |
...
### `metrics_format` [v3.1.6-plugins-outputs-graphite-metrics_format]
...
### `timestamp_field` [v3.1.6-plugins-outputs-graphite-timestamp_field]
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v3-1-6-plugins-outputs-graphite.md#v3.1.6-plugins-outputs-graphite-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-1-6-plugins-outputs-graphite.md#v3.1.6-plugins-outputs-graphite-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-1-6-plugins-outputs-graphite.md#v3.1.6-plugins-outputs-graphite-id) | [string](/lsr/value-types.md#string) | No |
