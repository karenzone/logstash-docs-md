...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v5.4.0-plugins-integrations-jdbc.html
applies_to:
  stack: ga
---

# JDBC Integration Plugin v5.4.0 [v5.4.0-plugins-integrations-jdbc]
