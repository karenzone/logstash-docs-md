...
| :- | :- | :- |
| [`hosts`](v1-2-0-plugins-filters-memcached.md#v1.2.0-plugins-filters-memcached-hosts) | [array](/lsr/value-types.md#array) | No |
| [`namespace`](v1-2-0-plugins-filters-memcached.md#v1.2.0-plugins-filters-memcached-namespace) | [string](/lsr/value-types.md#string) | No |
| [`get`](v1-2-0-plugins-filters-memcached.md#v1.2.0-plugins-filters-memcached-get) | [hash](/lsr/value-types.md#hash) | No |
| [`set`](v1-2-0-plugins-filters-memcached.md#v1.2.0-plugins-filters-memcached-set) | [hash](/lsr/value-types.md#hash) | No |
| [`tag_on_failure`](v1-2-0-plugins-filters-memcached.md#v1.2.0-plugins-filters-memcached-tag_on_failure) | [string](/lsr/value-types.md#string) | No |
| [`ttl`](v1-2-0-plugins-filters-memcached.md#v1.2.0-plugins-filters-memcached-ttl) | [number](/lsr/value-types.md#number) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v1-2-0-plugins-filters-memcached.md#v1.2.0-plugins-filters-memcached-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v1-2-0-plugins-filters-memcached.md#v1.2.0-plugins-filters-memcached-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v1-2-0-plugins-filters-memcached.md#v1.2.0-plugins-filters-memcached-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v1-2-0-plugins-filters-memcached.md#v1.2.0-plugins-filters-memcached-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v1-2-0-plugins-filters-memcached.md#v1.2.0-plugins-filters-memcached-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v1-2-0-plugins-filters-memcached.md#v1.2.0-plugins-filters-memcached-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v1-2-0-plugins-filters-memcached.md#v1.2.0-plugins-filters-memcached-remove_tag) | [array](/lsr/value-types.md#array) | No |

### `add_field` [v1.2.0-plugins-filters-memcached-add_field]
