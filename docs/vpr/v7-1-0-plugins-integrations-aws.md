...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v7.1.0-plugins-integrations-aws.html
---

# AWS Integration Plugin v7.1.0 [v7.1.0-plugins-integrations-aws]
