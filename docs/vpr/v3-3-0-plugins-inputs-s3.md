...
| [`proxy_uri`](v3-3-0-plugins-inputs-s3.md#v3.3.0-plugins-inputs-s3-proxy_uri) | [string](/lsr/value-types.md#string) | No |
...
### `add_field` [v3.3.0-plugins-inputs-s3-add_field]
