...
Also see [Common options](v3-0-4-plugins-filters-uuid.md#v3.0.4-plugins-filters-uuid-common-options) for a list of options supported by all filter plugins.
...
### `add_field` [v3.0.4-plugins-filters-uuid-add_field]
