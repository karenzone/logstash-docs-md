...
This plugin supports the following configuration options plus the [Common options](v3-0-13-plugins-filters-dns.md#v3.0.13-plugins-filters-dns-common-options) described later.
