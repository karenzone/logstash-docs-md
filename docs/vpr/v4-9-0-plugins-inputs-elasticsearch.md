...
| :- | :- | :- |
| [`api_key`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-api_key) | [password](/lsr/value-types.md#password) | No |
| [`ca_file`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-ca_file) | a valid filesystem path | No |
| [`cloud_auth`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-cloud_auth) | [password](/lsr/value-types.md#password) | No |
| [`cloud_id`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-cloud_id) | [string](/lsr/value-types.md#string) | No |
| [`connect_timeout_seconds`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-connect_timeout_seconds) | [number](/lsr/value-types.md#number) | No |
| [`docinfo`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-docinfo) | [boolean](/lsr/value-types.md#boolean) | No |
| [`docinfo_fields`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-docinfo_fields) | [array](/lsr/value-types.md#array) | No |
| [`docinfo_target`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-docinfo_target) | [string](/lsr/value-types.md#string) | No |
| [`hosts`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-hosts) | [array](/lsr/value-types.md#array) | No |
| [`index`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-index) | [string](/lsr/value-types.md#string) | No |
| [`password`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-password) | [password](/lsr/value-types.md#password) | No |
| [`proxy`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-proxy) | [uri](/lsr/value-types.md#uri) | No |
| [`query`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-query) | [string](/lsr/value-types.md#string) | No |
| [`request_timeout_seconds`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-request_timeout_seconds) | [number](/lsr/value-types.md#number) | No |
| [`schedule`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-schedule) | [string](/lsr/value-types.md#string) | No |
| [`scroll`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-scroll) | [string](/lsr/value-types.md#string) | No |
| [`size`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-size) | [number](/lsr/value-types.md#number) | No |
| [`slices`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-slices) | [number](/lsr/value-types.md#number) | No |
| [`ssl`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-ssl) | [boolean](/lsr/value-types.md#boolean) | No |
| [`socket_timeout_seconds`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-socket_timeout_seconds) | [number](/lsr/value-types.md#number) | No |
...
| [`user`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-user) | [string](/lsr/value-types.md#string) | No |
...
If set, you can use metadata information in the [`add_field`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-add_field) common option.
...
### `target` [v4.9.0-plugins-inputs-elasticsearch-target]
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v4-9-0-plugins-inputs-elasticsearch.md#v4.9.0-plugins-inputs-elasticsearch-type) | [string](/lsr/value-types.md#string) | No |
