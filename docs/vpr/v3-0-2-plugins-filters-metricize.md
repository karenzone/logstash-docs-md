...
## Metricize Filter Configuration Options [v3.0.2-plugins-filters-metricize-options]
...
| :- | :- | :- |
| [`drop_original_event`](v3-0-2-plugins-filters-metricize.md#v3.0.2-plugins-filters-metricize-drop_original_event) | [boolean](/lsr/value-types.md#boolean) | No |
| [`metric_field_name`](v3-0-2-plugins-filters-metricize.md#v3.0.2-plugins-filters-metricize-metric_field_name) | [string](/lsr/value-types.md#string) | No |
| [`metrics`](v3-0-2-plugins-filters-metricize.md#v3.0.2-plugins-filters-metricize-metrics) | [array](/lsr/value-types.md#array) | Yes |
| [`value_field_name`](v3-0-2-plugins-filters-metricize.md#v3.0.2-plugins-filters-metricize-value_field_name) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-2-plugins-filters-metricize.md#v3.0.2-plugins-filters-metricize-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v3-0-2-plugins-filters-metricize.md#v3.0.2-plugins-filters-metricize-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v3-0-2-plugins-filters-metricize.md#v3.0.2-plugins-filters-metricize-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-0-2-plugins-filters-metricize.md#v3.0.2-plugins-filters-metricize-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v3-0-2-plugins-filters-metricize.md#v3.0.2-plugins-filters-metricize-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v3-0-2-plugins-filters-metricize.md#v3.0.2-plugins-filters-metricize-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v3-0-2-plugins-filters-metricize.md#v3.0.2-plugins-filters-metricize-remove_tag) | [array](/lsr/value-types.md#array) | No |
