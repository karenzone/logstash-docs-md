...
This input plugin needs to be configured to bind to a TCP [`port`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-port), and can be constrained to bind to a particular interface by providing the IP to [`host`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-host).
...
| :- | :- | :- |
| [`host`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-host) | [string](/lsr/value-types.md#string) | No |
| [`password`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-password) | [password](/lsr/value-types.md#password) | No |
| [`port`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-port) | [number](/lsr/value-types.md#number) | No |
| [`ssl_certificate`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-ssl_certificate) | [path](/lsr/value-types.md#path) | No |
| [`ssl_certificate_authorities`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-ssl_certificate_authorities) | [array](/lsr/value-types.md#array) | No |
| [`ssl_client_authentication`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-ssl_client_authentication) | [string](/lsr/value-types.md#string), one of `["none", "optional", "required"]` | No |
| [`ssl_enabled`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-ssl_enabled) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ssl_key`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-ssl_key) | [path](/lsr/value-types.md#path) | No |
| [`ssl_keystore_password`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-ssl_keystore_password) | [password](/lsr/value-types.md#password) | No |
| [`ssl_keystore_path`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-ssl_keystore_path) | [path](/lsr/value-types.md#path) | No |
| [`ssl_key_passphrase`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-ssl_key_passphrase) | [password](/lsr/value-types.md#password) | No |
| [`username`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-username) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`enable_metric`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v1-0-2-plugins-inputs-logstash.md#v1.0.2-plugins-inputs-logstash-type) | [string](/lsr/value-types.md#string) | No |
