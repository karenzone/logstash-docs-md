...
| :- | :- | :- |
| [`application_name`](v2-1-2-plugins-inputs-kinesis.md#v2.1.2-plugins-inputs-kinesis-application_name) | [string](/lsr/value-types.md#string) | No |
| [`checkpoint_interval_seconds`](v2-1-2-plugins-inputs-kinesis.md#v2.1.2-plugins-inputs-kinesis-checkpoint_interval_seconds) | [number](/lsr/value-types.md#number) | No |
| [`initial_position_in_stream`](v2-1-2-plugins-inputs-kinesis.md#v2.1.2-plugins-inputs-kinesis-initial_position_in_stream) | [string](/lsr/value-types.md#string) | No |
| [`kinesis_stream_name`](v2-1-2-plugins-inputs-kinesis.md#v2.1.2-plugins-inputs-kinesis-kinesis_stream_name) | [string](/lsr/value-types.md#string) | Yes |
| [`metrics`](v2-1-2-plugins-inputs-kinesis.md#v2.1.2-plugins-inputs-kinesis-metrics) | [string](/lsr/value-types.md#string), one of `[nil, "cloudwatch"]` | No |
| [`profile`](v2-1-2-plugins-inputs-kinesis.md#v2.1.2-plugins-inputs-kinesis-profile) | [string](/lsr/value-types.md#string) | No |
| [`region`](v2-1-2-plugins-inputs-kinesis.md#v2.1.2-plugins-inputs-kinesis-region) | [string](/lsr/value-types.md#string) | No |
| [`role_arn`](v2-1-2-plugins-inputs-kinesis.md#v2.1.2-plugins-inputs-kinesis-role_arn) | [string](/lsr/value-types.md#string) | No |
| [`role_session_name`](v2-1-2-plugins-inputs-kinesis.md#v2.1.2-plugins-inputs-kinesis-role_session_name) | [string](/lsr/value-types.md#string) | No |
| [`additional_settings`](v2-1-2-plugins-inputs-kinesis.md#v2.1.2-plugins-inputs-kinesis-additional_settings) | [string](/lsr/value-types.md#string) | No |

Also see [Common options](v2-1-2-plugins-inputs-kinesis.md#v2.1.2-plugins-inputs-kinesis-common-options) for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v2-1-2-plugins-inputs-kinesis.md#v2.1.2-plugins-inputs-kinesis-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v2-1-2-plugins-inputs-kinesis.md#v2.1.2-plugins-inputs-kinesis-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v2-1-2-plugins-inputs-kinesis.md#v2.1.2-plugins-inputs-kinesis-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v2-1-2-plugins-inputs-kinesis.md#v2.1.2-plugins-inputs-kinesis-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v2-1-2-plugins-inputs-kinesis.md#v2.1.2-plugins-inputs-kinesis-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v2-1-2-plugins-inputs-kinesis.md#v2.1.2-plugins-inputs-kinesis-type) | [string](/lsr/value-types.md#string) | No |
