...
| :- | :- | :- |
| [`cache_size`](v7-2-10-plugins-filters-geoip.md#v7.2.10-plugins-filters-geoip-cache_size) | [number](/lsr/value-types.md#number) | No |
...
| [`ecs_compatibility`](v7-2-10-plugins-filters-geoip.md#v7.2.10-plugins-filters-geoip-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`fields`](v7-2-10-plugins-filters-geoip.md#v7.2.10-plugins-filters-geoip-fields) | [array](/lsr/value-types.md#array) | No |
| [`source`](v7-2-10-plugins-filters-geoip.md#v7.2.10-plugins-filters-geoip-source) | [string](/lsr/value-types.md#string) | Yes |
| [`tag_on_failure`](v7-2-10-plugins-filters-geoip.md#v7.2.10-plugins-filters-geoip-tag_on_failure) | [array](/lsr/value-types.md#array) | No |
| [`target`](v7-2-10-plugins-filters-geoip.md#v7.2.10-plugins-filters-geoip-target) | [string](/lsr/value-types.md#string) | No |
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/current). The value of this setting affects the *default* value of [`target`](v7-2-10-plugins-filters-geoip.md#v7.2.10-plugins-filters-geoip-target).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v7-2-10-plugins-filters-geoip.md#v7.2.10-plugins-filters-geoip-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v7-2-10-plugins-filters-geoip.md#v7.2.10-plugins-filters-geoip-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v7-2-10-plugins-filters-geoip.md#v7.2.10-plugins-filters-geoip-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v7-2-10-plugins-filters-geoip.md#v7.2.10-plugins-filters-geoip-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v7-2-10-plugins-filters-geoip.md#v7.2.10-plugins-filters-geoip-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v7-2-10-plugins-filters-geoip.md#v7.2.10-plugins-filters-geoip-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v7-2-10-plugins-filters-geoip.md#v7.2.10-plugins-filters-geoip-remove_tag) | [array](/lsr/value-types.md#array) | No |
