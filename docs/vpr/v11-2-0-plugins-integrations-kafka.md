...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v11.2.0-plugins-integrations-kafka.html
applies_to:
  stack: ga
---

# Kafka Integration Plugin v11.2.0 [v11.2.0-plugins-integrations-kafka]
