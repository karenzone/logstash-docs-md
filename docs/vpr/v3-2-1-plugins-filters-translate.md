...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v3.2.1-plugins-filters-translate.html
applies_to:
  stack: ga
---

# Translate filter plugin v3.2.1 [v3.2.1-plugins-filters-translate]

* Plugin version: v3.2.1
* Released on: 2018-08-24
* [Changelog](https://github.com/logstash-plugins/logstash-filter-translate/blob/v3.2.1/CHANGELOG.md)
...
## Translate Filter Configuration Options [v3.2.1-plugins-filters-translate-options]

This plugin supports the following configuration options plus the [Common options](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`destination`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-destination) | [string](/lsr/value-types.md#string) | No |
| [`dictionary`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-dictionary) | [hash](/lsr/value-types.md#hash) | No |
| [`dictionary_path`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-dictionary_path) | a valid filesystem path | No |
| [`exact`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-exact) | [boolean](/lsr/value-types.md#boolean) | No |
| [`fallback`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-fallback) | [string](/lsr/value-types.md#string) | No |
| [`field`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-field) | [string](/lsr/value-types.md#string) | Yes |
| [`iterate_on`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-iterate_on) | [string](/lsr/value-types.md#string) | No |
| [`override`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-override) | [boolean](/lsr/value-types.md#boolean) | No |
| [`refresh_interval`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-refresh_interval) | [number](/lsr/value-types.md#number) | No |
| [`regex`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-regex) | [boolean](/lsr/value-types.md#boolean) | No |
| [`refresh_behaviour`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-refresh_behaviour) | [string](/lsr/value-types.md#string) | No |

Also see [Common options](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-common-options) for a list of options supported by all filter plugins.

### `destination` [v3.2.1-plugins-filters-translate-destination]
...
### `dictionary` [v3.2.1-plugins-filters-translate-dictionary]
...
### `dictionary_path` [v3.2.1-plugins-filters-translate-dictionary_path]
...
### `exact` [v3.2.1-plugins-filters-translate-exact]
...
### `fallback` [v3.2.1-plugins-filters-translate-fallback]
...
### `field` [v3.2.1-plugins-filters-translate-field]
...
### `iterate_on` [v3.2.1-plugins-filters-translate-iterate_on]
...
### `override` [v3.2.1-plugins-filters-translate-override]
...
### `refresh_interval` [v3.2.1-plugins-filters-translate-refresh_interval]
...
### `regex` [v3.2.1-plugins-filters-translate-regex]
...
### `refresh_behaviour` [v3.2.1-plugins-filters-translate-refresh_behaviour]
...
## Common options [v3.2.1-plugins-filters-translate-common-options]

These configuration options are supported by all filter plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v3-2-1-plugins-filters-translate.md#v3.2.1-plugins-filters-translate-remove_tag) | [array](/lsr/value-types.md#array) | No |

### `add_field` [v3.2.1-plugins-filters-translate-add_field]
...
### `add_tag` [v3.2.1-plugins-filters-translate-add_tag]
...
### `enable_metric` [v3.2.1-plugins-filters-translate-enable_metric]
...
### `id` [v3.2.1-plugins-filters-translate-id]
...
### `periodic_flush` [v3.2.1-plugins-filters-translate-periodic_flush]
...
### `remove_field` [v3.2.1-plugins-filters-translate-remove_field]
...
### `remove_tag` [v3.2.1-plugins-filters-translate-remove_tag]
