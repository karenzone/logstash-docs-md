...
Also see [Common options](v3-2-1-plugins-inputs-syslog.md#v3.2.1-plugins-inputs-syslog-common-options) for a list of options supported by all input plugins.
