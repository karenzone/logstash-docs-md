...
| :- | :- | :- |
| [`field`](v3-1-7-plugins-filters-split.md#v3.1.7-plugins-filters-split-field) | [string](/lsr/value-types.md#string) | No |
| [`target`](v3-1-7-plugins-filters-split.md#v3.1.7-plugins-filters-split-target) | [string](/lsr/value-types.md#string) | No |
| [`terminator`](v3-1-7-plugins-filters-split.md#v3.1.7-plugins-filters-split-terminator) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-1-7-plugins-filters-split.md#v3.1.7-plugins-filters-split-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v3-1-7-plugins-filters-split.md#v3.1.7-plugins-filters-split-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v3-1-7-plugins-filters-split.md#v3.1.7-plugins-filters-split-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-1-7-plugins-filters-split.md#v3.1.7-plugins-filters-split-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v3-1-7-plugins-filters-split.md#v3.1.7-plugins-filters-split-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v3-1-7-plugins-filters-split.md#v3.1.7-plugins-filters-split-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v3-1-7-plugins-filters-split.md#v3.1.7-plugins-filters-split-remove_tag) | [array](/lsr/value-types.md#array) | No |
