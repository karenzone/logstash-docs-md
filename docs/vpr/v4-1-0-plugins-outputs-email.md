...
| :- | :- | :- |
| [`address`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-address) | [string](/lsr/value-types.md#string) | No |
| [`attachments`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-attachments) | [array](/lsr/value-types.md#array) | No |
| [`authentication`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-authentication) | [string](/lsr/value-types.md#string) | No |
| [`body`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-body) | [string](/lsr/value-types.md#string) | No |
| [`cc`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-cc) | [string](/lsr/value-types.md#string) | No |
| [`bcc`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-bcc) | [string](/lsr/value-types.md#string) | No |
| [`contenttype`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-contenttype) | [string](/lsr/value-types.md#string) | No |
| [`debug`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-debug) | [boolean](/lsr/value-types.md#boolean) | No |
| [`domain`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-domain) | [string](/lsr/value-types.md#string) | No |
| [`from`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-from) | [string](/lsr/value-types.md#string) | No |
| [`htmlbody`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-htmlbody) | [string](/lsr/value-types.md#string) | No |
| [`password`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-password) | [string](/lsr/value-types.md#string) | No |
| [`port`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-port) | [number](/lsr/value-types.md#number) | No |
| [`replyto`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-replyto) | [string](/lsr/value-types.md#string) | No |
| [`subject`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-subject) | [string](/lsr/value-types.md#string) | No |
| [`to`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-to) | [string](/lsr/value-types.md#string) | Yes |
| [`use_tls`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-use_tls) | [boolean](/lsr/value-types.md#boolean) | No |
| [`username`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-username) | [string](/lsr/value-types.md#string) | No |
| [`via`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-via) | [string](/lsr/value-types.md#string) | No |
| [`template_file`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-template_file) | [path](/lsr/value-types.md#path) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v4-1-0-plugins-outputs-email.md#v4.1.0-plugins-outputs-email-id) | [string](/lsr/value-types.md#string) | No |
