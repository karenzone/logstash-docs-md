...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v6.2.2-plugins-codecs-cef.html
---

# Cef codec plugin v6.2.2 [v6.2.2-plugins-codecs-cef]

* Plugin version: v6.2.2
* Released on: 2021-06-22
* [Changelog](https://github.com/logstash-plugins/logstash-codec-cef/blob/v6.2.2/CHANGELOG.md)
...
The ECS Compatibility mode for a specific plugin instance can be controlled by setting [`ecs_compatibility`](v6-2-2-plugins-codecs-cef.md#v6.2.2-plugins-codecs-cef-ecs_compatibility) when defining the codec:
...
* When the timestamp does not include UTC-offset information, we use the event’s timezone (`dtz` or `deviceTimeZone` field), or fall through to this plugin’s [`default_timezone`](v6-2-2-plugins-codecs-cef.md#v6.2.2-plugins-codecs-cef-default_timezone).
* Localized timestamps are parsed using the provided [`locale`](v6-2-2-plugins-codecs-cef.md#v6.2.2-plugins-codecs-cef-locale).

### Field mapping [v6.2.2-plugins-codecs-cef-field-mapping]

The header fields from each CEF payload is expanded to the following fields, depending on whether ECS is enabled.

### Header field mapping [v6.2.2-plugins-codecs-cef-header-field]
...
### Extension field mapping [v6.2.2-plugins-codecs-cef-ext-field]
...
## Cef Codec Configuration Options [v6.2.2-plugins-codecs-cef-options]

| Setting | Input type | Required |
| :- | :- | :- |
| [`default_timezone`](v6-2-2-plugins-codecs-cef.md#v6.2.2-plugins-codecs-cef-default_timezone) | [string](/lsr/value-types.md#string) | No |
| [`delimiter`](v6-2-2-plugins-codecs-cef.md#v6.2.2-plugins-codecs-cef-delimiter) | [string](/lsr/value-types.md#string) | No |
| [`device`](v6-2-2-plugins-codecs-cef.md#v6.2.2-plugins-codecs-cef-device) | [string](/lsr/value-types.md#string) | No |
| [`ecs_compatibility`](v6-2-2-plugins-codecs-cef.md#v6.2.2-plugins-codecs-cef-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`fields`](v6-2-2-plugins-codecs-cef.md#v6.2.2-plugins-codecs-cef-fields) | [array](/lsr/value-types.md#array) | No |
| [`locale`](v6-2-2-plugins-codecs-cef.md#v6.2.2-plugins-codecs-cef-locale) | [string](/lsr/value-types.md#string) | No |
| [`name`](v6-2-2-plugins-codecs-cef.md#v6.2.2-plugins-codecs-cef-name) | [string](/lsr/value-types.md#string) | No |
| [`product`](v6-2-2-plugins-codecs-cef.md#v6.2.2-plugins-codecs-cef-product) | [string](/lsr/value-types.md#string) | No |
| [`reverse_mapping`](v6-2-2-plugins-codecs-cef.md#v6.2.2-plugins-codecs-cef-reverse_mapping) | [boolean](/lsr/value-types.md#boolean) | No |
| [`severity`](v6-2-2-plugins-codecs-cef.md#v6.2.2-plugins-codecs-cef-severity) | [string](/lsr/value-types.md#string) | No |
| [`signature`](v6-2-2-plugins-codecs-cef.md#v6.2.2-plugins-codecs-cef-signature) | [string](/lsr/value-types.md#string) | No |
| [`vendor`](v6-2-2-plugins-codecs-cef.md#v6.2.2-plugins-codecs-cef-vendor) | [string](/lsr/value-types.md#string) | No |
| [`version`](v6-2-2-plugins-codecs-cef.md#v6.2.2-plugins-codecs-cef-version) | [string](/lsr/value-types.md#string) | No |

### `default_timezone` [v6.2.2-plugins-codecs-cef-default_timezone]
...
### `delimiter` [v6.2.2-plugins-codecs-cef-delimiter]
...
### `device` [v6.2.2-plugins-codecs-cef-device]
...
* Option has no effect when [`ecs_compatibility => disabled`](v6-2-2-plugins-codecs-cef.md#v6.2.2-plugins-codecs-cef-ecs_compatibility).
...
### `ecs_compatibility` [v6.2.2-plugins-codecs-cef-ecs_compatibility]
...
### `fields` [v6.2.2-plugins-codecs-cef-fields]
...
### `locale` [v6.2.2-plugins-codecs-cef-locale]
...
### `name` [v6.2.2-plugins-codecs-cef-name]
...
### `product` [v6.2.2-plugins-codecs-cef-product]
...
### `reverse_mapping` [v6.2.2-plugins-codecs-cef-reverse_mapping]
...
### `severity` [v6.2.2-plugins-codecs-cef-severity]
...
### `signature` [v6.2.2-plugins-codecs-cef-signature]
...
### `vendor` [v6.2.2-plugins-codecs-cef-vendor]
...
### `version` [v6.2.2-plugins-codecs-cef-version]
