...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v7.1.1-plugins-outputs-cloudwatch.html
---

# Cloudwatch output plugin v7.1.1 [v7.1.1-plugins-outputs-cloudwatch]
...
## Cloudwatch Output Configuration Options [v7.1.1-plugins-outputs-cloudwatch-options]

This plugin supports the following configuration options plus the [Common options](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`access_key_id`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-access_key_id) | [string](/lsr/value-types.md#string) | No |
| [`aws_credentials_file`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-aws_credentials_file) | [string](/lsr/value-types.md#string) | No |
| [`batch_size`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-batch_size) | [number](/lsr/value-types.md#number) | No |
| [`dimensions`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-dimensions) | [hash](/lsr/value-types.md#hash) | No |
| [`field_dimensions`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-field_dimensions) | [string](/lsr/value-types.md#string) | No |
| [`field_metricname`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-field_metricname) | [string](/lsr/value-types.md#string) | No |
| [`field_namespace`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-field_namespace) | [string](/lsr/value-types.md#string) | No |
| [`field_unit`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-field_unit) | [string](/lsr/value-types.md#string) | No |
| [`field_value`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-field_value) | [string](/lsr/value-types.md#string) | No |
| [`metricname`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-metricname) | [string](/lsr/value-types.md#string) | No |
| [`namespace`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-namespace) | [string](/lsr/value-types.md#string) | No |
| [`proxy_uri`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-proxy_uri) | [string](/lsr/value-types.md#string) | No |
| [`queue_size`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-queue_size) | [number](/lsr/value-types.md#number) | No |
| [`region`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-region) | [string](/lsr/value-types.md#string), one of `["us-east-1", "us-east-2", "us-west-1", "us-west-2", "eu-central-1", "eu-west-1", "eu-west-2", "ap-southeast-1", "ap-southeast-2", "ap-northeast-1", "ap-northeast-2", "sa-east-1", "us-gov-west-1", "cn-north-1", "ap-south-1", "ca-central-1"]` | No |
| [`secret_access_key`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-secret_access_key) | [string](/lsr/value-types.md#string) | No |
| [`session_token`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-session_token) | [string](/lsr/value-types.md#string) | No |
| [`timeframe`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-timeframe) | [string](/lsr/value-types.md#string) | No |
| [`unit`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-unit) | [string](/lsr/value-types.md#string), one of `["Seconds", "Microseconds", "Milliseconds", "Bytes", "Kilobytes", "Megabytes", "Gigabytes", "Terabytes", "Bits", "Kilobits", "Megabits", "Gigabits", "Terabits", "Percent", "Count", "Bytes/Second", "Kilobytes/Second", "Megabytes/Second", "Gigabytes/Second", "Terabytes/Second", "Bits/Second", "Kilobits/Second", "Megabits/Second", "Gigabits/Second", "Terabits/Second", "Count/Second", "None"]` | No |
| [`value`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-value) | [string](/lsr/value-types.md#string) | No |

Also see [Common options](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-common-options) for a list of options supported by all output plugins.

### `access_key_id` [v7.1.1-plugins-outputs-cloudwatch-access_key_id]
...
### `aws_credentials_file` [v7.1.1-plugins-outputs-cloudwatch-aws_credentials_file]
...
### `batch_size` [v7.1.1-plugins-outputs-cloudwatch-batch_size]
...
### `dimensions` [v7.1.1-plugins-outputs-cloudwatch-dimensions]
...
### `field_dimensions` [v7.1.1-plugins-outputs-cloudwatch-field_dimensions]
...
### `field_metricname` [v7.1.1-plugins-outputs-cloudwatch-field_metricname]
...
### `field_namespace` [v7.1.1-plugins-outputs-cloudwatch-field_namespace]
...
### `field_unit` [v7.1.1-plugins-outputs-cloudwatch-field_unit]
...
### `field_value` [v7.1.1-plugins-outputs-cloudwatch-field_value]
...
### `metricname` [v7.1.1-plugins-outputs-cloudwatch-metricname]
...
### `namespace` [v7.1.1-plugins-outputs-cloudwatch-namespace]
...
### `proxy_uri` [v7.1.1-plugins-outputs-cloudwatch-proxy_uri]
...
### `queue_size` [v7.1.1-plugins-outputs-cloudwatch-queue_size]
...
### `region` [v7.1.1-plugins-outputs-cloudwatch-region]
...
### `secret_access_key` [v7.1.1-plugins-outputs-cloudwatch-secret_access_key]
...
### `session_token` [v7.1.1-plugins-outputs-cloudwatch-session_token]
...
### `timeframe` [v7.1.1-plugins-outputs-cloudwatch-timeframe]
...
### `unit` [v7.1.1-plugins-outputs-cloudwatch-unit]
...
### `value` [v7.1.1-plugins-outputs-cloudwatch-value]
...
## Common options [v7.1.1-plugins-outputs-cloudwatch-common-options]

These configuration options are supported by all output plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v7-1-1-plugins-outputs-cloudwatch.md#v7.1.1-plugins-outputs-cloudwatch-id) | [string](/lsr/value-types.md#string) | No |

### `codec` [v7.1.1-plugins-outputs-cloudwatch-codec]
...
### `enable_metric` [v7.1.1-plugins-outputs-cloudwatch-enable_metric]
...
### `id` [v7.1.1-plugins-outputs-cloudwatch-id]
