...
| :- | :- | :- |
| [`allow_time_override`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-allow_time_override) | [boolean](/lsr/value-types.md#boolean) | No |
| [`coerce_values`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-coerce_values) | [hash](/lsr/value-types.md#hash) | No |
| [`data_points`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-data_points) | [hash](/lsr/value-types.md#hash) | Yes |
| [`db`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-db) | [string](/lsr/value-types.md#string) | No |
| [`exclude_fields`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-exclude_fields) | [array](/lsr/value-types.md#array) | No |
| [`flush_size`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-flush_size) | [number](/lsr/value-types.md#number) | No |
| [`host`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-host) | [string](/lsr/value-types.md#string) | Yes |
| [`idle_flush_time`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-idle_flush_time) | [number](/lsr/value-types.md#number) | No |
| [`initial_delay`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-initial_delay) | [number](/lsr/value-types.md#number) | No |
| [`max_retries`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-max_retries) | [number](/lsr/value-types.md#number) | No |
| [`measurement`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-measurement) | [string](/lsr/value-types.md#string) | No |
| [`password`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-password) | [password](/lsr/value-types.md#password) | No |
| [`port`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-port) | [number](/lsr/value-types.md#number) | No |
| [`retention_policy`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-retention_policy) | [string](/lsr/value-types.md#string) | No |
| [`send_as_tags`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-send_as_tags) | [array](/lsr/value-types.md#array) | No |
| [`ssl`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-ssl) | [boolean](/lsr/value-types.md#boolean) | No |
| [`time_precision`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-time_precision) | [string](/lsr/value-types.md#string), one of `["n", "u", "ms", "s", "m", "h"]` | No |
| [`use_event_fields_for_data_points`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-use_event_fields_for_data_points) | [boolean](/lsr/value-types.md#boolean) | No |
| [`user`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-user) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v5-0-5-plugins-outputs-influxdb.md#v5.0.5-plugins-outputs-influxdb-id) | [string](/lsr/value-types.md#string) | No |
