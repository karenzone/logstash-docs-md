...
| [`timezone`](v3-3-0-plugins-inputs-syslog.md#v3.3.0-plugins-inputs-syslog-timezone) | [string](/lsr/value-types.md#string) | No |
...
### `add_field` [v3.3.0-plugins-inputs-syslog-add_field]
