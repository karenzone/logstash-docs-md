...
Also see [Common options](v4-3-0-plugins-filters-xml.md#v4.3.0-plugins-filters-xml-common-options) for a list of options supported by all filter plugins.
...
### `add_field` [v4.3.0-plugins-filters-xml-add_field]
