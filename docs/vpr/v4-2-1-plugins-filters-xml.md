...
| :- | :- | :- |
| [`force_array`](v4-2-1-plugins-filters-xml.md#v4.2.1-plugins-filters-xml-force_array) | [boolean](/lsr/value-types.md#boolean) | No |
| [`force_content`](v4-2-1-plugins-filters-xml.md#v4.2.1-plugins-filters-xml-force_content) | [boolean](/lsr/value-types.md#boolean) | No |
| [`namespaces`](v4-2-1-plugins-filters-xml.md#v4.2.1-plugins-filters-xml-namespaces) | [hash](/lsr/value-types.md#hash) | No |
| [`parse_options`](v4-2-1-plugins-filters-xml.md#v4.2.1-plugins-filters-xml-parse_options) | [string](/lsr/value-types.md#string) | No |
| [`remove_namespaces`](v4-2-1-plugins-filters-xml.md#v4.2.1-plugins-filters-xml-remove_namespaces) | [boolean](/lsr/value-types.md#boolean) | No |
| [`source`](v4-2-1-plugins-filters-xml.md#v4.2.1-plugins-filters-xml-source) | [string](/lsr/value-types.md#string) | Yes |
| [`store_xml`](v4-2-1-plugins-filters-xml.md#v4.2.1-plugins-filters-xml-store_xml) | [boolean](/lsr/value-types.md#boolean) | No |
| [`suppress_empty`](v4-2-1-plugins-filters-xml.md#v4.2.1-plugins-filters-xml-suppress_empty) | [boolean](/lsr/value-types.md#boolean) | No |
| [`target`](v4-2-1-plugins-filters-xml.md#v4.2.1-plugins-filters-xml-target) | [string](/lsr/value-types.md#string) | No |
| [`xpath`](v4-2-1-plugins-filters-xml.md#v4.2.1-plugins-filters-xml-xpath) | [hash](/lsr/value-types.md#hash) | No |

Also see [Common options](v4-2-1-plugins-filters-xml.md#v4.2.1-plugins-filters-xml-common-options) for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-2-1-plugins-filters-xml.md#v4.2.1-plugins-filters-xml-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v4-2-1-plugins-filters-xml.md#v4.2.1-plugins-filters-xml-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v4-2-1-plugins-filters-xml.md#v4.2.1-plugins-filters-xml-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v4-2-1-plugins-filters-xml.md#v4.2.1-plugins-filters-xml-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v4-2-1-plugins-filters-xml.md#v4.2.1-plugins-filters-xml-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v4-2-1-plugins-filters-xml.md#v4.2.1-plugins-filters-xml-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v4-2-1-plugins-filters-xml.md#v4.2.1-plugins-filters-xml-remove_tag) | [array](/lsr/value-types.md#array) | No |
