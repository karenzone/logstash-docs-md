...
| [`secret_access_key`](v3-1-5-plugins-inputs-s3.md#v3.1.5-plugins-inputs-s3-secret_access_key) | [string](/lsr/value-types.md#string) | No |
...
### `add_field` [v3.1.5-plugins-inputs-s3-add_field]
