...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v4.1.1-plugins-filters-grok.html
---

# Grok filter plugin v4.1.1 [v4.1.1-plugins-filters-grok]

* Plugin version: v4.1.1
* Released on: 2019-08-08
* [Changelog](https://github.com/logstash-plugins/logstash-filter-grok/blob/v4.1.1/CHANGELOG.md)
...
## Grok Filter Configuration Options [v4.1.1-plugins-filters-grok-options]

This plugin supports the following configuration options plus the [Common options](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`break_on_match`](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-break_on_match) | [boolean](/lsr/value-types.md#boolean) | No |
| [`keep_empty_captures`](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-keep_empty_captures) | [boolean](/lsr/value-types.md#boolean) | No |
| [`match`](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-match) | [hash](/lsr/value-types.md#hash) | No |
| [`named_captures_only`](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-named_captures_only) | [boolean](/lsr/value-types.md#boolean) | No |
| [`overwrite`](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-overwrite) | [array](/lsr/value-types.md#array) | No |
| [`pattern_definitions`](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-pattern_definitions) | [hash](/lsr/value-types.md#hash) | No |
| [`patterns_dir`](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-patterns_dir) | [array](/lsr/value-types.md#array) | No |
| [`patterns_files_glob`](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-patterns_files_glob) | [string](/lsr/value-types.md#string) | No |
| [`tag_on_failure`](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-tag_on_failure) | [array](/lsr/value-types.md#array) | No |
| [`tag_on_timeout`](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-tag_on_timeout) | [string](/lsr/value-types.md#string) | No |
| [`timeout_millis`](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-timeout_millis) | [number](/lsr/value-types.md#number) | No |

Also see [Common options](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-common-options) for a list of options supported by all filter plugins.

### `break_on_match` [v4.1.1-plugins-filters-grok-break_on_match]
...
### `keep_empty_captures` [v4.1.1-plugins-filters-grok-keep_empty_captures]
...
### `match` [v4.1.1-plugins-filters-grok-match]
...
### `named_captures_only` [v4.1.1-plugins-filters-grok-named_captures_only]
...
### `overwrite` [v4.1.1-plugins-filters-grok-overwrite]
...
### `pattern_definitions` [v4.1.1-plugins-filters-grok-pattern_definitions]
...
### `patterns_dir` [v4.1.1-plugins-filters-grok-patterns_dir]
...
### `patterns_files_glob` [v4.1.1-plugins-filters-grok-patterns_files_glob]
...
### `tag_on_failure` [v4.1.1-plugins-filters-grok-tag_on_failure]
...
### `tag_on_timeout` [v4.1.1-plugins-filters-grok-tag_on_timeout]
...
### `timeout_millis` [v4.1.1-plugins-filters-grok-timeout_millis]
...
## Common options [v4.1.1-plugins-filters-grok-common-options]

These configuration options are supported by all filter plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v4-1-1-plugins-filters-grok.md#v4.1.1-plugins-filters-grok-remove_tag) | [array](/lsr/value-types.md#array) | No |

### `add_field` [v4.1.1-plugins-filters-grok-add_field]
...
### `add_tag` [v4.1.1-plugins-filters-grok-add_tag]
...
### `enable_metric` [v4.1.1-plugins-filters-grok-enable_metric]
...
### `id` [v4.1.1-plugins-filters-grok-id]
...
### `periodic_flush` [v4.1.1-plugins-filters-grok-periodic_flush]
...
### `remove_field` [v4.1.1-plugins-filters-grok-remove_field]
...
### `remove_tag` [v4.1.1-plugins-filters-grok-remove_tag]
