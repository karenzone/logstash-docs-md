...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v5.0.5-plugins-integrations-jdbc.html
---

# JDBC Integration Plugin v5.0.5 [v5.0.5-plugins-integrations-jdbc]
