...
Also see [Common options](v3-1-1-plugins-filters-cidr.md#v3.1.1-plugins-filters-cidr-common-options) for a list of options supported by all filter plugins.
