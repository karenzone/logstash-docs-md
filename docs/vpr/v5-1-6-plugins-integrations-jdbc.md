...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v5.1.6-plugins-integrations-jdbc.html
applies_to:
  stack: ga
---

# JDBC Integration Plugin v5.1.6 [v5.1.6-plugins-integrations-jdbc]
