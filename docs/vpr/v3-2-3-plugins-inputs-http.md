...
Also see [Common options](v3-2-3-plugins-inputs-http.md#v3.2.3-plugins-inputs-http-common-options) for a list of options supported by all input plugins.
...
### `tags` [v3.2.3-plugins-inputs-http-tags]
