...
| :- | :- | :- |
| [`access_key_id`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-access_key_id) | [string](/lsr/value-types.md#string) | No |
| [`aws_credentials_file`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-aws_credentials_file) | [string](/lsr/value-types.md#string) | No |
| [`endpoint`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-endpoint) | [string](/lsr/value-types.md#string) | No |
| [`id_field`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-id_field) | [string](/lsr/value-types.md#string) | No |
| [`md5_field`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-md5_field) | [string](/lsr/value-types.md#string) | No |
| [`polling_frequency`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-polling_frequency) | [number](/lsr/value-types.md#number) | No |
| [`proxy_uri`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-proxy_uri) | [string](/lsr/value-types.md#string) | No |
| [`queue`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-queue) | [string](/lsr/value-types.md#string) | Yes |
| [`queue_owner_aws_account_id`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-queue_owner_aws_account_id) | [string](/lsr/value-types.md#string) | No |
| [`region`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-region) | [string](/lsr/value-types.md#string) | No |
| [`role_arn`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-role_arn) | [string](/lsr/value-types.md#string) | No |
| [`role_session_name`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-role_session_name) | [string](/lsr/value-types.md#string) | No |
| [`secret_access_key`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-secret_access_key) | [string](/lsr/value-types.md#string) | No |
| [`sent_timestamp_field`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-sent_timestamp_field) | [string](/lsr/value-types.md#string) | No |
| [`session_token`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-session_token) | [string](/lsr/value-types.md#string) | No |
| [`threads`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-threads) | [number](/lsr/value-types.md#number) | No |

Also see [Common options](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-common-options) for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v3-2-0-plugins-inputs-sqs.md#v3.2.0-plugins-inputs-sqs-type) | [string](/lsr/value-types.md#string) | No |

### `add_field` [v3.2.0-plugins-inputs-sqs-add_field]
