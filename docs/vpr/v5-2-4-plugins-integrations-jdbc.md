...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v5.2.4-plugins-integrations-jdbc.html
---

# JDBC Integration Plugin v5.2.4 [v5.2.4-plugins-integrations-jdbc]
