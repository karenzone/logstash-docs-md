...
## Netflow Codec Configuration Options [v3.9.1-plugins-codecs-netflow-options]
...
| [`cache_ttl`](v3-9-1-plugins-codecs-netflow.md#v3.9.1-plugins-codecs-netflow-cache_ttl) | [number](/lsr/value-types.md#number) | No |
| [`include_flowset_id`](v3-9-1-plugins-codecs-netflow.md#v3.9.1-plugins-codecs-netflow-include_flowset_id) | [boolean](/lsr/value-types.md#boolean) | No |
...
| [`target`](v3-9-1-plugins-codecs-netflow.md#v3.9.1-plugins-codecs-netflow-target) | [string](/lsr/value-types.md#string) | No |
| [`versions`](v3-9-1-plugins-codecs-netflow.md#v3.9.1-plugins-codecs-netflow-versions) | [array](/lsr/value-types.md#array) | No |
...
### `ipfix_definitions` [v3.9.1-plugins-codecs-netflow-ipfix_definitions]
