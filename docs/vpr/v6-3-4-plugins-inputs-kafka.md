...
| :- | :- | :- |
| [`auto_commit_interval_ms`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-auto_commit_interval_ms) | [string](/lsr/value-types.md#string) | No |
| [`auto_offset_reset`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-auto_offset_reset) | [string](/lsr/value-types.md#string) | No |
| [`bootstrap_servers`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-bootstrap_servers) | [string](/lsr/value-types.md#string) | No |
| [`check_crcs`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-check_crcs) | [string](/lsr/value-types.md#string) | No |
| [`client_id`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-client_id) | [string](/lsr/value-types.md#string) | No |
| [`connections_max_idle_ms`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-connections_max_idle_ms) | [string](/lsr/value-types.md#string) | No |
| [`consumer_threads`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-consumer_threads) | [number](/lsr/value-types.md#number) | No |
| [`decorate_events`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-decorate_events) | [boolean](/lsr/value-types.md#boolean) | No |
| [`enable_auto_commit`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-enable_auto_commit) | [string](/lsr/value-types.md#string) | No |
| [`exclude_internal_topics`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-exclude_internal_topics) | [string](/lsr/value-types.md#string) | No |
| [`fetch_max_bytes`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-fetch_max_bytes) | [string](/lsr/value-types.md#string) | No |
| [`fetch_max_wait_ms`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-fetch_max_wait_ms) | [string](/lsr/value-types.md#string) | No |
| [`fetch_min_bytes`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-fetch_min_bytes) | [string](/lsr/value-types.md#string) | No |
| [`group_id`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-group_id) | [string](/lsr/value-types.md#string) | No |
| [`heartbeat_interval_ms`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-heartbeat_interval_ms) | [string](/lsr/value-types.md#string) | No |
...
| [`key_deserializer_class`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-key_deserializer_class) | [string](/lsr/value-types.md#string) | No |
| [`max_partition_fetch_bytes`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-max_partition_fetch_bytes) | [string](/lsr/value-types.md#string) | No |
| [`max_poll_interval_ms`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-max_poll_interval_ms) | [string](/lsr/value-types.md#string) | No |
| [`max_poll_records`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-max_poll_records) | [string](/lsr/value-types.md#string) | No |
| [`metadata_max_age_ms`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-metadata_max_age_ms) | [string](/lsr/value-types.md#string) | No |
| [`partition_assignment_strategy`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-partition_assignment_strategy) | [string](/lsr/value-types.md#string) | No |
| [`poll_timeout_ms`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-poll_timeout_ms) | [number](/lsr/value-types.md#number) | No |
| [`receive_buffer_bytes`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-receive_buffer_bytes) | [string](/lsr/value-types.md#string) | No |
| [`reconnect_backoff_ms`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-reconnect_backoff_ms) | [string](/lsr/value-types.md#string) | No |
| [`request_timeout_ms`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-request_timeout_ms) | [string](/lsr/value-types.md#string) | No |
| [`retry_backoff_ms`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-retry_backoff_ms) | [string](/lsr/value-types.md#string) | No |
| [`sasl_kerberos_service_name`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-sasl_kerberos_service_name) | [string](/lsr/value-types.md#string) | No |
| [`sasl_mechanism`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-sasl_mechanism) | [string](/lsr/value-types.md#string) | No |
| [`security_protocol`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-security_protocol) | [string](/lsr/value-types.md#string), one of `["PLAINTEXT", "SSL", "SASL_PLAINTEXT", "SASL_SSL"]` | No |
| [`send_buffer_bytes`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-send_buffer_bytes) | [string](/lsr/value-types.md#string) | No |
| [`session_timeout_ms`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-session_timeout_ms) | [string](/lsr/value-types.md#string) | No |
| [`ssl_key_password`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-ssl_key_password) | [password](/lsr/value-types.md#password) | No |
...
| [`ssl_keystore_password`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-ssl_keystore_password) | [password](/lsr/value-types.md#password) | No |
| [`ssl_keystore_type`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-ssl_keystore_type) | [string](/lsr/value-types.md#string) | No |
...
| [`ssl_truststore_password`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-ssl_truststore_password) | [password](/lsr/value-types.md#password) | No |
| [`ssl_truststore_type`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-ssl_truststore_type) | [string](/lsr/value-types.md#string) | No |
| [`topics`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-topics) | [array](/lsr/value-types.md#array) | No |
| [`topics_pattern`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-topics_pattern) | [string](/lsr/value-types.md#string) | No |
| [`value_deserializer_class`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-value_deserializer_class) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v6-3-4-plugins-inputs-kafka.md#v6.3.4-plugins-inputs-kafka-type) | [string](/lsr/value-types.md#string) | No |

### `add_field` [v6.3.4-plugins-inputs-kafka-add_field]
