...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v4.1.1-plugins-filters-kv.html
---

# Kv filter plugin v4.1.1 [v4.1.1-plugins-filters-kv]

* Plugin version: v4.1.1
* Released on: 2018-03-23
* [Changelog](https://github.com/logstash-plugins/logstash-filter-kv/blob/v4.1.1/CHANGELOG.md)
...
## Kv Filter Configuration Options [v4.1.1-plugins-filters-kv-options]

This plugin supports the following configuration options plus the [Common options](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`allow_duplicate_values`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-allow_duplicate_values) | [boolean](/lsr/value-types.md#boolean) | No |
| [`default_keys`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-default_keys) | [hash](/lsr/value-types.md#hash) | No |
| [`exclude_keys`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-exclude_keys) | [array](/lsr/value-types.md#array) | No |
| [`field_split`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-field_split) | [string](/lsr/value-types.md#string) | No |
| [`include_brackets`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-include_brackets) | [boolean](/lsr/value-types.md#boolean) | No |
| [`include_keys`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-include_keys) | [array](/lsr/value-types.md#array) | No |
| [`prefix`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-prefix) | [string](/lsr/value-types.md#string) | No |
| [`recursive`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-recursive) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_char_key`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-remove_char_key) | [string](/lsr/value-types.md#string) | No |
| [`remove_char_value`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-remove_char_value) | [string](/lsr/value-types.md#string) | No |
| [`source`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-source) | [string](/lsr/value-types.md#string) | No |
| [`target`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-target) | [string](/lsr/value-types.md#string) | No |
| [`transform_key`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-transform_key) | [string](/lsr/value-types.md#string), one of `["lowercase", "uppercase", "capitalize"]` | No |
| [`transform_value`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-transform_value) | [string](/lsr/value-types.md#string), one of `["lowercase", "uppercase", "capitalize"]` | No |
| [`trim_key`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-trim_key) | [string](/lsr/value-types.md#string) | No |
| [`trim_value`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-trim_value) | [string](/lsr/value-types.md#string) | No |
| [`value_split`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-value_split) | [string](/lsr/value-types.md#string) | No |

Also see [Common options](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-common-options) for a list of options supported by all filter plugins.

### `allow_duplicate_values` [v4.1.1-plugins-filters-kv-allow_duplicate_values]
...
### `default_keys` [v4.1.1-plugins-filters-kv-default_keys]
...
### `exclude_keys` [v4.1.1-plugins-filters-kv-exclude_keys]
...
### `field_split` [v4.1.1-plugins-filters-kv-field_split]
...
### `field_split_pattern` [v4.1.1-plugins-filters-kv-field_split_pattern]
...
### `include_brackets` [v4.1.1-plugins-filters-kv-include_brackets]
...
### `include_keys` [v4.1.1-plugins-filters-kv-include_keys]
...
### `prefix` [v4.1.1-plugins-filters-kv-prefix]
...
### `recursive` [v4.1.1-plugins-filters-kv-recursive]
...
### `remove_char_key` [v4.1.1-plugins-filters-kv-remove_char_key]
...
### `remove_char_value` [v4.1.1-plugins-filters-kv-remove_char_value]
...
### `source` [v4.1.1-plugins-filters-kv-source]
...
### `target` [v4.1.1-plugins-filters-kv-target]
...
### `transform_key` [v4.1.1-plugins-filters-kv-transform_key]
...
### `transform_value` [v4.1.1-plugins-filters-kv-transform_value]
...
### `trim_key` [v4.1.1-plugins-filters-kv-trim_key]
...
### `trim_value` [v4.1.1-plugins-filters-kv-trim_value]
...
### `value_split` [v4.1.1-plugins-filters-kv-value_split]
...
### `value_split_pattern` [v4.1.1-plugins-filters-kv-value_split_pattern]
...
## Common options [v4.1.1-plugins-filters-kv-common-options]

These configuration options are supported by all filter plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v4-1-1-plugins-filters-kv.md#v4.1.1-plugins-filters-kv-remove_tag) | [array](/lsr/value-types.md#array) | No |

### `add_field` [v4.1.1-plugins-filters-kv-add_field]
...
### `add_tag` [v4.1.1-plugins-filters-kv-add_tag]
...
### `enable_metric` [v4.1.1-plugins-filters-kv-enable_metric]
...
### `id` [v4.1.1-plugins-filters-kv-id]
...
### `periodic_flush` [v4.1.1-plugins-filters-kv-periodic_flush]
...
### `remove_field` [v4.1.1-plugins-filters-kv-remove_field]
...
### `remove_tag` [v4.1.1-plugins-filters-kv-remove_tag]
