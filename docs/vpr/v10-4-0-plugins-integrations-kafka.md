...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v10.4.0-plugins-integrations-kafka.html
applies_to:
  stack: ga
---

# Kafka Integration Plugin v10.4.0 [v10.4.0-plugins-integrations-kafka]
