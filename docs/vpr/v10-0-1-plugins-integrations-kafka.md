...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v10.0.1-plugins-integrations-kafka.html
applies_to:
  stack: ga
---

# Kafka Integration Plugin v10.0.1 [v10.0.1-plugins-integrations-kafka]
