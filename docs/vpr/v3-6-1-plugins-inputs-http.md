...
| :- | :- | :- |
| [`additional_codecs`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-additional_codecs) | [hash](/lsr/value-types.md#hash) | No |
| [`cipher_suites`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-cipher_suites) | [array](/lsr/value-types.md#array) | *Deprecated* |
| [`ecs_compatibility`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`host`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-host) | [string](/lsr/value-types.md#string) | No |
| [`keystore`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-keystore) | [path](/lsr/value-types.md#path) | *Deprecated* |
| [`keystore_password`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-keystore_password) | [password](/lsr/value-types.md#password) | *Deprecated* |
| [`password`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-password) | [password](/lsr/value-types.md#password) | No |
| [`port`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-port) | [number](/lsr/value-types.md#number) | No |
| [`max_pending_requests`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-max_pending_requests) | [number](/lsr/value-types.md#number) | No |
| [`response_headers`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-response_headers) | [hash](/lsr/value-types.md#hash) | No |
| [`response_code`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-response_code) | [number](/lsr/value-types.md#number), one of `[200, 201, 202, 204]` | No |
| [`ssl`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-ssl) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ssl_certificate`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-ssl_certificate) | a valid filesystem path | No |
| [`ssl_certificate_authorities`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-ssl_certificate_authorities) | [array](/lsr/value-types.md#array) | No |
| [`ssl_cipher_suites`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-ssl_cipher_suites) | [array](/lsr/value-types.md#array) | No |
| [`ssl_handshake_timeout`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-ssl_handshake_timeout) | [number](/lsr/value-types.md#number) | No |
| [`ssl_key`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-ssl_key) | a valid filesystem path | No |
| [`ssl_key_passphrase`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-ssl_key_passphrase) | [password](/lsr/value-types.md#password) | No |
| [`ssl_supported_protocols`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-ssl_supported_protocols) | [array](/lsr/value-types.md#array) | No |
| [`ssl_verify_mode`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-ssl_verify_mode) | [string](/lsr/value-types.md#string), one of `["none", "peer", "force_peer"]` | No |
| [`threads`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-threads) | [number](/lsr/value-types.md#number) | No |
| [`tls_max_version`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-tls_max_version) | [number](/lsr/value-types.md#number) | *Deprecated* |
| [`tls_min_version`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-tls_min_version) | [number](/lsr/value-types.md#number) | *Deprecated* |
| [`user`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-user) | [string](/lsr/value-types.md#string) | No |
| [`verify_mode`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-verify_mode) | [string](/lsr/value-types.md#string), one of `["none", "peer", "force_peer"]` | *Deprecated* |
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/current). See [Event Metadata and the Elastic Common Schema (ECS)](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-ecs_metadata) for detailed information.
...
### `ssl_key` [v3.6.1-plugins-inputs-http-ssl_key]
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v3-6-1-plugins-inputs-http.md#v3.6.1-plugins-inputs-http-type) | [string](/lsr/value-types.md#string) | No |
