...
[Description](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-description)\
[Example #1](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-example1)\
[Example #2 : no start event](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-example2)\
[Example #3 : no end event](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-example3)\
[Example #4 : no end event and tasks come one after the other](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-example4)\
[Example #5 : no end event and push events as soon as possible](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-example5)\
[How it works](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-howitworks)\
[Use Cases](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-usecases)\
[Aggregate Filter Configuration Options](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-options)
...
| :- | :- | :- |
| [`aggregate_maps_path`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-aggregate_maps_path) | [string](/lsr/value-types.md#string), a valid filesystem path | No |
| [`code`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-code) | [string](/lsr/value-types.md#string) | Yes |
| [`end_of_task`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-end_of_task) | [boolean](/lsr/value-types.md#boolean) | No |
| [`inactivity_timeout`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-inactivity_timeout) | [number](/lsr/value-types.md#number) | No |
| [`map_action`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-map_action) | [string](/lsr/value-types.md#string), one of `["create", "update", "create_or_update"]` | No |
| [`push_map_as_event_on_timeout`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-push_map_as_event_on_timeout) | [boolean](/lsr/value-types.md#boolean) | No |
| [`push_previous_map_as_event`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-push_previous_map_as_event) | [boolean](/lsr/value-types.md#boolean) | No |
| [`task_id`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-task_id) | [string](/lsr/value-types.md#string) | Yes |
| [`timeout`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-timeout) | [number](/lsr/value-types.md#number) | No |
| [`timeout_code`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-timeout_code) | [string](/lsr/value-types.md#string) | No |
| [`timeout_tags`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-timeout_tags) | [array](/lsr/value-types.md#array) | No |
| [`timeout_task_id_field`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-timeout_task_id_field) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v2-6-0-plugins-filters-aggregate.md#v2.6.0-plugins-filters-aggregate-remove_tag) | [array](/lsr/value-types.md#array) | No |
