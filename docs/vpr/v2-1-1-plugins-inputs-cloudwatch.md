...
| :- | :- | :- |
| [`access_key_id`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-access_key_id) | [string](/lsr/value-types.md#string) | No |
| [`aws_credentials_file`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-aws_credentials_file) | [string](/lsr/value-types.md#string) | No |
| [`combined`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-combined) | [boolean](/lsr/value-types.md#boolean) | No |
| [`endpoint`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-endpoint) | [string](/lsr/value-types.md#string) | No |
| [`filters`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-filters) | [array](/lsr/value-types.md#array) | Yes |
| [`interval`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-interval) | [number](/lsr/value-types.md#number) | No |
| [`metrics`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-metrics) | [array](/lsr/value-types.md#array) | No |
| [`namespace`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-namespace) | [string](/lsr/value-types.md#string) | No |
| [`period`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-period) | [number](/lsr/value-types.md#number) | No |
| [`proxy_uri`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-proxy_uri) | [string](/lsr/value-types.md#string) | No |
| [`region`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-region) | [string](/lsr/value-types.md#string) | No |
| [`role_arn`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-role_arn) | [string](/lsr/value-types.md#string) | No |
| [`role_session_name`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-role_session_name) | [string](/lsr/value-types.md#string) | No |
| [`secret_access_key`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-secret_access_key) | [string](/lsr/value-types.md#string) | No |
| [`session_token`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-session_token) | [string](/lsr/value-types.md#string) | No |
| [`statistics`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-statistics) | [array](/lsr/value-types.md#array) | No |
| [`use_ssl`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-use_ssl) | [boolean](/lsr/value-types.md#boolean) | No |
...
### `period` [v2.1.1-plugins-inputs-cloudwatch-period]
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v2-1-1-plugins-inputs-cloudwatch.md#v2.1.1-plugins-inputs-cloudwatch-type) | [string](/lsr/value-types.md#string) | No |
