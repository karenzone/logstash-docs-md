...
| :- | :- | :- |
| [`additional_codecs`](v3-0-9-plugins-inputs-http.md#v3.0.9-plugins-inputs-http-additional_codecs) | [hash](/lsr/value-types.md#hash) | No |
| [`host`](v3-0-9-plugins-inputs-http.md#v3.0.9-plugins-inputs-http-host) | [string](/lsr/value-types.md#string) | No |
| [`keystore`](v3-0-9-plugins-inputs-http.md#v3.0.9-plugins-inputs-http-keystore) | a valid filesystem path | No |
| [`keystore_password`](v3-0-9-plugins-inputs-http.md#v3.0.9-plugins-inputs-http-keystore_password) | [password](/lsr/value-types.md#password) | No |
| [`password`](v3-0-9-plugins-inputs-http.md#v3.0.9-plugins-inputs-http-password) | [password](/lsr/value-types.md#password) | No |
| [`port`](v3-0-9-plugins-inputs-http.md#v3.0.9-plugins-inputs-http-port) | [number](/lsr/value-types.md#number) | No |
| [`response_headers`](v3-0-9-plugins-inputs-http.md#v3.0.9-plugins-inputs-http-response_headers) | [hash](/lsr/value-types.md#hash) | No |
| [`ssl`](v3-0-9-plugins-inputs-http.md#v3.0.9-plugins-inputs-http-ssl) | [boolean](/lsr/value-types.md#boolean) | No |
| [`threads`](v3-0-9-plugins-inputs-http.md#v3.0.9-plugins-inputs-http-threads) | [number](/lsr/value-types.md#number) | No |
| [`user`](v3-0-9-plugins-inputs-http.md#v3.0.9-plugins-inputs-http-user) | [string](/lsr/value-types.md#string) | No |
| [`verify_mode`](v3-0-9-plugins-inputs-http.md#v3.0.9-plugins-inputs-http-verify_mode) | [string](/lsr/value-types.md#string), one of `["none", "peer", "force_peer"]` | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-9-plugins-inputs-http.md#v3.0.9-plugins-inputs-http-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v3-0-9-plugins-inputs-http.md#v3.0.9-plugins-inputs-http-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-0-9-plugins-inputs-http.md#v3.0.9-plugins-inputs-http-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-0-9-plugins-inputs-http.md#v3.0.9-plugins-inputs-http-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v3-0-9-plugins-inputs-http.md#v3.0.9-plugins-inputs-http-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v3-0-9-plugins-inputs-http.md#v3.0.9-plugins-inputs-http-type) | [string](/lsr/value-types.md#string) | No |
