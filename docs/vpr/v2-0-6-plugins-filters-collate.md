...
| :- | :- | :- |
| [`count`](v2-0-6-plugins-filters-collate.md#v2.0.6-plugins-filters-collate-count) | [number](/lsr/value-types.md#number) | No |
| [`interval`](v2-0-6-plugins-filters-collate.md#v2.0.6-plugins-filters-collate-interval) | [string](/lsr/value-types.md#string) | No |
| [`order`](v2-0-6-plugins-filters-collate.md#v2.0.6-plugins-filters-collate-order) | [string](/lsr/value-types.md#string), one of `["ascending", "descending"]` | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v2-0-6-plugins-filters-collate.md#v2.0.6-plugins-filters-collate-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v2-0-6-plugins-filters-collate.md#v2.0.6-plugins-filters-collate-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v2-0-6-plugins-filters-collate.md#v2.0.6-plugins-filters-collate-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v2-0-6-plugins-filters-collate.md#v2.0.6-plugins-filters-collate-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v2-0-6-plugins-filters-collate.md#v2.0.6-plugins-filters-collate-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v2-0-6-plugins-filters-collate.md#v2.0.6-plugins-filters-collate-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v2-0-6-plugins-filters-collate.md#v2.0.6-plugins-filters-collate-remove_tag) | [array](/lsr/value-types.md#array) | No |

### `add_field` [v2.0.6-plugins-filters-collate-add_field]
