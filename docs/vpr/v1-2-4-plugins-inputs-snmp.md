...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v1.2.4-plugins-inputs-snmp.html
---

# SNMP input plugin v1.2.4 [v1.2.4-plugins-inputs-snmp]

* Plugin version: v1.2.4
* Released on: 2020-08-20
* [Changelog](https://github.com/logstash-plugins/logstash-input-snmp/blob/v1.2.4/CHANGELOG.md)
...
## Importing MIBs [v1.2.4-plugins-inputs-snmp-import-mibs]
...
## SNMP Input Configuration Options [v1.2.4-plugins-inputs-snmp-options]

This plugin supports the following configuration options plus the [Common options](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`get`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-get) | [array](/lsr/value-types.md#array) | No |
| [`hosts`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-hosts) | [array](/lsr/value-types.md#array) | No |
| [`interval`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-interval) | [number](/lsr/value-types.md#number) | No |
| [`mib_paths`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-mib_paths) | [path](/lsr/value-types.md#path) | No |
| [`oid_root_skip`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-oid_root_skip) | [number](/lsr/value-types.md#number) | No |
| [`oid_path_length`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-oid_path_length) | [number](/lsr/value-types.md#number) | No |
| [`walk`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-walk) | [array](/lsr/value-types.md#array) | No |
| [`tables`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-tables) | [array](/lsr/value-types.md#array) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`auth_pass`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-auth_pass) | [password](/lsr/value-types.md#password) | No |
| [`auth_protocol`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-auth_protocol) | [string](/lsr/value-types.md#string), one of `["md5", "sha", "sha2", "hmac128sha224", "hmac192sha256", "hmac256sha384", "hmac384sha512"]` | No |
| [`priv_pass`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-priv_pass) | [password](/lsr/value-types.md#password) | No |
| [`priv_protocol`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-priv_protocol) | [string](/lsr/value-types.md#string), one of `["des", "3des", "aes", "aes128", "aes192", "aes256"]` | No |
| [`security_level`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-security_level) | [string](/lsr/value-types.md#string), one of `["noAuthNoPriv", "authNoPriv", "authPriv"]` | No |
| [`security_name`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-security_name) | [string](/lsr/value-types.md#string) | No |

## SNMP Input Configuration Options [_snmp_input_configuration_options]

Also see [Common options](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-common-options) for a list of options supported by all input plugins.

### `get` [v1.2.4-plugins-inputs-snmp-get]
...
### `hosts` [v1.2.4-plugins-inputs-snmp-hosts]
...
### `interval` [v1.2.4-plugins-inputs-snmp-interval]
...
### `mib_paths` [v1.2.4-plugins-inputs-snmp-mib_paths]
...
This plugin includes the IETF MIBs. If you require other MIBs, you need to import them. See [Importing MIBs](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-import-mibs).

### `oid_root_skip` [v1.2.4-plugins-inputs-snmp-oid_root_skip]
...
### `oid_path_length` [v1.2.4-plugins-inputs-snmp-oid_path_length]
...
### `walk` [v1.2.4-plugins-inputs-snmp-walk]
...
### `tables` [v1.2.4-plugins-inputs-snmp-tables]
...
### `auth_pass` [v1.2.4-plugins-inputs-snmp-auth_pass]
...
### `auth_protocol` [v1.2.4-plugins-inputs-snmp-auth_protocol]
...
### `priv_pass` [v1.2.4-plugins-inputs-snmp-priv_pass]
...
### `priv_protocol` [v1.2.4-plugins-inputs-snmp-priv_protocol]
...
### `security_name` [v1.2.4-plugins-inputs-snmp-security_name]
...
### `security_level` [v1.2.4-plugins-inputs-snmp-security_level]
...
## Common options [v1.2.4-plugins-inputs-snmp-common-options]

These configuration options are supported by all input plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`enable_metric`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v1-2-4-plugins-inputs-snmp.md#v1.2.4-plugins-inputs-snmp-type) | [string](/lsr/value-types.md#string) | No |

### `add_field` [v1.2.4-plugins-inputs-snmp-add_field]
...
### `enable_metric` [v1.2.4-plugins-inputs-snmp-enable_metric]
...
### `id` [v1.2.4-plugins-inputs-snmp-id]
...
### `tags` [v1.2.4-plugins-inputs-snmp-tags]
...
### `type` [v1.2.4-plugins-inputs-snmp-type]
