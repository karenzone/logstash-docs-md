...
| :- | :- | :- |
| [`api_version`](v3-0-5-plugins-inputs-salesforce.md#v3.0.5-plugins-inputs-salesforce-api_version) | [string](/lsr/value-types.md#string) | No |
| [`client_id`](v3-0-5-plugins-inputs-salesforce.md#v3.0.5-plugins-inputs-salesforce-client_id) | [string](/lsr/value-types.md#string) | Yes |
| [`client_secret`](v3-0-5-plugins-inputs-salesforce.md#v3.0.5-plugins-inputs-salesforce-client_secret) | [string](/lsr/value-types.md#string) | Yes |
| [`password`](v3-0-5-plugins-inputs-salesforce.md#v3.0.5-plugins-inputs-salesforce-password) | [string](/lsr/value-types.md#string) | Yes |
| [`security_token`](v3-0-5-plugins-inputs-salesforce.md#v3.0.5-plugins-inputs-salesforce-security_token) | [string](/lsr/value-types.md#string) | Yes |
| [`sfdc_fields`](v3-0-5-plugins-inputs-salesforce.md#v3.0.5-plugins-inputs-salesforce-sfdc_fields) | [array](/lsr/value-types.md#array) | No |
| [`sfdc_filters`](v3-0-5-plugins-inputs-salesforce.md#v3.0.5-plugins-inputs-salesforce-sfdc_filters) | [string](/lsr/value-types.md#string) | No |
| [`sfdc_object_name`](v3-0-5-plugins-inputs-salesforce.md#v3.0.5-plugins-inputs-salesforce-sfdc_object_name) | [string](/lsr/value-types.md#string) | Yes |
| [`to_underscores`](v3-0-5-plugins-inputs-salesforce.md#v3.0.5-plugins-inputs-salesforce-to_underscores) | [boolean](/lsr/value-types.md#boolean) | No |
| [`use_test_sandbox`](v3-0-5-plugins-inputs-salesforce.md#v3.0.5-plugins-inputs-salesforce-use_test_sandbox) | [boolean](/lsr/value-types.md#boolean) | No |
| [`username`](v3-0-5-plugins-inputs-salesforce.md#v3.0.5-plugins-inputs-salesforce-username) | [string](/lsr/value-types.md#string) | Yes |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-5-plugins-inputs-salesforce.md#v3.0.5-plugins-inputs-salesforce-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v3-0-5-plugins-inputs-salesforce.md#v3.0.5-plugins-inputs-salesforce-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-0-5-plugins-inputs-salesforce.md#v3.0.5-plugins-inputs-salesforce-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-0-5-plugins-inputs-salesforce.md#v3.0.5-plugins-inputs-salesforce-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v3-0-5-plugins-inputs-salesforce.md#v3.0.5-plugins-inputs-salesforce-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v3-0-5-plugins-inputs-salesforce.md#v3.0.5-plugins-inputs-salesforce-type) | [string](/lsr/value-types.md#string) | No |
