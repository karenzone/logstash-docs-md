...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v12.0.2-plugins-integrations-kafka.html
applies_to:
  stack: ga
---

# Kafka Integration Plugin v12.0.2 [v12.0.2-plugins-integrations-kafka]
