...
| :- | :- | :- |
| [`hosts`](v1-0-0-plugins-outputs-logstash.md#v1.0.0-plugins-outputs-logstash-hosts) | list of [string](/lsr/value-types.md#string) | Yes |
| [`password`](v1-0-0-plugins-outputs-logstash.md#v1.0.0-plugins-outputs-logstash-password) | [password](/lsr/value-types.md#password) | No |
| [`ssl_enabled`](v1-0-0-plugins-outputs-logstash.md#v1.0.0-plugins-outputs-logstash-ssl_enabled) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ssl_certificate`](v1-0-0-plugins-outputs-logstash.md#v1.0.0-plugins-outputs-logstash-ssl_certificate) | [path](/lsr/value-types.md#path) | No |
| [`ssl_certificate_authorities`](v1-0-0-plugins-outputs-logstash.md#v1.0.0-plugins-outputs-logstash-ssl_certificate_authorities) | list of [path](/lsr/value-types.md#path) | No |
| [`ssl_key`](v1-0-0-plugins-outputs-logstash.md#v1.0.0-plugins-outputs-logstash-ssl_key) | [path](/lsr/value-types.md#path) | No |
| [`ssl_keystore_path`](v1-0-0-plugins-outputs-logstash.md#v1.0.0-plugins-outputs-logstash-ssl_keystore_path) | [path](/lsr/value-types.md#path) | No |
| [`ssl_keystore_password`](v1-0-0-plugins-outputs-logstash.md#v1.0.0-plugins-outputs-logstash-ssl_keystore_password) | [password](/lsr/value-types.md#password) | No |
| [`ssl_truststore_path`](v1-0-0-plugins-outputs-logstash.md#v1.0.0-plugins-outputs-logstash-ssl_truststore_path) | [path](/lsr/value-types.md#path) | No |
| [`ssl_truststore_password`](v1-0-0-plugins-outputs-logstash.md#v1.0.0-plugins-outputs-logstash-ssl_truststore_password) | [password](/lsr/value-types.md#password) | No |
| [`ssl_verification_mode`](v1-0-0-plugins-outputs-logstash.md#v1.0.0-plugins-outputs-logstash-ssl_verification_mode) | [string](/lsr/value-types.md#string), one of `["full", "none"]` | No |
| [`username`](v1-0-0-plugins-outputs-logstash.md#v1.0.0-plugins-outputs-logstash-username) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`enable_metric`](v1-0-0-plugins-outputs-logstash.md#v1.0.0-plugins-outputs-logstash-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v1-0-0-plugins-outputs-logstash.md#v1.0.0-plugins-outputs-logstash-id) | [string](/lsr/value-types.md#string) | No |
