...
This plugin supports the following configuration options plus the [Common options](v4-3-0-plugins-filters-kv.md#v4.3.0-plugins-filters-kv-common-options) described later.
