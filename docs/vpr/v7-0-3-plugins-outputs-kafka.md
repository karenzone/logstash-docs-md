...
| [`retry_backoff_ms`](v7-0-3-plugins-outputs-kafka.md#v7.0.3-plugins-outputs-kafka-retry_backoff_ms) | [number](/lsr/value-types.md#number) | No |
...
### `codec` [v7.0.3-plugins-outputs-kafka-codec]
