...
| :- | :- | :- |
| [`batch_count`](v3-1-3-plugins-inputs-redis.md#v3.1.3-plugins-inputs-redis-batch_count) | [number](/lsr/value-types.md#number) | No |
| [`data_type`](v3-1-3-plugins-inputs-redis.md#v3.1.3-plugins-inputs-redis-data_type) | [string](/lsr/value-types.md#string), one of `["list", "channel", "pattern_channel"]` | Yes |
| [`db`](v3-1-3-plugins-inputs-redis.md#v3.1.3-plugins-inputs-redis-db) | [number](/lsr/value-types.md#number) | No |
| [`host`](v3-1-3-plugins-inputs-redis.md#v3.1.3-plugins-inputs-redis-host) | [string](/lsr/value-types.md#string) | No |
| [`key`](v3-1-3-plugins-inputs-redis.md#v3.1.3-plugins-inputs-redis-key) | [string](/lsr/value-types.md#string) | Yes |
| [`password`](v3-1-3-plugins-inputs-redis.md#v3.1.3-plugins-inputs-redis-password) | [password](/lsr/value-types.md#password) | No |
| [`port`](v3-1-3-plugins-inputs-redis.md#v3.1.3-plugins-inputs-redis-port) | [number](/lsr/value-types.md#number) | No |
| [`threads`](v3-1-3-plugins-inputs-redis.md#v3.1.3-plugins-inputs-redis-threads) | [number](/lsr/value-types.md#number) | No |
| [`timeout`](v3-1-3-plugins-inputs-redis.md#v3.1.3-plugins-inputs-redis-timeout) | [number](/lsr/value-types.md#number) | No |

Also see [Common options](v3-1-3-plugins-inputs-redis.md#v3.1.3-plugins-inputs-redis-common-options) for a list of options supported by all input plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-1-3-plugins-inputs-redis.md#v3.1.3-plugins-inputs-redis-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v3-1-3-plugins-inputs-redis.md#v3.1.3-plugins-inputs-redis-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-1-3-plugins-inputs-redis.md#v3.1.3-plugins-inputs-redis-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-1-3-plugins-inputs-redis.md#v3.1.3-plugins-inputs-redis-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v3-1-3-plugins-inputs-redis.md#v3.1.3-plugins-inputs-redis-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v3-1-3-plugins-inputs-redis.md#v3.1.3-plugins-inputs-redis-type) | [string](/lsr/value-types.md#string) | No |
