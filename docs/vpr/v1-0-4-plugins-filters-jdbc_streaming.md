...
This plugin supports the following configuration options plus the [Common options](v1-0-4-plugins-filters-jdbc_streaming.md#v1.0.4-plugins-filters-jdbc_streaming-common-options) described later.
