...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v0.0.2-plugins-integrations-logstash.html
applies_to:
  stack: ga
---

# Logstash Integration Plugin v0.0.2 [v0.0.2-plugins-integrations-logstash]
...
### High-level concepts [v0.0.2-plugins-integrations-logstash-concepts]
