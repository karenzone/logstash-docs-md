...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v7.3.2-plugins-integrations-rabbitmq.html
applies_to:
  stack: ga
---

# Rabbitmq Integration Plugin v7.3.2 [v7.3.2-plugins-integrations-rabbitmq]
