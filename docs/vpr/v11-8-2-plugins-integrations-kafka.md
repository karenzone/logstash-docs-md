...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v11.8.2-plugins-integrations-kafka.html
applies_to:
  stack: ga
---

# Kafka Integration Plugin v11.8.2 [v11.8.2-plugins-integrations-kafka]

* Plugin version: v11.8.2
