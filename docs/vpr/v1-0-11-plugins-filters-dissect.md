...
| :- | :- | :- |
| [`convert_datatype`](v1-0-11-plugins-filters-dissect.md#v1.0.11-plugins-filters-dissect-convert_datatype) | [hash](/lsr/value-types.md#hash) | No |
| [`mapping`](v1-0-11-plugins-filters-dissect.md#v1.0.11-plugins-filters-dissect-mapping) | [hash](/lsr/value-types.md#hash) | No |
| [`tag_on_failure`](v1-0-11-plugins-filters-dissect.md#v1.0.11-plugins-filters-dissect-tag_on_failure) | [array](/lsr/value-types.md#array) | No |

Also see [Common options](v1-0-11-plugins-filters-dissect.md#v1.0.11-plugins-filters-dissect-common-options) for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v1-0-11-plugins-filters-dissect.md#v1.0.11-plugins-filters-dissect-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v1-0-11-plugins-filters-dissect.md#v1.0.11-plugins-filters-dissect-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v1-0-11-plugins-filters-dissect.md#v1.0.11-plugins-filters-dissect-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v1-0-11-plugins-filters-dissect.md#v1.0.11-plugins-filters-dissect-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v1-0-11-plugins-filters-dissect.md#v1.0.11-plugins-filters-dissect-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v1-0-11-plugins-filters-dissect.md#v1.0.11-plugins-filters-dissect-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v1-0-11-plugins-filters-dissect.md#v1.0.11-plugins-filters-dissect-remove_tag) | [array](/lsr/value-types.md#array) | No |
