...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v7.3.0-plugins-integrations-aws.html
applies_to:
  stack: ga
---

# AWS Integration Plugin v7.3.0 [v7.3.0-plugins-integrations-aws]
