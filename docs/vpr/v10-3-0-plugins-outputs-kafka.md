...
| [`sasl_mechanism`](v10-3-0-plugins-outputs-kafka.md#v10.3.0-plugins-outputs-kafka-sasl_mechanism) | [string](/lsr/value-types.md#string) | No |
...
### `codec` [v10.3.0-plugins-outputs-kafka-codec]
