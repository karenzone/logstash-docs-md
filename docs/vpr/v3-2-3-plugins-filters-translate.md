...
### `exact` [v3.2.3-plugins-filters-translate-exact]
...
### `refresh_interval` [v3.2.3-plugins-filters-translate-refresh_interval]
...
### `add_field` [v3.2.3-plugins-filters-translate-add_field]
