...
| :- | :- | :- |
| [`arguments`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-arguments) | [array](/lsr/value-types.md#array) | No |
| [`automatic_recovery`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-automatic_recovery) | [boolean](/lsr/value-types.md#boolean) | No |
| [`connect_retry_interval`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-connect_retry_interval) | [number](/lsr/value-types.md#number) | No |
| [`connection_timeout`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-connection_timeout) | [number](/lsr/value-types.md#number) | No |
| [`durable`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-durable) | [boolean](/lsr/value-types.md#boolean) | No |
| [`exchange`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-exchange) | [string](/lsr/value-types.md#string) | Yes |
| [`exchange_type`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-exchange_type) | [string](/lsr/value-types.md#string), one of `["fanout", "direct", "topic", "x-consistent-hash", "x-modulus-hash"]` | Yes |
| [`heartbeat`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-heartbeat) | [number](/lsr/value-types.md#number) | No |
| [`host`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-host) | [string](/lsr/value-types.md#string) | Yes |
| [`key`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-key) | [string](/lsr/value-types.md#string) | No |
| [`message_properties`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-message_properties) | [hash](/lsr/value-types.md#hash) | No |
| [`passive`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-passive) | [boolean](/lsr/value-types.md#boolean) | No |
| [`password`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-password) | [password](/lsr/value-types.md#password) | No |
| [`persistent`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-persistent) | [boolean](/lsr/value-types.md#boolean) | No |
| [`port`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-port) | [number](/lsr/value-types.md#number) | No |
| [`ssl`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-ssl) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ssl_certificate_password`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-ssl_certificate_password) | [string](/lsr/value-types.md#string) | No |
...
| [`ssl_version`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-ssl_version) | [string](/lsr/value-types.md#string) | No |
| [`user`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-user) | [string](/lsr/value-types.md#string) | No |
| [`vhost`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-vhost) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v5-0-0-plugins-outputs-rabbitmq.md#v5.0.0-plugins-outputs-rabbitmq-id) | [string](/lsr/value-types.md#string) | No |

### `codec` [v5.0.0-plugins-outputs-rabbitmq-codec]
