...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v11.6.1-plugins-integrations-kafka.html
---

# Kafka Integration Plugin v11.6.1 [v11.6.1-plugins-integrations-kafka]
