...
| :- | :- | :- |
| [`end_tag`](v4-1-0-plugins-filters-elapsed.md#v4.1.0-plugins-filters-elapsed-end_tag) | [string](/lsr/value-types.md#string) | Yes |
| [`new_event_on_match`](v4-1-0-plugins-filters-elapsed.md#v4.1.0-plugins-filters-elapsed-new_event_on_match) | [boolean](/lsr/value-types.md#boolean) | No |
| [`start_tag`](v4-1-0-plugins-filters-elapsed.md#v4.1.0-plugins-filters-elapsed-start_tag) | [string](/lsr/value-types.md#string) | Yes |
| [`timeout`](v4-1-0-plugins-filters-elapsed.md#v4.1.0-plugins-filters-elapsed-timeout) | [number](/lsr/value-types.md#number) | No |
| [`unique_id_field`](v4-1-0-plugins-filters-elapsed.md#v4.1.0-plugins-filters-elapsed-unique_id_field) | [string](/lsr/value-types.md#string) | Yes |
| [`keep_start_event`](v4-1-0-plugins-filters-elapsed.md#v4.1.0-plugins-filters-elapsed-keep_start_event) | [string](/lsr/value-types.md#string) | No |

Also see [Common options](v4-1-0-plugins-filters-elapsed.md#v4.1.0-plugins-filters-elapsed-common-options) for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v4-1-0-plugins-filters-elapsed.md#v4.1.0-plugins-filters-elapsed-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v4-1-0-plugins-filters-elapsed.md#v4.1.0-plugins-filters-elapsed-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v4-1-0-plugins-filters-elapsed.md#v4.1.0-plugins-filters-elapsed-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v4-1-0-plugins-filters-elapsed.md#v4.1.0-plugins-filters-elapsed-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v4-1-0-plugins-filters-elapsed.md#v4.1.0-plugins-filters-elapsed-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v4-1-0-plugins-filters-elapsed.md#v4.1.0-plugins-filters-elapsed-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v4-1-0-plugins-filters-elapsed.md#v4.1.0-plugins-filters-elapsed-remove_tag) | [array](/lsr/value-types.md#array) | No |
