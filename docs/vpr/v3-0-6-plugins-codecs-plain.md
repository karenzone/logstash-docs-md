...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v3.0.6-plugins-codecs-plain.html
applies_to:
  stack: ga
---

# Plain codec plugin v3.0.6 [v3.0.6-plugins-codecs-plain]

* Plugin version: v3.0.6
* Released on: 2017-12-19
* [Changelog](https://github.com/logstash-plugins/logstash-codec-plain/blob/v3.0.6/CHANGELOG.md)
...
### `format` [v3.0.6-plugins-codecs-plain-format]
