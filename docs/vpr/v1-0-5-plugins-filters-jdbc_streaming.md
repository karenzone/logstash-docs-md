...
This plugin supports the following configuration options plus the [Common options](v1-0-5-plugins-filters-jdbc_streaming.md#v1.0.5-plugins-filters-jdbc_streaming-common-options) described later.
