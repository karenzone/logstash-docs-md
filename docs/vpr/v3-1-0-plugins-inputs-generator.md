...
This plugin uses different field names depending on whether [ECS-compatibility](https://www.elastic.co/guide/en/ecs/current) is enabled. See [`ecs_compatibility`](v3-1-0-plugins-inputs-generator.md#v3.1.0-plugins-inputs-generator-ecs_compatibility).
...
| :- | :- | :- |
| [`count`](v3-1-0-plugins-inputs-generator.md#v3.1.0-plugins-inputs-generator-count) | [number](/lsr/value-types.md#number) | No |
| [`ecs_compatibility`](v3-1-0-plugins-inputs-generator.md#v3.1.0-plugins-inputs-generator-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`lines`](v3-1-0-plugins-inputs-generator.md#v3.1.0-plugins-inputs-generator-lines) | [array](/lsr/value-types.md#array) | No |
| [`message`](v3-1-0-plugins-inputs-generator.md#v3.1.0-plugins-inputs-generator-message) | [string](/lsr/value-types.md#string) | No |
| [`threads`](v3-1-0-plugins-inputs-generator.md#v3.1.0-plugins-inputs-generator-threads) | [number](/lsr/value-types.md#number) | No |
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/current). See [Compatibility with the Elastic Common Schema (ECS)](v3-1-0-plugins-inputs-generator.md#v3.1.0-plugins-inputs-generator-ecs) for detailed information.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-1-0-plugins-inputs-generator.md#v3.1.0-plugins-inputs-generator-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v3-1-0-plugins-inputs-generator.md#v3.1.0-plugins-inputs-generator-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-1-0-plugins-inputs-generator.md#v3.1.0-plugins-inputs-generator-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-1-0-plugins-inputs-generator.md#v3.1.0-plugins-inputs-generator-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v3-1-0-plugins-inputs-generator.md#v3.1.0-plugins-inputs-generator-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v3-1-0-plugins-inputs-generator.md#v3.1.0-plugins-inputs-generator-type) | [string](/lsr/value-types.md#string) | No |
