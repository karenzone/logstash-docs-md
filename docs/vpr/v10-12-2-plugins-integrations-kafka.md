...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v10.12.2-plugins-integrations-kafka.html
---

# Kafka Integration Plugin v10.12.2 [v10.12.2-plugins-integrations-kafka]

* Plugin version: v10.12.2
