...
| :- | :- | :- |
| [`count`](v3-1-0-plugins-inputs-heartbeat.md#v3.1.0-plugins-inputs-heartbeat-count) | [number](/lsr/value-types.md#number) | No |
| [`ecs_compatibility`](v3-1-0-plugins-inputs-heartbeat.md#v3.1.0-plugins-inputs-heartbeat-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`interval`](v3-1-0-plugins-inputs-heartbeat.md#v3.1.0-plugins-inputs-heartbeat-interval) | [number](/lsr/value-types.md#number) | No |
| [`message`](v3-1-0-plugins-inputs-heartbeat.md#v3.1.0-plugins-inputs-heartbeat-message) | [string](/lsr/value-types.md#string) | No |
| [`sequence`](v3-1-0-plugins-inputs-heartbeat.md#v3.1.0-plugins-inputs-heartbeat-sequence) | [string](/lsr/value-types.md#string) one of `["none", "epoch", "sequence"]` | No |
| [`threads`](v3-1-0-plugins-inputs-heartbeat.md#v3.1.0-plugins-inputs-heartbeat-threads) | [number](/lsr/value-types.md#number) | No |
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/current). Refer to [Elastic Common Schema (ECS)](v3-1-0-plugins-inputs-heartbeat.md#v3.1.0-plugins-inputs-heartbeat-ecs) in this topic for detailed information.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-1-0-plugins-inputs-heartbeat.md#v3.1.0-plugins-inputs-heartbeat-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v3-1-0-plugins-inputs-heartbeat.md#v3.1.0-plugins-inputs-heartbeat-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v3-1-0-plugins-inputs-heartbeat.md#v3.1.0-plugins-inputs-heartbeat-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-1-0-plugins-inputs-heartbeat.md#v3.1.0-plugins-inputs-heartbeat-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v3-1-0-plugins-inputs-heartbeat.md#v3.1.0-plugins-inputs-heartbeat-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v3-1-0-plugins-inputs-heartbeat.md#v3.1.0-plugins-inputs-heartbeat-type) | [string](/lsr/value-types.md#string) | No |
