...
| :- | :- | :- |
| [`fields`](v1-0-4-plugins-filters-de_dot.md#v1.0.4-plugins-filters-de_dot-fields) | [array](/lsr/value-types.md#array) | No |
| [`nested`](v1-0-4-plugins-filters-de_dot.md#v1.0.4-plugins-filters-de_dot-nested) | [boolean](/lsr/value-types.md#boolean) | No |
| [`separator`](v1-0-4-plugins-filters-de_dot.md#v1.0.4-plugins-filters-de_dot-separator) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v1-0-4-plugins-filters-de_dot.md#v1.0.4-plugins-filters-de_dot-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v1-0-4-plugins-filters-de_dot.md#v1.0.4-plugins-filters-de_dot-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v1-0-4-plugins-filters-de_dot.md#v1.0.4-plugins-filters-de_dot-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v1-0-4-plugins-filters-de_dot.md#v1.0.4-plugins-filters-de_dot-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v1-0-4-plugins-filters-de_dot.md#v1.0.4-plugins-filters-de_dot-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v1-0-4-plugins-filters-de_dot.md#v1.0.4-plugins-filters-de_dot-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v1-0-4-plugins-filters-de_dot.md#v1.0.4-plugins-filters-de_dot-remove_tag) | [array](/lsr/value-types.md#array) | No |
