...
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v7.4.1-plugins-integrations-rabbitmq.html
applies_to:
  stack: ga
---

# Rabbitmq Integration Plugin v7.4.1 [v7.4.1-plugins-integrations-rabbitmq]
