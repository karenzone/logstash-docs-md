---
navigation_title: v1.5.2
mapped_pages:
  - https://www.elastic.co/guide/en/logstash-versioned-plugins/current/v1.5.2-plugins-inputs-azure_event_hubs.html
applies_to:
  stack: ga
---

# Azure Event Hubs plugin v1.5.2 [v1.5.2-plugins-inputs-azure_event_hubs]
...
### Best practices [v1.5.2-plugins-inputs-azure_event_hubs-best-practices]

Here are some guidelines to help you avoid data conflicts that can cause lost events.

* [Create a Logstash consumer group](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-bp-group)
* [Avoid overwriting offset with multiple Event Hubs](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-bp-multihub)
* [Set number of threads correctly](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-bp-threads)

### Create a Logstash consumer group [v1.5.2-plugins-inputs-azure_event_hubs-bp-group]
...
### Avoid overwriting offset with multiple Event Hubs [v1.5.2-plugins-inputs-azure_event_hubs-bp-multihub]
...
### Set number of threads correctly [v1.5.2-plugins-inputs-azure_event_hubs-bp-threads]
...
## Configuration models [v1.5.2-plugins-inputs-azure_event_hubs-eh_config_models]
...
### Basic configuration (default) [v1.5.2-plugins-inputs-azure_event_hubs-eh_basic_config]
...
### Advanced configuration [v1.5.2-plugins-inputs-azure_event_hubs-eh_advanced_config]
...
## Azure Event Hubs Configuration Options [v1.5.2-plugins-inputs-azure_event_hubs-options]

This plugin supports the following configuration options plus the [Common options](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`config_mode`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-config_mode) | [string](/lsr/value-types.md#string), (`basic` or `advanced`) | No |
| [`event_hubs`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-event_hubs) | [array](/lsr/value-types.md#array) | Yes, when `config_mode => advanced` |
| [`event_hub_connections`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-event_hub_connections) | [array](/lsr/value-types.md#array) | Yes, when `config_mode => basic` |
| [`event_hub_connection`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-event_hub_connection) | [string](/lsr/value-types.md#string) | Yes, when `config_mode => advanced` |
| [`checkpoint_interval`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-checkpoint_interval) | [number](/lsr/value-types.md#number) | No |
| [`consumer_group`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-consumer_group) | [string](/lsr/value-types.md#string) | No |
| [`decorate_events`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-decorate_events) | [boolean](/lsr/value-types.md#boolean) | No |
| [`initial_position`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-initial_position) | [string](/lsr/value-types.md#string), (`beginning`, `end`, or `look_back`) | No |
| [`initial_position_look_back`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-initial_position_look_back) | [number](/lsr/value-types.md#number) | No, unless `initial_position => look_back` |
| [`max_batch_size`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-max_batch_size) | [number](/lsr/value-types.md#number) | No |
| [`storage_connection`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-storage_connection) | [string](/lsr/value-types.md#string) | No |
| [`storage_container`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-storage_container) | [string](/lsr/value-types.md#string) | No |
| [`threads`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-threads) | [number](/lsr/value-types.md#number) | No |

Also see [Common options](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-common-options) for a list of options supported by all input plugins.
...
### `config_mode` [v1.5.2-plugins-inputs-azure_event_hubs-config_mode]

* Value type is [string](/lsr/value-types.md#string)
* Valid entries are `basic` or `advanced`
* Default value is `basic`

Sets configuration to either [Basic configuration (default)](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-eh_basic_config) or [Advanced configuration](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-eh_advanced_config).
...
### `event_hubs` [v1.5.2-plugins-inputs-azure_event_hubs-event_hubs]
...
### `event_hub_connections` [v1.5.2-plugins-inputs-azure_event_hubs-event_hub_connections]
...
### `event_hub_connection` [v1.5.2-plugins-inputs-azure_event_hubs-event_hub_connection]
...
### `checkpoint_interval` [v1.5.2-plugins-inputs-azure_event_hubs-checkpoint_interval]
...
### `consumer_group` [v1.5.2-plugins-inputs-azure_event_hubs-consumer_group]
...
### `decorate_events` [v1.5.2-plugins-inputs-azure_event_hubs-decorate_events]
...
### `initial_position` [v1.5.2-plugins-inputs-azure_event_hubs-initial_position]
...
### `initial_position_look_back` [v1.5.2-plugins-inputs-azure_event_hubs-initial_position_look_back]
...
### `max_batch_size` [v1.5.2-plugins-inputs-azure_event_hubs-max_batch_size]
...
### `storage_connection` [v1.5.2-plugins-inputs-azure_event_hubs-storage_connection]
...
### `storage_container` [v1.5.2-plugins-inputs-azure_event_hubs-storage_container]
...
### `threads` [v1.5.2-plugins-inputs-azure_event_hubs-threads]
...
The number of threads should be the number of Event Hubs plus one or more. See [Best practices](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-best-practices) for more information.

## Common options [v1.5.2-plugins-inputs-azure_event_hubs-common-options]

These configuration options are supported by all input plugins:

| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](v1-5-2-plugins-inputs-azure_event_hubs.md#v1.5.2-plugins-inputs-azure_event_hubs-type) | [string](/lsr/value-types.md#string) | No |

### `add_field` [v1.5.2-plugins-inputs-azure_event_hubs-add_field]
...
### `codec` [v1.5.2-plugins-inputs-azure_event_hubs-codec]
...
### `enable_metric` [v1.5.2-plugins-inputs-azure_event_hubs-enable_metric]
...
### `id` [v1.5.2-plugins-inputs-azure_event_hubs-id]
...
### `tags` [v1.5.2-plugins-inputs-azure_event_hubs-tags]
...
### `type` [v1.5.2-plugins-inputs-azure_event_hubs-type]
