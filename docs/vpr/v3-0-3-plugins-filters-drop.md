...
| :- | :- | :- |
| [`percentage`](v3-0-3-plugins-filters-drop.md#v3.0.3-plugins-filters-drop-percentage) | [number](/lsr/value-types.md#number) | No |

Also see [Common options](v3-0-3-plugins-filters-drop.md#v3.0.3-plugins-filters-drop-common-options) for a list of options supported by all filter plugins.
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](v3-0-3-plugins-filters-drop.md#v3.0.3-plugins-filters-drop-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](v3-0-3-plugins-filters-drop.md#v3.0.3-plugins-filters-drop-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](v3-0-3-plugins-filters-drop.md#v3.0.3-plugins-filters-drop-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](v3-0-3-plugins-filters-drop.md#v3.0.3-plugins-filters-drop-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](v3-0-3-plugins-filters-drop.md#v3.0.3-plugins-filters-drop-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](v3-0-3-plugins-filters-drop.md#v3.0.3-plugins-filters-drop-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](v3-0-3-plugins-filters-drop.md#v3.0.3-plugins-filters-drop-remove_tag) | [array](/lsr/value-types.md#array) | No |
