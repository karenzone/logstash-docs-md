...
| :- | :- | :- |
| [`convert`](plugins-filters-mutate.md#plugins-filters-mutate-convert) | [hash](/lsr/value-types.md#hash) | No |
| [`copy`](plugins-filters-mutate.md#plugins-filters-mutate-copy) | [hash](/lsr/value-types.md#hash) | No |
| [`gsub`](plugins-filters-mutate.md#plugins-filters-mutate-gsub) | [array](/lsr/value-types.md#array) | No |
| [`join`](plugins-filters-mutate.md#plugins-filters-mutate-join) | [hash](/lsr/value-types.md#hash) | No |
| [`lowercase`](plugins-filters-mutate.md#plugins-filters-mutate-lowercase) | [array](/lsr/value-types.md#array) | No |
| [`merge`](plugins-filters-mutate.md#plugins-filters-mutate-merge) | [hash](/lsr/value-types.md#hash) | No |
| [`coerce`](plugins-filters-mutate.md#plugins-filters-mutate-coerce) | [hash](/lsr/value-types.md#hash) | No |
| [`rename`](plugins-filters-mutate.md#plugins-filters-mutate-rename) | [hash](/lsr/value-types.md#hash) | No |
| [`replace`](plugins-filters-mutate.md#plugins-filters-mutate-replace) | [hash](/lsr/value-types.md#hash) | No |
| [`split`](plugins-filters-mutate.md#plugins-filters-mutate-split) | [hash](/lsr/value-types.md#hash) | No |
| [`strip`](plugins-filters-mutate.md#plugins-filters-mutate-strip) | [array](/lsr/value-types.md#array) | No |
| [`update`](plugins-filters-mutate.md#plugins-filters-mutate-update) | [hash](/lsr/value-types.md#hash) | No |
| [`uppercase`](plugins-filters-mutate.md#plugins-filters-mutate-uppercase) | [array](/lsr/value-types.md#array) | No |
| [`capitalize`](plugins-filters-mutate.md#plugins-filters-mutate-capitalize) | [array](/lsr/value-types.md#array) | No |
| [`tag_on_failure`](plugins-filters-mutate.md#plugins-filters-mutate-tag_on_failure) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-mutate.md#plugins-filters-mutate-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-mutate.md#plugins-filters-mutate-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-mutate.md#plugins-filters-mutate-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-mutate.md#plugins-filters-mutate-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-mutate.md#plugins-filters-mutate-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-mutate.md#plugins-filters-mutate-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-mutate.md#plugins-filters-mutate-remove_tag) | [array](/lsr/value-types.md#array) | No |
