...
* Plugin version: v1.0.3 ([Other versions](/vpr/filter-bytes-index.md))
...
| :- | :- | :- |
| [`source`](plugins-filters-bytes.md#plugins-filters-bytes-source) | [string](/lsr/value-types.md#string) | No |
| [`target`](plugins-filters-bytes.md#plugins-filters-bytes-target) | [string](/lsr/value-types.md#string) | Yes |
| [`conversion_method`](plugins-filters-bytes.md#plugins-filters-bytes-conversion_method) | [string](/lsr/value-types.md#string) | No |
| [`source`](plugins-filters-bytes.md#plugins-filters-bytes-decimal_separator) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-bytes.md#plugins-filters-bytes-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-bytes.md#plugins-filters-bytes-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-bytes.md#plugins-filters-bytes-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-bytes.md#plugins-filters-bytes-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-bytes.md#plugins-filters-bytes-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-bytes.md#plugins-filters-bytes-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-bytes.md#plugins-filters-bytes-remove_tag) | [array](/lsr/value-types.md#array) | No |
