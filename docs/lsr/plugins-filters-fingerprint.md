...
* Plugin version: v3.4.4 ([Other versions](/vpr/filter-fingerprint-index.md))
...
| :- | :- | :- |
| [`base64encode`](plugins-filters-fingerprint.md#plugins-filters-fingerprint-base64encode) | [boolean](/lsr/value-types.md#boolean) | No |
| [`concatenate_sources`](plugins-filters-fingerprint.md#plugins-filters-fingerprint-concatenate_sources) | [boolean](/lsr/value-types.md#boolean) | No |
| [`concatenate_all_fields`](plugins-filters-fingerprint.md#plugins-filters-fingerprint-concatenate_all_fields) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ecs_compatibility`](plugins-filters-fingerprint.md#plugins-filters-fingerprint-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`key`](plugins-filters-fingerprint.md#plugins-filters-fingerprint-key) | [password](/lsr/value-types.md#password) | No |
| [`method`](plugins-filters-fingerprint.md#plugins-filters-fingerprint-method) | [string](/lsr/value-types.md#string), one of `["SHA1", "SHA256", "SHA384", "SHA512", "MD5", "MURMUR3", "MURMUR3_128", IPV4_NETWORK", "UUID", "PUNCTUATION"]` | Yes |
| [`source`](plugins-filters-fingerprint.md#plugins-filters-fingerprint-source) | [array](/lsr/value-types.md#array) | No |
| [`target`](plugins-filters-fingerprint.md#plugins-filters-fingerprint-target) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-fingerprint.md#plugins-filters-fingerprint-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-fingerprint.md#plugins-filters-fingerprint-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-fingerprint.md#plugins-filters-fingerprint-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-fingerprint.md#plugins-filters-fingerprint-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-fingerprint.md#plugins-filters-fingerprint-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-fingerprint.md#plugins-filters-fingerprint-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-fingerprint.md#plugins-filters-fingerprint-remove_tag) | [array](/lsr/value-types.md#array) | No |
