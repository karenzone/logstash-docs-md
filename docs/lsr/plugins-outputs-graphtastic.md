...
* Plugin version: v3.0.4 ([Other versions](/vpr/output-graphtastic-index.md))
...
| :- | :- | :- |
| [`batch_number`](plugins-outputs-graphtastic.md#plugins-outputs-graphtastic-batch_number) | [number](/lsr/value-types.md#number) | No |
| [`context`](plugins-outputs-graphtastic.md#plugins-outputs-graphtastic-context) | [string](/lsr/value-types.md#string) | No |
| [`error_file`](plugins-outputs-graphtastic.md#plugins-outputs-graphtastic-error_file) | [string](/lsr/value-types.md#string) | No |
| [`host`](plugins-outputs-graphtastic.md#plugins-outputs-graphtastic-host) | [string](/lsr/value-types.md#string) | No |
| [`integration`](plugins-outputs-graphtastic.md#plugins-outputs-graphtastic-integration) | [string](/lsr/value-types.md#string), one of `["udp", "tcp", "rmi", "rest"]` | No |
| [`metrics`](plugins-outputs-graphtastic.md#plugins-outputs-graphtastic-metrics) | [hash](/lsr/value-types.md#hash) | No |
| [`port`](plugins-outputs-graphtastic.md#plugins-outputs-graphtastic-port) | [number](/lsr/value-types.md#number) | No |
| [`retries`](plugins-outputs-graphtastic.md#plugins-outputs-graphtastic-retries) | [number](/lsr/value-types.md#number) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-graphtastic.md#plugins-outputs-graphtastic-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-graphtastic.md#plugins-outputs-graphtastic-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-outputs-graphtastic.md#plugins-outputs-graphtastic-id) | [string](/lsr/value-types.md#string) | No |
