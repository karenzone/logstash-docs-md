...
* Plugin version: v7.3.1 ([Other versions](/vpr/filter-geoip-index.md))
...
| :- | :- | :- |
| [`cache_size`](plugins-filters-geoip.md#plugins-filters-geoip-cache_size) | [number](/lsr/value-types.md#number) | No |
...
| [`ecs_compatibility`](plugins-filters-geoip.md#plugins-filters-geoip-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`fields`](plugins-filters-geoip.md#plugins-filters-geoip-fields) | [array](/lsr/value-types.md#array) | No |
| [`source`](plugins-filters-geoip.md#plugins-filters-geoip-source) | [string](/lsr/value-types.md#string) | Yes |
| [`tag_on_failure`](plugins-filters-geoip.md#plugins-filters-geoip-tag_on_failure) | [array](/lsr/value-types.md#array) | No |
| [`target`](plugins-filters-geoip.md#plugins-filters-geoip-target) | [string](/lsr/value-types.md#string) | No |
...
Controls this plugin’s compatibility with the [Elastic Common Schema (ECS)](https://www.elastic.co/guide/en/ecs/current). The value of this setting affects the *default* value of [`target`](plugins-filters-geoip.md#plugins-filters-geoip-target).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-geoip.md#plugins-filters-geoip-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-geoip.md#plugins-filters-geoip-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-geoip.md#plugins-filters-geoip-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-geoip.md#plugins-filters-geoip-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-geoip.md#plugins-filters-geoip-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-geoip.md#plugins-filters-geoip-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-geoip.md#plugins-filters-geoip-remove_tag) | [array](/lsr/value-types.md#array) | No |
