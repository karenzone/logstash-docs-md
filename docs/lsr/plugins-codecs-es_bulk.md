...
* Plugin version: v3.1.0 ([Other versions](/vpr/codec-es_bulk-index.md))
...
| :- | :- | :- |
| [`ecs_compatibility`](plugins-codecs-es_bulk.md#plugins-codecs-es_bulk-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`target`](plugins-codecs-es_bulk.md#plugins-codecs-es_bulk-target) | [string](/lsr/value-types.md#string) | No |
