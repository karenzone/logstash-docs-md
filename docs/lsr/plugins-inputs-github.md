...
* Plugin version: v3.0.11 ([Other versions](/vpr/input-github-index.md))
...
| :- | :- | :- |
| [`drop_invalid`](plugins-inputs-github.md#plugins-inputs-github-drop_invalid) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ip`](plugins-inputs-github.md#plugins-inputs-github-ip) | [string](/lsr/value-types.md#string) | No |
| [`port`](plugins-inputs-github.md#plugins-inputs-github-port) | [number](/lsr/value-types.md#number) | Yes |
| [`secret_token`](plugins-inputs-github.md#plugins-inputs-github-secret_token) | [password](/lsr/value-types.md#password) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-github.md#plugins-inputs-github-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](plugins-inputs-github.md#plugins-inputs-github-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-github.md#plugins-inputs-github-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-inputs-github.md#plugins-inputs-github-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](plugins-inputs-github.md#plugins-inputs-github-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](plugins-inputs-github.md#plugins-inputs-github-type) | [string](/lsr/value-types.md#string) | No |
