...
* Plugin version: v3.1.7 ([Other versions](/vpr/output-gelf-index.md))
...
| :- | :- | :- |
| [`chunksize`](plugins-outputs-gelf.md#plugins-outputs-gelf-chunksize) | [number](/lsr/value-types.md#number) | No |
| [`custom_fields`](plugins-outputs-gelf.md#plugins-outputs-gelf-custom_fields) | [hash](/lsr/value-types.md#hash) | No |
| [`full_message`](plugins-outputs-gelf.md#plugins-outputs-gelf-full_message) | [string](/lsr/value-types.md#string) | No |
| [`host`](plugins-outputs-gelf.md#plugins-outputs-gelf-host) | [string](/lsr/value-types.md#string) | Yes |
| [`ignore_metadata`](plugins-outputs-gelf.md#plugins-outputs-gelf-ignore_metadata) | [array](/lsr/value-types.md#array) | No |
| [`level`](plugins-outputs-gelf.md#plugins-outputs-gelf-level) | [array](/lsr/value-types.md#array) | No |
| [`port`](plugins-outputs-gelf.md#plugins-outputs-gelf-port) | [number](/lsr/value-types.md#number) | No |
| [`protocol`](plugins-outputs-gelf.md#plugins-outputs-gelf-protocol) | [string](/lsr/value-types.md#string) | No |
| [`sender`](plugins-outputs-gelf.md#plugins-outputs-gelf-sender) | [string](/lsr/value-types.md#string) | No |
| [`ship_metadata`](plugins-outputs-gelf.md#plugins-outputs-gelf-ship_metadata) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ship_tags`](plugins-outputs-gelf.md#plugins-outputs-gelf-ship_tags) | [boolean](/lsr/value-types.md#boolean) | No |
| [`short_message`](plugins-outputs-gelf.md#plugins-outputs-gelf-short_message) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-gelf.md#plugins-outputs-gelf-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-gelf.md#plugins-outputs-gelf-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-outputs-gelf.md#plugins-outputs-gelf-id) | [string](/lsr/value-types.md#string) | No |
