...
* Plugin version: v3.0.3 ([Other versions](/vpr/filter-range-index.md))
...
| :- | :- | :- |
| [`negate`](plugins-filters-range.md#plugins-filters-range-negate) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ranges`](plugins-filters-range.md#plugins-filters-range-ranges) | [array](/lsr/value-types.md#array) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-range.md#plugins-filters-range-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-range.md#plugins-filters-range-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-range.md#plugins-filters-range-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-range.md#plugins-filters-range-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-range.md#plugins-filters-range-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-range.md#plugins-filters-range-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-range.md#plugins-filters-range-remove_tag) | [array](/lsr/value-types.md#array) | No |
