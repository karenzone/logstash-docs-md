...
* Plugin version: v3.0.4 ([Other versions](/vpr/output-metriccatcher-index.md))
...
| :- | :- | :- |
| [`biased`](plugins-outputs-metriccatcher.md#plugins-outputs-metriccatcher-biased) | [hash](/lsr/value-types.md#hash) | No |
| [`counter`](plugins-outputs-metriccatcher.md#plugins-outputs-metriccatcher-counter) | [hash](/lsr/value-types.md#hash) | No |
| [`gauge`](plugins-outputs-metriccatcher.md#plugins-outputs-metriccatcher-gauge) | [hash](/lsr/value-types.md#hash) | No |
| [`host`](plugins-outputs-metriccatcher.md#plugins-outputs-metriccatcher-host) | [string](/lsr/value-types.md#string) | No |
| [`meter`](plugins-outputs-metriccatcher.md#plugins-outputs-metriccatcher-meter) | [hash](/lsr/value-types.md#hash) | No |
| [`port`](plugins-outputs-metriccatcher.md#plugins-outputs-metriccatcher-port) | [number](/lsr/value-types.md#number) | No |
| [`timer`](plugins-outputs-metriccatcher.md#plugins-outputs-metriccatcher-timer) | [hash](/lsr/value-types.md#hash) | No |
| [`uniform`](plugins-outputs-metriccatcher.md#plugins-outputs-metriccatcher-uniform) | [hash](/lsr/value-types.md#hash) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-metriccatcher.md#plugins-outputs-metriccatcher-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-metriccatcher.md#plugins-outputs-metriccatcher-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-outputs-metriccatcher.md#plugins-outputs-metriccatcher-id) | [string](/lsr/value-types.md#string) | No |
