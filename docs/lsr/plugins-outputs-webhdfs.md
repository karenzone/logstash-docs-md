...
* Plugin version: v3.1.0 ([Other versions](/vpr/output-webhdfs-index.md))
...
| :- | :- | :- |
| [`compression`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-compression) | [string](/lsr/value-types.md#string), one of `["none", "snappy", "gzip"]` | No |
| [`flush_size`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-flush_size) | [number](/lsr/value-types.md#number) | No |
| [`host`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-host) | [string](/lsr/value-types.md#string) | Yes |
| [`idle_flush_time`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-idle_flush_time) | [number](/lsr/value-types.md#number) | No |
| [`kerberos_keytab`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-kerberos_keytab) | [string](/lsr/value-types.md#string) | No |
| [`open_timeout`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-open_timeout) | [number](/lsr/value-types.md#number) | No |
| [`path`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-path) | [string](/lsr/value-types.md#string) | Yes |
| [`port`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-port) | [number](/lsr/value-types.md#number) | No |
| [`read_timeout`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-read_timeout) | [number](/lsr/value-types.md#number) | No |
| [`retry_interval`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-retry_interval) | [number](/lsr/value-types.md#number) | No |
| [`retry_known_errors`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-retry_known_errors) | [boolean](/lsr/value-types.md#boolean) | No |
| [`retry_times`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-retry_times) | [number](/lsr/value-types.md#number) | No |
| [`single_file_per_thread`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-single_file_per_thread) | [boolean](/lsr/value-types.md#boolean) | No |
| [`snappy_bufsize`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-snappy_bufsize) | [number](/lsr/value-types.md#number) | No |
| [`snappy_format`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-snappy_format) | [string](/lsr/value-types.md#string), one of `["stream", "file"]` | No |
| [`ssl_cert`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-ssl_cert) | [string](/lsr/value-types.md#string) | No |
| [`ssl_key`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-ssl_key) | [string](/lsr/value-types.md#string) | No |
| [`standby_host`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-standby_host) | [string](/lsr/value-types.md#string) | No |
| [`standby_port`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-standby_port) | [number](/lsr/value-types.md#number) | No |
| [`use_httpfs`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-use_httpfs) | [boolean](/lsr/value-types.md#boolean) | No |
| [`use_kerberos_auth`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-use_kerberos_auth) | [boolean](/lsr/value-types.md#boolean) | No |
| [`use_ssl_auth`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-use_ssl_auth) | [boolean](/lsr/value-types.md#boolean) | No |
| [`user`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-user) | [string](/lsr/value-types.md#string) | Yes |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-outputs-webhdfs.md#plugins-outputs-webhdfs-id) | [string](/lsr/value-types.md#string) | No |
