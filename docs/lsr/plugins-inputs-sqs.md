...
| :- | :- | :- |
| [`access_key_id`](plugins-inputs-sqs.md#plugins-inputs-sqs-access_key_id) | [string](/lsr/value-types.md#string) | No |
| [`additional_settings`](plugins-inputs-sqs.md#plugins-inputs-sqs-additional_settings) | [hash](/lsr/value-types.md#hash) | No |
| [`aws_credentials_file`](plugins-inputs-sqs.md#plugins-inputs-sqs-aws_credentials_file) | [string](/lsr/value-types.md#string) | No |
| [`endpoint`](plugins-inputs-sqs.md#plugins-inputs-sqs-endpoint) | [string](/lsr/value-types.md#string) | No |
| [`id_field`](plugins-inputs-sqs.md#plugins-inputs-sqs-id_field) | [string](/lsr/value-types.md#string) | No |
| [`md5_field`](plugins-inputs-sqs.md#plugins-inputs-sqs-md5_field) | [string](/lsr/value-types.md#string) | No |
| [`polling_frequency`](plugins-inputs-sqs.md#plugins-inputs-sqs-polling_frequency) | [number](/lsr/value-types.md#number) | No |
| [`proxy_uri`](plugins-inputs-sqs.md#plugins-inputs-sqs-proxy_uri) | [string](/lsr/value-types.md#string) | No |
| [`queue`](plugins-inputs-sqs.md#plugins-inputs-sqs-queue) | [string](/lsr/value-types.md#string) | Yes |
| [`queue_owner_aws_account_id`](plugins-inputs-sqs.md#plugins-inputs-sqs-queue_owner_aws_account_id) | [string](/lsr/value-types.md#string) | No |
| [`region`](plugins-inputs-sqs.md#plugins-inputs-sqs-region) | [string](/lsr/value-types.md#string) | No |
| [`role_arn`](plugins-inputs-sqs.md#plugins-inputs-sqs-role_arn) | [string](/lsr/value-types.md#string) | No |
| [`role_session_name`](plugins-inputs-sqs.md#plugins-inputs-sqs-role_session_name) | [string](/lsr/value-types.md#string) | No |
| [`secret_access_key`](plugins-inputs-sqs.md#plugins-inputs-sqs-secret_access_key) | [string](/lsr/value-types.md#string) | No |
| [`sent_timestamp_field`](plugins-inputs-sqs.md#plugins-inputs-sqs-sent_timestamp_field) | [string](/lsr/value-types.md#string) | No |
| [`session_token`](plugins-inputs-sqs.md#plugins-inputs-sqs-session_token) | [string](/lsr/value-types.md#string) | No |
| [`threads`](plugins-inputs-sqs.md#plugins-inputs-sqs-threads) | [number](/lsr/value-types.md#number) | No |
| [`use_aws_bundled_ca`](plugins-inputs-sqs.md#plugins-inputs-sqs-use_aws_bundled_ca) | [boolean](/lsr/value-types.md#boolean) | No |
| [`web_identity_token_file`](plugins-inputs-sqs.md#plugins-inputs-sqs-web_identity_token_file) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-sqs.md#plugins-inputs-sqs-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](plugins-inputs-sqs.md#plugins-inputs-sqs-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-sqs.md#plugins-inputs-sqs-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-inputs-sqs.md#plugins-inputs-sqs-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](plugins-inputs-sqs.md#plugins-inputs-sqs-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](plugins-inputs-sqs.md#plugins-inputs-sqs-type) | [string](/lsr/value-types.md#string) | No |
