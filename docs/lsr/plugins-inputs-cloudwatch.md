...
This plugin supports the following configuration options plus the [Common options](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`access_key_id`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-access_key_id) | [string](/lsr/value-types.md#string) | No |
| [`aws_credentials_file`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-aws_credentials_file) | [string](/lsr/value-types.md#string) | No |
| [`combined`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-combined) | [boolean](/lsr/value-types.md#boolean) | No |
| [`endpoint`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-endpoint) | [string](/lsr/value-types.md#string) | No |
| [`filters`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-filters) | [array](/lsr/value-types.md#array) | See [note](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-filters) |
| [`interval`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-interval) | [number](/lsr/value-types.md#number) | No |
| [`metrics`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-metrics) | [array](/lsr/value-types.md#array) | No |
| [`namespace`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-namespace) | [string](/lsr/value-types.md#string) | No |
| [`period`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-period) | [number](/lsr/value-types.md#number) | No |
| [`proxy_uri`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-proxy_uri) | [string](/lsr/value-types.md#string) | No |
| [`region`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-region) | [string](/lsr/value-types.md#string) | No |
| [`role_arn`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-role_arn) | [string](/lsr/value-types.md#string) | No |
| [`role_session_name`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-role_session_name) | [string](/lsr/value-types.md#string) | No |
| [`secret_access_key`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-secret_access_key) | [string](/lsr/value-types.md#string) | No |
| [`session_token`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-session_token) | [string](/lsr/value-types.md#string) | No |
| [`statistics`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-statistics) | [array](/lsr/value-types.md#array) | No |
| [`use_aws_bundled_ca`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-use_aws_bundled_ca) | [boolean](/lsr/value-types.md#boolean) | No |
| [`use_ssl`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-use_ssl) | [boolean](/lsr/value-types.md#boolean) | No |
| [`web_identity_token_file`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-web_identity_token_file) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](plugins-inputs-cloudwatch.md#plugins-inputs-cloudwatch-type) | [string](/lsr/value-types.md#string) | No |
