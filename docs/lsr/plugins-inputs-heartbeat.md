...
* Plugin version: v3.1.1 ([Other versions](/vpr/input-heartbeat-index.md))
...
| :- | :- | :- |
| [`count`](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-count) | [number](/lsr/value-types.md#number) | No |
| [`ecs_compatibility`](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`interval`](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-interval) | [number](/lsr/value-types.md#number) | No |
| [`message`](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-message) | [string](/lsr/value-types.md#string) | No |
| [`sequence`](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-sequence) | [string](/lsr/value-types.md#string) one of `["none", "epoch", "sequence"]` | No |
| [`threads`](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-threads) | [number](/lsr/value-types.md#number) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](plugins-inputs-heartbeat.md#plugins-inputs-heartbeat-type) | [string](/lsr/value-types.md#string) | No |
