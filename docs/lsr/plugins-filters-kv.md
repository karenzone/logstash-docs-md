...
* Plugin version: v4.7.0 ([Other versions](/vpr/filter-kv-index.md))
...
| :- | :- | :- |
| [`allow_duplicate_values`](plugins-filters-kv.md#plugins-filters-kv-allow_duplicate_values) | [boolean](/lsr/value-types.md#boolean) | No |
| [`allow_empty_values`](plugins-filters-kv.md#plugins-filters-kv-allow_empty_values) | [boolean](/lsr/value-types.md#boolean) | No |
| [`default_keys`](plugins-filters-kv.md#plugins-filters-kv-default_keys) | [hash](/lsr/value-types.md#hash) | No |
| [`ecs_compatibility`](plugins-filters-kv.md#plugins-filters-kv-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`exclude_keys`](plugins-filters-kv.md#plugins-filters-kv-exclude_keys) | [array](/lsr/value-types.md#array) | No |
| [`field_split`](plugins-filters-kv.md#plugins-filters-kv-field_split) | [string](/lsr/value-types.md#string) | No |
| [`field_split_pattern`](plugins-filters-kv.md#plugins-filters-kv-field_split_pattern) | [string](/lsr/value-types.md#string) | No |
| [`include_brackets`](plugins-filters-kv.md#plugins-filters-kv-include_brackets) | [boolean](/lsr/value-types.md#boolean) | No |
| [`include_keys`](plugins-filters-kv.md#plugins-filters-kv-include_keys) | [array](/lsr/value-types.md#array) | No |
| [`prefix`](plugins-filters-kv.md#plugins-filters-kv-prefix) | [string](/lsr/value-types.md#string) | No |
| [`recursive`](plugins-filters-kv.md#plugins-filters-kv-recursive) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_char_key`](plugins-filters-kv.md#plugins-filters-kv-remove_char_key) | [string](/lsr/value-types.md#string) | No |
| [`remove_char_value`](plugins-filters-kv.md#plugins-filters-kv-remove_char_value) | [string](/lsr/value-types.md#string) | No |
| [`source`](plugins-filters-kv.md#plugins-filters-kv-source) | [string](/lsr/value-types.md#string) | No |
| [`target`](plugins-filters-kv.md#plugins-filters-kv-target) | [string](/lsr/value-types.md#string) | No |
| [`tag_on_failure`](plugins-filters-kv.md#plugins-filters-kv-tag_on_failure) | [array](/lsr/value-types.md#array) | No |
| [`tag_on_timeout`](plugins-filters-kv.md#plugins-filters-kv-tag_on_timeout) | [string](/lsr/value-types.md#string) | No |
| [`timeout_millis`](plugins-filters-kv.md#plugins-filters-kv-timeout_millis) | [number](/lsr/value-types.md#number) | No |
| [`transform_key`](plugins-filters-kv.md#plugins-filters-kv-transform_key) | [string](/lsr/value-types.md#string), one of `["lowercase", "uppercase", "capitalize"]` | No |
| [`transform_value`](plugins-filters-kv.md#plugins-filters-kv-transform_value) | [string](/lsr/value-types.md#string), one of `["lowercase", "uppercase", "capitalize"]` | No |
| [`trim_key`](plugins-filters-kv.md#plugins-filters-kv-trim_key) | [string](/lsr/value-types.md#string) | No |
| [`trim_value`](plugins-filters-kv.md#plugins-filters-kv-trim_value) | [string](/lsr/value-types.md#string) | No |
| [`value_split`](plugins-filters-kv.md#plugins-filters-kv-value_split) | [string](/lsr/value-types.md#string) | No |
| [`value_split_pattern`](plugins-filters-kv.md#plugins-filters-kv-value_split_pattern) | [string](/lsr/value-types.md#string) | No |
| [`whitespace`](plugins-filters-kv.md#plugins-filters-kv-whitespace) | [string](/lsr/value-types.md#string), one of `["strict", "lenient"]` | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-kv.md#plugins-filters-kv-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-kv.md#plugins-filters-kv-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-kv.md#plugins-filters-kv-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-kv.md#plugins-filters-kv-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-kv.md#plugins-filters-kv-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-kv.md#plugins-filters-kv-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-kv.md#plugins-filters-kv-remove_tag) | [array](/lsr/value-types.md#array) | No |
