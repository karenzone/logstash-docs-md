...
* Plugin version: v3.1.4 ([Other versions](/vpr/output-stdout-index.md))
...
| :- | :- | :- |
| [`codec`](plugins-outputs-stdout.md#plugins-outputs-stdout-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-stdout.md#plugins-outputs-stdout-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-outputs-stdout.md#plugins-outputs-stdout-id) | [string](/lsr/value-types.md#string) | No |
