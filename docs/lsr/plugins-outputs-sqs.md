...
| :- | :- | :- |
| [`access_key_id`](plugins-outputs-sqs.md#plugins-outputs-sqs-access_key_id) | [string](/lsr/value-types.md#string) | No |
| [`aws_credentials_file`](plugins-outputs-sqs.md#plugins-outputs-sqs-aws_credentials_file) | [string](/lsr/value-types.md#string) | No |
| [`batch_events`](plugins-outputs-sqs.md#plugins-outputs-sqs-batch_events) | [number](/lsr/value-types.md#number) | No |
| [`endpoint`](plugins-outputs-sqs.md#plugins-outputs-sqs-endpoint) | [string](/lsr/value-types.md#string) | No |
| [`message_max_size`](plugins-outputs-sqs.md#plugins-outputs-sqs-message_max_size) | [bytes](/lsr/value-types.md#bytes) | No |
| [`proxy_uri`](plugins-outputs-sqs.md#plugins-outputs-sqs-proxy_uri) | [string](/lsr/value-types.md#string) | No |
| [`queue`](plugins-outputs-sqs.md#plugins-outputs-sqs-queue) | [string](/lsr/value-types.md#string) | Yes |
| [`queue_owner_aws_account_id`](plugins-outputs-sqs.md#plugins-outputs-sqs-queue_owner_aws_account_id) | [string](/lsr/value-types.md#string) | No |
| [`region`](plugins-outputs-sqs.md#plugins-outputs-sqs-region) | [string](/lsr/value-types.md#string) | No |
| [`role_arn`](plugins-outputs-sqs.md#plugins-outputs-sqs-role_arn) | [string](/lsr/value-types.md#string) | No |
| [`role_session_name`](plugins-outputs-sqs.md#plugins-outputs-sqs-role_session_name) | [string](/lsr/value-types.md#string) | No |
| [`secret_access_key`](plugins-outputs-sqs.md#plugins-outputs-sqs-secret_access_key) | [string](/lsr/value-types.md#string) | No |
| [`session_token`](plugins-outputs-sqs.md#plugins-outputs-sqs-session_token) | [string](/lsr/value-types.md#string) | No |
| [`use_aws_bundled_ca`](plugins-outputs-sqs.md#plugins-outputs-sqs-use_aws_bundled_ca) | [boolean](/lsr/value-types.md#boolean) | No |
| [`web_identity_token_file`](plugins-outputs-sqs.md#plugins-outputs-sqs-web_identity_token_file) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-sqs.md#plugins-outputs-sqs-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-sqs.md#plugins-outputs-sqs-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-outputs-sqs.md#plugins-outputs-sqs-id) | [string](/lsr/value-types.md#string) | No |
