...
| :- | :- | :- |
| [`arguments`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-arguments) | [array](/lsr/value-types.md#array) | No |
| [`automatic_recovery`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-automatic_recovery) | [boolean](/lsr/value-types.md#boolean) | No |
| [`connect_retry_interval`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-connect_retry_interval) | [number](/lsr/value-types.md#number) | No |
| [`connection_timeout`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-connection_timeout) | [number](/lsr/value-types.md#number) | No |
| [`durable`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-durable) | [boolean](/lsr/value-types.md#boolean) | No |
| [`exchange`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-exchange) | [string](/lsr/value-types.md#string) | Yes |
| [`exchange_type`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-exchange_type) | [string](/lsr/value-types.md#string), one of `["fanout", "direct", "topic", "x-consistent-hash", "x-modulus-hash"]` | Yes |
| [`heartbeat`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-heartbeat) | [number](/lsr/value-types.md#number) | No |
| [`host`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-host) | [string](/lsr/value-types.md#string) | Yes |
| [`key`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-key) | [string](/lsr/value-types.md#string) | No |
| [`message_properties`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-message_properties) | [hash](/lsr/value-types.md#hash) | No |
| [`passive`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-passive) | [boolean](/lsr/value-types.md#boolean) | No |
| [`password`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-password) | [password](/lsr/value-types.md#password) | No |
| [`persistent`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-persistent) | [boolean](/lsr/value-types.md#boolean) | No |
| [`port`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-port) | [number](/lsr/value-types.md#number) | No |
| [`ssl`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-ssl) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ssl_certificate_password`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-ssl_certificate_password) | [string](/lsr/value-types.md#string) | No |
...
| [`ssl_version`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-ssl_version) | [string](/lsr/value-types.md#string) | No |
| [`user`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-user) | [string](/lsr/value-types.md#string) | No |
| [`vhost`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-vhost) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-outputs-rabbitmq.md#plugins-outputs-rabbitmq-id) | [string](/lsr/value-types.md#string) | No |
