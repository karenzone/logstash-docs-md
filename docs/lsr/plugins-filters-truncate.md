...
* Plugin version: v1.0.6 ([Other versions](/vpr/filter-truncate-index.md))
...
| :- | :- | :- |
| [`fields`](plugins-filters-truncate.md#plugins-filters-truncate-fields) | [string](/lsr/value-types.md#string) | No |
| [`length_bytes`](plugins-filters-truncate.md#plugins-filters-truncate-length_bytes) | [number](/lsr/value-types.md#number) | Yes |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-truncate.md#plugins-filters-truncate-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-truncate.md#plugins-filters-truncate-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-truncate.md#plugins-filters-truncate-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-truncate.md#plugins-filters-truncate-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-truncate.md#plugins-filters-truncate-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-truncate.md#plugins-filters-truncate-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-truncate.md#plugins-filters-truncate-remove_tag) | [array](/lsr/value-types.md#array) | No |
