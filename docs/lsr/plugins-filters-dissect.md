...
* Plugin version: v1.2.5 ([Other versions](/vpr/filter-dissect-index.md))
...
| :- | :- | :- |
| [`convert_datatype`](plugins-filters-dissect.md#plugins-filters-dissect-convert_datatype) | [hash](/lsr/value-types.md#hash) | No |
| [`mapping`](plugins-filters-dissect.md#plugins-filters-dissect-mapping) | [hash](/lsr/value-types.md#hash) | No |
| [`tag_on_failure`](plugins-filters-dissect.md#plugins-filters-dissect-tag_on_failure) | [array](/lsr/value-types.md#array) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-dissect.md#plugins-filters-dissect-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-dissect.md#plugins-filters-dissect-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-dissect.md#plugins-filters-dissect-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-dissect.md#plugins-filters-dissect-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-dissect.md#plugins-filters-dissect-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-dissect.md#plugins-filters-dissect-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-dissect.md#plugins-filters-dissect-remove_tag) | [array](/lsr/value-types.md#array) | No |
