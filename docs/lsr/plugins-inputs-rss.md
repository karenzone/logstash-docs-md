...
| :- | :- | :- |
| [`interval`](plugins-inputs-rss.md#plugins-inputs-rss-interval) | [number](/lsr/value-types.md#number) | Yes |
| [`url`](plugins-inputs-rss.md#plugins-inputs-rss-url) | [string](/lsr/value-types.md#string) | Yes |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-rss.md#plugins-inputs-rss-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](plugins-inputs-rss.md#plugins-inputs-rss-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-rss.md#plugins-inputs-rss-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-inputs-rss.md#plugins-inputs-rss-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](plugins-inputs-rss.md#plugins-inputs-rss-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](plugins-inputs-rss.md#plugins-inputs-rss-type) | [string](/lsr/value-types.md#string) | No |
