...
* Plugin version: v4.5.0 ([Other versions](/vpr/output-google_cloud_storage-index.md))
...
| :- | :- | :- |
| [`bucket`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-bucket) | [string](/lsr/value-types.md#string) | Yes |
| [`date_pattern`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-date_pattern) | [string](/lsr/value-types.md#string) | No |
| [`flush_interval_secs`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-flush_interval_secs) | [number](/lsr/value-types.md#number) | No |
| [`gzip`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-gzip) | [boolean](/lsr/value-types.md#boolean) | No |
| [`gzip_content_encoding`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-gzip_content_encoding) | [boolean](/lsr/value-types.md#boolean) | No |
| [`include_hostname`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-include_hostname) | [boolean](/lsr/value-types.md#boolean) | No |
| [`include_uuid`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-include_uuid) | [boolean](/lsr/value-types.md#boolean) | No |
| [`json_key_file`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-json_key_file) | [string](/lsr/value-types.md#string) | No |
| [`key_password`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-key_password) | [string](/lsr/value-types.md#string) | *Deprecated* |
| [`log_file_prefix`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-log_file_prefix) | [string](/lsr/value-types.md#string) | No |
| [`max_concurrent_uploads`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-max_concurrent_uploads) | [number](/lsr/value-types.md#number) | No |
| [`max_file_size_kbytes`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-max_file_size_kbytes) | [number](/lsr/value-types.md#number) | No |
| [`output_format`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-output_format) | [string](/lsr/value-types.md#string), one of `["json", "plain", nil]` | *Deprecated* |
| [`service_account`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-service_account) | [string](/lsr/value-types.md#string) | *Deprecated* |
| [`temp_directory`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-temp_directory) | [string](/lsr/value-types.md#string) | No |
| [`uploader_interval_secs`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-uploader_interval_secs) | [number](/lsr/value-types.md#number) | No |
...
Time pattern for log file, defaults to hourly files. Must Time.strftime patterns: [www.ruby-doc.org/core-2.0/Time.html#method-i-strftime](http://www.ruby-doc.org/core-2.0/Time.html#method-i-strftime)
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-outputs-google_cloud_storage.md#plugins-outputs-google_cloud_storage-id) | [string](/lsr/value-types.md#string) | No |
