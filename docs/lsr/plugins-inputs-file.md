...
* Plugin version: v4.4.6 ([Other versions](/vpr/input-file-index.md))
...
| :- | :- | :- |
| [`check_archive_validity`](plugins-inputs-file.md#plugins-inputs-file-check_archive_validity) | [boolean](/lsr/value-types.md#boolean) | No |
| [`close_older`](plugins-inputs-file.md#plugins-inputs-file-close_older) | [number](/lsr/value-types.md#number) or [string_duration](plugins-inputs-file.md#plugins-inputs-file-string_duration) | No |
| [`delimiter`](plugins-inputs-file.md#plugins-inputs-file-delimiter) | [string](/lsr/value-types.md#string) | No |
| [`discover_interval`](plugins-inputs-file.md#plugins-inputs-file-discover_interval) | [number](/lsr/value-types.md#number) | No |
| [`ecs_compatibility`](plugins-inputs-file.md#plugins-inputs-file-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`exclude`](plugins-inputs-file.md#plugins-inputs-file-exclude) | [array](/lsr/value-types.md#array) | No |
| [`exit_after_read`](plugins-inputs-file.md#plugins-inputs-file-exit_after_read) | [boolean](/lsr/value-types.md#boolean) | No |
| [`file_chunk_count`](plugins-inputs-file.md#plugins-inputs-file-file_chunk_count) | [number](/lsr/value-types.md#number) | No |
| [`file_chunk_size`](plugins-inputs-file.md#plugins-inputs-file-file_chunk_size) | [number](/lsr/value-types.md#number) | No |
| [`file_completed_action`](plugins-inputs-file.md#plugins-inputs-file-file_completed_action) | [string](/lsr/value-types.md#string), one of `["delete", "log", "log_and_delete"]` | No |
| [`file_completed_log_path`](plugins-inputs-file.md#plugins-inputs-file-file_completed_log_path) | [string](/lsr/value-types.md#string) | No |
| [`file_sort_by`](plugins-inputs-file.md#plugins-inputs-file-file_sort_by) | [string](/lsr/value-types.md#string), one of `["last_modified", "path"]` | No |
| [`file_sort_direction`](plugins-inputs-file.md#plugins-inputs-file-file_sort_direction) | [string](/lsr/value-types.md#string), one of `["asc", "desc"]` | No |
| [`ignore_older`](plugins-inputs-file.md#plugins-inputs-file-ignore_older) | [number](/lsr/value-types.md#number) or [string_duration](plugins-inputs-file.md#plugins-inputs-file-string_duration) | No |
| [`max_open_files`](plugins-inputs-file.md#plugins-inputs-file-max_open_files) | [number](/lsr/value-types.md#number) | No |
| [`mode`](plugins-inputs-file.md#plugins-inputs-file-mode) | [string](/lsr/value-types.md#string), one of `["tail", "read"]` | No |
| [`path`](plugins-inputs-file.md#plugins-inputs-file-path) | [array](/lsr/value-types.md#array) | Yes |
| [`sincedb_clean_after`](plugins-inputs-file.md#plugins-inputs-file-sincedb_clean_after) | [number](/lsr/value-types.md#number) or [string_duration](plugins-inputs-file.md#plugins-inputs-file-string_duration) | No |
| [`sincedb_path`](plugins-inputs-file.md#plugins-inputs-file-sincedb_path) | [string](/lsr/value-types.md#string) | No |
| [`sincedb_write_interval`](plugins-inputs-file.md#plugins-inputs-file-sincedb_write_interval) | [number](/lsr/value-types.md#number) or [string_duration](plugins-inputs-file.md#plugins-inputs-file-string_duration) | No |
| [`start_position`](plugins-inputs-file.md#plugins-inputs-file-start_position) | [string](/lsr/value-types.md#string), one of `["beginning", "end"]` | No |
| [`stat_interval`](plugins-inputs-file.md#plugins-inputs-file-stat_interval) | [number](/lsr/value-types.md#number) or [string_duration](plugins-inputs-file.md#plugins-inputs-file-string_duration) | No |
...
* Value type is [number](/lsr/value-types.md#number) or [string_duration](plugins-inputs-file.md#plugins-inputs-file-string_duration)
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-file.md#plugins-inputs-file-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](plugins-inputs-file.md#plugins-inputs-file-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-file.md#plugins-inputs-file-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-inputs-file.md#plugins-inputs-file-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](plugins-inputs-file.md#plugins-inputs-file-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](plugins-inputs-file.md#plugins-inputs-file-type) | [string](/lsr/value-types.md#string) | No |
