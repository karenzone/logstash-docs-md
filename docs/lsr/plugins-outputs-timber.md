...
* Plugin version: v1.0.3 ([Other versions](/vpr/output-timber-index.md))
...
This plugin supports the following configuration options plus the [Common options](plugins-outputs-timber.md#plugins-outputs-timber-common-options) described later.
...
| [`connect_timeout`](plugins-outputs-timber.md#plugins-outputs-timber-connect_timeout) | [number](/lsr/value-types.md#number) | No |
| [`keystore`](plugins-outputs-timber.md#plugins-outputs-timber-keystore) | a valid filesystem path | No |
| [`keystore_password`](plugins-outputs-timber.md#plugins-outputs-timber-keystore_password) | [password](/lsr/value-types.md#password) | No |
| [`keystore_type`](plugins-outputs-timber.md#plugins-outputs-timber-keystore_type) | [string](/lsr/value-types.md#string) | No |
| [`pool_max`](plugins-outputs-timber.md#plugins-outputs-timber-pool_max) | [number](/lsr/value-types.md#number) | No |
| [`proxy`](plugins-outputs-timber.md#plugins-outputs-timber-proxy) | <<,>> | No |
| [`request_timeout`](plugins-outputs-timber.md#plugins-outputs-timber-request_timeout) | [number](/lsr/value-types.md#number) | No |
| [`socket_timeout`](plugins-outputs-timber.md#plugins-outputs-timber-socket_timeout) | [number](/lsr/value-types.md#number) | No |
| [`truststore`](plugins-outputs-timber.md#plugins-outputs-timber-truststore) | a valid filesystem path | No |
| [`truststore_password`](plugins-outputs-timber.md#plugins-outputs-timber-truststore_password) | [password](/lsr/value-types.md#password) | No |
| [`truststore_type`](plugins-outputs-timber.md#plugins-outputs-timber-truststore_type) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-timber.md#plugins-outputs-timber-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-timber.md#plugins-outputs-timber-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-outputs-timber.md#plugins-outputs-timber-id) | [string](/lsr/value-types.md#string) | No |
