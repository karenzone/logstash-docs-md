...
* Plugin version: v3.0.4 ([Other versions](/vpr/input-relp-index.md))
...
| :- | :- | :- |
| [`host`](plugins-inputs-relp.md#plugins-inputs-relp-host) | [string](/lsr/value-types.md#string) | No |
| [`port`](plugins-inputs-relp.md#plugins-inputs-relp-port) | [number](/lsr/value-types.md#number) | Yes |
...
| [`ssl_enable`](plugins-inputs-relp.md#plugins-inputs-relp-ssl_enable) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ssl_key`](plugins-inputs-relp.md#plugins-inputs-relp-ssl_key) | a valid filesystem path | No |
| [`ssl_key_passphrase`](plugins-inputs-relp.md#plugins-inputs-relp-ssl_key_passphrase) | [password](/lsr/value-types.md#password) | No |
| [`ssl_verify`](plugins-inputs-relp.md#plugins-inputs-relp-ssl_verify) | [boolean](/lsr/value-types.md#boolean) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-relp.md#plugins-inputs-relp-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](plugins-inputs-relp.md#plugins-inputs-relp-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-relp.md#plugins-inputs-relp-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-inputs-relp.md#plugins-inputs-relp-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](plugins-inputs-relp.md#plugins-inputs-relp-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](plugins-inputs-relp.md#plugins-inputs-relp-type) | [string](/lsr/value-types.md#string) | No |
