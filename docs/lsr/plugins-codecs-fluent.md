...
* Plugin version: v3.4.3 ([Other versions](/vpr/codec-fluent-index.md))
...
| :- | :- | :- |
| [`nanosecond_precision`](plugins-codecs-fluent.md#plugins-codecs-fluent-nanosecond_precision) | [boolean](/lsr/value-types.md#boolean) | No |
| [`target`](plugins-codecs-fluent.md#plugins-codecs-fluent-target) | [string](/lsr/value-types.md#string) | No |
