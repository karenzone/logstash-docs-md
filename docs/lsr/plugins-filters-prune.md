...
* Plugin version: v3.0.4 ([Other versions](/vpr/filter-prune-index.md))
...
| :- | :- | :- |
| [`blacklist_names`](plugins-filters-prune.md#plugins-filters-prune-blacklist_names) | [array](/lsr/value-types.md#array) | No |
| [`blacklist_values`](plugins-filters-prune.md#plugins-filters-prune-blacklist_values) | [hash](/lsr/value-types.md#hash) | No |
| [`interpolate`](plugins-filters-prune.md#plugins-filters-prune-interpolate) | [boolean](/lsr/value-types.md#boolean) | No |
| [`whitelist_names`](plugins-filters-prune.md#plugins-filters-prune-whitelist_names) | [array](/lsr/value-types.md#array) | No |
| [`whitelist_values`](plugins-filters-prune.md#plugins-filters-prune-whitelist_values) | [hash](/lsr/value-types.md#hash) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-prune.md#plugins-filters-prune-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-prune.md#plugins-filters-prune-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-prune.md#plugins-filters-prune-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-prune.md#plugins-filters-prune-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-prune.md#plugins-filters-prune-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-prune.md#plugins-filters-prune-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-prune.md#plugins-filters-prune-remove_tag) | [array](/lsr/value-types.md#array) | No |
