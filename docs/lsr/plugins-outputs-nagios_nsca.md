...
* Plugin version: v3.0.7 ([Other versions](/vpr/output-nagios_nsca-index.md))
...
| :- | :- | :- |
| [`host`](plugins-outputs-nagios_nsca.md#plugins-outputs-nagios_nsca-host) | [string](/lsr/value-types.md#string) | No |
| [`message_format`](plugins-outputs-nagios_nsca.md#plugins-outputs-nagios_nsca-message_format) | [string](/lsr/value-types.md#string) | No |
| [`nagios_host`](plugins-outputs-nagios_nsca.md#plugins-outputs-nagios_nsca-nagios_host) | [string](/lsr/value-types.md#string) | No |
| [`nagios_service`](plugins-outputs-nagios_nsca.md#plugins-outputs-nagios_nsca-nagios_service) | [string](/lsr/value-types.md#string) | No |
| [`nagios_status`](plugins-outputs-nagios_nsca.md#plugins-outputs-nagios_nsca-nagios_status) | [string](/lsr/value-types.md#string) | Yes |
| [`port`](plugins-outputs-nagios_nsca.md#plugins-outputs-nagios_nsca-port) | [number](/lsr/value-types.md#number) | No |
| [`send_nsca_bin`](plugins-outputs-nagios_nsca.md#plugins-outputs-nagios_nsca-send_nsca_bin) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-nagios_nsca.md#plugins-outputs-nagios_nsca-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-nagios_nsca.md#plugins-outputs-nagios_nsca-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-outputs-nagios_nsca.md#plugins-outputs-nagios_nsca-id) | [string](/lsr/value-types.md#string) | No |
