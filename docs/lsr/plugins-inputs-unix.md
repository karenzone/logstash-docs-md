...
* Plugin version: v3.1.2 ([Other versions](/vpr/input-unix-index.md))
...
This plugin supports the following configuration options plus the [Common options](plugins-inputs-unix.md#plugins-inputs-unix-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`data_timeout`](plugins-inputs-unix.md#plugins-inputs-unix-data_timeout) | [number](/lsr/value-types.md#number) | No |
| [`ecs_compatibility`](plugins-inputs-unix.md#plugins-inputs-unix-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`force_unlink`](plugins-inputs-unix.md#plugins-inputs-unix-force_unlink) | [boolean](/lsr/value-types.md#boolean) | No |
| [`mode`](plugins-inputs-unix.md#plugins-inputs-unix-mode) | [string](/lsr/value-types.md#string), one of `["server", "client"]` | No |
| [`path`](plugins-inputs-unix.md#plugins-inputs-unix-path) | [string](/lsr/value-types.md#string) | Yes |
| [`socket_not_present_retry_interval_seconds`](plugins-inputs-unix.md#plugins-inputs-unix-socket_not_present_retry_interval_seconds) | [number](/lsr/value-types.md#number) | Yes |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-unix.md#plugins-inputs-unix-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](plugins-inputs-unix.md#plugins-inputs-unix-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-unix.md#plugins-inputs-unix-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-inputs-unix.md#plugins-inputs-unix-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](plugins-inputs-unix.md#plugins-inputs-unix-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](plugins-inputs-unix.md#plugins-inputs-unix-type) | [string](/lsr/value-types.md#string) | No |
