...
* Plugin version: v4.0.7 ([Other versions](/vpr/filter-metrics-index.md))
...
| :- | :- | :- |
| [`clear_interval`](plugins-filters-metrics.md#plugins-filters-metrics-clear_interval) | [number](/lsr/value-types.md#number) | No |
| [`flush_interval`](plugins-filters-metrics.md#plugins-filters-metrics-flush_interval) | [number](/lsr/value-types.md#number) | No |
| [`ignore_older_than`](plugins-filters-metrics.md#plugins-filters-metrics-ignore_older_than) | [number](/lsr/value-types.md#number) | No |
| [`meter`](plugins-filters-metrics.md#plugins-filters-metrics-meter) | [array](/lsr/value-types.md#array) | No |
| [`percentiles`](plugins-filters-metrics.md#plugins-filters-metrics-percentiles) | [array](/lsr/value-types.md#array) | No |
| [`rates`](plugins-filters-metrics.md#plugins-filters-metrics-rates) | [array](/lsr/value-types.md#array) | No |
| [`timer`](plugins-filters-metrics.md#plugins-filters-metrics-timer) | [hash](/lsr/value-types.md#hash) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-metrics.md#plugins-filters-metrics-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-metrics.md#plugins-filters-metrics-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-metrics.md#plugins-filters-metrics-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-metrics.md#plugins-filters-metrics-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-metrics.md#plugins-filters-metrics-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-metrics.md#plugins-filters-metrics-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-metrics.md#plugins-filters-metrics-remove_tag) | [array](/lsr/value-types.md#array) | No |
