...
* Plugin version: v5.0.6 ([Other versions](/vpr/output-influxdb-index.md))
...
| :- | :- | :- |
| [`allow_time_override`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-allow_time_override) | [boolean](/lsr/value-types.md#boolean) | No |
| [`coerce_values`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-coerce_values) | [hash](/lsr/value-types.md#hash) | No |
| [`data_points`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-data_points) | [hash](/lsr/value-types.md#hash) | Yes |
| [`db`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-db) | [string](/lsr/value-types.md#string) | No |
| [`exclude_fields`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-exclude_fields) | [array](/lsr/value-types.md#array) | No |
| [`flush_size`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-flush_size) | [number](/lsr/value-types.md#number) | No |
| [`host`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-host) | [string](/lsr/value-types.md#string) | Yes |
| [`idle_flush_time`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-idle_flush_time) | [number](/lsr/value-types.md#number) | No |
| [`initial_delay`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-initial_delay) | [number](/lsr/value-types.md#number) | No |
| [`max_retries`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-max_retries) | [number](/lsr/value-types.md#number) | No |
| [`measurement`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-measurement) | [string](/lsr/value-types.md#string) | No |
| [`password`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-password) | [password](/lsr/value-types.md#password) | No |
| [`port`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-port) | [number](/lsr/value-types.md#number) | No |
| [`retention_policy`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-retention_policy) | [string](/lsr/value-types.md#string) | No |
| [`send_as_tags`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-send_as_tags) | [array](/lsr/value-types.md#array) | No |
| [`ssl`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-ssl) | [boolean](/lsr/value-types.md#boolean) | No |
| [`time_precision`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-time_precision) | [string](/lsr/value-types.md#string), one of `["n", "u", "ms", "s", "m", "h"]` | No |
| [`use_event_fields_for_data_points`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-use_event_fields_for_data_points) | [boolean](/lsr/value-types.md#boolean) | No |
| [`user`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-user) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-outputs-influxdb.md#plugins-outputs-influxdb-id) | [string](/lsr/value-types.md#string) | No |
