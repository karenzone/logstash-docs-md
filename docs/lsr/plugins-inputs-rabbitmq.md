...
* A component of the [rabbitmq integration plugin](/vpr/integration-rabbitmq-index.md)
...
| :- | :- | :- |
| [`ack`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-ack) | [boolean](/lsr/value-types.md#boolean) | No |
| [`arguments`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-arguments) | [array](/lsr/value-types.md#array) | No |
| [`auto_delete`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-auto_delete) | [boolean](/lsr/value-types.md#boolean) | No |
| [`automatic_recovery`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-automatic_recovery) | [boolean](/lsr/value-types.md#boolean) | No |
| [`connect_retry_interval`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-connect_retry_interval) | [number](/lsr/value-types.md#number) | No |
| [`connection_timeout`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-connection_timeout) | [number](/lsr/value-types.md#number) | No |
| [`durable`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-durable) | [boolean](/lsr/value-types.md#boolean) | No |
| [`exchange`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-exchange) | [string](/lsr/value-types.md#string) | No |
| [`exchange_type`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-exchange_type) | [string](/lsr/value-types.md#string) | No |
| [`exclusive`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-exclusive) | [boolean](/lsr/value-types.md#boolean) | No |
| [`heartbeat`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-heartbeat) | [number](/lsr/value-types.md#number) | No |
| [`host`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-host) | [string](/lsr/value-types.md#string) | Yes |
| [`key`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-key) | [string](/lsr/value-types.md#string) | No |
| [`metadata_enabled`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-metadata_enabled) | [boolean](/lsr/value-types.md#boolean) | No |
| [`passive`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-passive) | [boolean](/lsr/value-types.md#boolean) | No |
| [`password`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-password) | [password](/lsr/value-types.md#password) | No |
| [`port`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-port) | [number](/lsr/value-types.md#number) | No |
| [`prefetch_count`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-prefetch_count) | [number](/lsr/value-types.md#number) | No |
| [`queue`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-queue) | [string](/lsr/value-types.md#string) | No |
| [`ssl`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-ssl) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ssl_certificate_password`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-ssl_certificate_password) | [string](/lsr/value-types.md#string) | No |
| [`ssl_certificate_path`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-ssl_certificate_path) | a valid filesystem path | No |
| [`ssl_version`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-ssl_version) | [string](/lsr/value-types.md#string) | No |
| [`subscription_retry_interval_seconds`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-subscription_retry_interval_seconds) | [number](/lsr/value-types.md#number) | Yes |
| [`threads`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-threads) | [number](/lsr/value-types.md#number) | No |
| [`user`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-user) | [string](/lsr/value-types.md#string) | No |
| [`vhost`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-vhost) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](plugins-inputs-rabbitmq.md#plugins-inputs-rabbitmq-type) | [string](/lsr/value-types.md#string) | No |
