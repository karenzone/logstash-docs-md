...
* Plugin version: v4.1.0 ([Other versions](/vpr/filter-elapsed-index.md))
...
This plugin supports the following configuration options plus the [Common options](plugins-filters-elapsed.md#plugins-filters-elapsed-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`end_tag`](plugins-filters-elapsed.md#plugins-filters-elapsed-end_tag) | [string](/lsr/value-types.md#string) | Yes |
| [`new_event_on_match`](plugins-filters-elapsed.md#plugins-filters-elapsed-new_event_on_match) | [boolean](/lsr/value-types.md#boolean) | No |
| [`start_tag`](plugins-filters-elapsed.md#plugins-filters-elapsed-start_tag) | [string](/lsr/value-types.md#string) | Yes |
| [`timeout`](plugins-filters-elapsed.md#plugins-filters-elapsed-timeout) | [number](/lsr/value-types.md#number) | No |
| [`unique_id_field`](plugins-filters-elapsed.md#plugins-filters-elapsed-unique_id_field) | [string](/lsr/value-types.md#string) | Yes |
| [`keep_start_event`](plugins-filters-elapsed.md#plugins-filters-elapsed-keep_start_event) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-elapsed.md#plugins-filters-elapsed-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-elapsed.md#plugins-filters-elapsed-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-elapsed.md#plugins-filters-elapsed-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-elapsed.md#plugins-filters-elapsed-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-elapsed.md#plugins-filters-elapsed-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-elapsed.md#plugins-filters-elapsed-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-elapsed.md#plugins-filters-elapsed-remove_tag) | [array](/lsr/value-types.md#array) | No |
