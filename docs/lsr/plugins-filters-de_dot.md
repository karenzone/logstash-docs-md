...
* Plugin version: v1.1.0 ([Other versions](/vpr/filter-de_dot-index.md))
...
| :- | :- | :- |
| [`fields`](plugins-filters-de_dot.md#plugins-filters-de_dot-fields) | [array](/lsr/value-types.md#array) | No |
| [`nested`](plugins-filters-de_dot.md#plugins-filters-de_dot-nested) | [boolean](/lsr/value-types.md#boolean) | No |
| [`recursive`](plugins-filters-de_dot.md#plugins-filters-de_dot-recursive) | [boolean](/lsr/value-types.md#boolean) | No |
| [`separator`](plugins-filters-de_dot.md#plugins-filters-de_dot-separator) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-de_dot.md#plugins-filters-de_dot-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-de_dot.md#plugins-filters-de_dot-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-de_dot.md#plugins-filters-de_dot-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-de_dot.md#plugins-filters-de_dot-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-de_dot.md#plugins-filters-de_dot-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-de_dot.md#plugins-filters-de_dot-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-de_dot.md#plugins-filters-de_dot-remove_tag) | [array](/lsr/value-types.md#array) | No |
