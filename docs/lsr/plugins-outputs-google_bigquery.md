...
* Plugin version: v4.6.0 ([Other versions](/vpr/output-google_bigquery-index.md))
...
| :- | :- | :- |
| [`batch_size`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-batch_size) | [number](/lsr/value-types.md#number) | No |
| [`batch_size_bytes`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-batch_size_bytes) | [number](/lsr/value-types.md#number) | No |
| [`csv_schema`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-csv_schema) | [string](/lsr/value-types.md#string) | No |
| [`dataset`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-dataset) | [string](/lsr/value-types.md#string) | Yes |
| [`date_pattern`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-date_pattern) | [string](/lsr/value-types.md#string) | No |
| [`deleter_interval_secs`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-deleter_interval_secs) | [number](/lsr/value-types.md#number) | *Deprecated* |
| [`error_directory`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-error_directory) | [string](/lsr/value-types.md#string) | Yes |
| [`flush_interval_secs`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-flush_interval_secs) | [number](/lsr/value-types.md#number) | No |
| [`ignore_unknown_values`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-ignore_unknown_values) | [boolean](/lsr/value-types.md#boolean) | No |
| [`json_key_file`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-json_key_file) | [string](/lsr/value-types.md#string) | No |
| [`json_schema`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-json_schema) | [hash](/lsr/value-types.md#hash) | No |
| [`key_password`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-key_password) | [string](/lsr/value-types.md#string) | *Deprecated* |
| [`project_id`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-project_id) | [string](/lsr/value-types.md#string) | Yes |
| [`service_account`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-service_account) | [string](/lsr/value-types.md#string) | *Deprecated* |
| [`skip_invalid_rows`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-skip_invalid_rows) | [boolean](/lsr/value-types.md#boolean) | No |
| [`table_prefix`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-table_prefix) | [string](/lsr/value-types.md#string) | No |
| [`table_separator`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-table_separator) | [string](/lsr/value-types.md#string) | No |
| [`temp_directory`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-temp_directory) | [string](/lsr/value-types.md#string) | *Deprecated* |
| [`temp_file_prefix`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-temp_file_prefix) | [string](/lsr/value-types.md#string) | *Deprecated* |
| [`uploader_interval_secs`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-uploader_interval_secs) | [number](/lsr/value-types.md#number) | *Deprecated* |
...
Time pattern for BigQuery table, defaults to hourly tables. Must Time.strftime patterns: [www.ruby-doc.org/core-2.0/Time.html#method-i-strftime](http://www.ruby-doc.org/core-2.0/Time.html#method-i-strftime)
...
Replaces [`key_password`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-key_password) and [`service_account`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-service_account).
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-outputs-google_bigquery.md#plugins-outputs-google_bigquery-id) | [string](/lsr/value-types.md#string) | No |
