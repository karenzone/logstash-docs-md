...
* Plugin version: v3.1.0 ([Other versions](/vpr/output-websocket-index.md))
...
| :- | :- | :- |
| [`host`](plugins-outputs-websocket.md#plugins-outputs-websocket-host) | [string](/lsr/value-types.md#string) | No |
| [`port`](plugins-outputs-websocket.md#plugins-outputs-websocket-port) | [number](/lsr/value-types.md#number) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-websocket.md#plugins-outputs-websocket-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-websocket.md#plugins-outputs-websocket-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-outputs-websocket.md#plugins-outputs-websocket-id) | [string](/lsr/value-types.md#string) | No |
