...
* Plugin version: v1.2.0 ([Other versions](/vpr/filter-memcached-index.md))
...
| :- | :- | :- |
| [`hosts`](plugins-filters-memcached.md#plugins-filters-memcached-hosts) | [array](/lsr/value-types.md#array) | No |
| [`namespace`](plugins-filters-memcached.md#plugins-filters-memcached-namespace) | [string](/lsr/value-types.md#string) | No |
| [`get`](plugins-filters-memcached.md#plugins-filters-memcached-get) | [hash](/lsr/value-types.md#hash) | No |
| [`set`](plugins-filters-memcached.md#plugins-filters-memcached-set) | [hash](/lsr/value-types.md#hash) | No |
| [`tag_on_failure`](plugins-filters-memcached.md#plugins-filters-memcached-tag_on_failure) | [string](/lsr/value-types.md#string) | No |
| [`ttl`](plugins-filters-memcached.md#plugins-filters-memcached-ttl) | [number](/lsr/value-types.md#number) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-memcached.md#plugins-filters-memcached-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-memcached.md#plugins-filters-memcached-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-memcached.md#plugins-filters-memcached-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-memcached.md#plugins-filters-memcached-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-memcached.md#plugins-filters-memcached-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-memcached.md#plugins-filters-memcached-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-memcached.md#plugins-filters-memcached-remove_tag) | [array](/lsr/value-types.md#array) | No |
