...
* Plugin version: v3.1.3 ([Other versions](/vpr/filter-cidr-index.md))
...
| :- | :- | :- |
| [`address`](plugins-filters-cidr.md#plugins-filters-cidr-address) | [array](/lsr/value-types.md#array) | No |
| [`network`](plugins-filters-cidr.md#plugins-filters-cidr-network) | [array](/lsr/value-types.md#array) | No |
| [`network_path`](plugins-filters-cidr.md#plugins-filters-cidr-network_path) | a valid filesystem path | No |
| [`refresh_interval`](plugins-filters-cidr.md#plugins-filters-cidr-refresh_interval) | [number](/lsr/value-types.md#number) | No |
| [`separator`](plugins-filters-cidr.md#plugins-filters-cidr-separator) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-cidr.md#plugins-filters-cidr-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-cidr.md#plugins-filters-cidr-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-cidr.md#plugins-filters-cidr-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-cidr.md#plugins-filters-cidr-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-cidr.md#plugins-filters-cidr-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-cidr.md#plugins-filters-cidr-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-cidr.md#plugins-filters-cidr-remove_tag) | [array](/lsr/value-types.md#array) | No |
