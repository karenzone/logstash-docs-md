...
| :- | :- | :- |
| [`community`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-community) | [array](/lsr/value-types.md#array) | No |
| [`ecs_compatibility`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`host`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-host) | [string](/lsr/value-types.md#string) | No |
| [`mib_paths`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-mib_paths) | [path](/lsr/value-types.md#path) | No |
| [`oid_mapping_format`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-oid_mapping_format) | [string](/lsr/value-types.md#string), one of `["default", "ruby_snmp", "dotted_string"]` | No |
| [`oid_map_field_values`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-oid_map_field_values) | [boolean](/lsr/value-types.md#boolean) | Yes |
| [`oid_path_length`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-oid_path_length) | [number](/lsr/value-types.md#number) | No |
| [`oid_root_skip`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-oid_root_skip) | [number](/lsr/value-types.md#number) | No |
| [`port`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-port) | [number](/lsr/value-types.md#number) | No |
| [`supported_transports`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-supported_transports) | [string](/lsr/value-types.md#string) | No |
| [`supported_versions`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-supported_versions) | [string](/lsr/value-types.md#string) | No |
| [`target`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-target) | [string](/lsr/value-types.md#string) | No |
| [`threads`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-threads) | [number](/lsr/value-types.md#number) | No |
| [`use_provided_mibs`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-use_provided_mibs) | [boolean](/lsr/value-types.md#boolean) | No |
| [`yamlmibdir`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-yamlmibdir) | [string](/lsr/value-types.md#string) | *Deprecated* |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](plugins-inputs-snmptrap.md#plugins-inputs-snmptrap-type) | [string](/lsr/value-types.md#string) | No |
