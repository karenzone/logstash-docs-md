...
| :- | :- | :- |
| [`clean_run`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-clean_run) | [boolean](/lsr/value-types.md#boolean) | No |
...
| [`jdbc_driver_library`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-jdbc_driver_library) | [string](/lsr/value-types.md#string) | No |
| [`jdbc_fetch_size`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-jdbc_fetch_size) | [number](/lsr/value-types.md#number) | No |
| [`jdbc_page_size`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-jdbc_page_size) | [number](/lsr/value-types.md#number) | No |
| [`jdbc_paging_enabled`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-jdbc_paging_enabled) | [boolean](/lsr/value-types.md#boolean) | No |
| [`jdbc_paging_mode`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-jdbc_paging_mode) | [string](/lsr/value-types.md#string), one of `["auto", "explicit"]` | No |
| [`jdbc_password`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-jdbc_password) | [password](/lsr/value-types.md#password) | No |
| [`jdbc_password_filepath`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-jdbc_password_filepath) | a valid filesystem path | No |
| [`jdbc_pool_timeout`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-jdbc_pool_timeout) | [number](/lsr/value-types.md#number) | No |
| [`jdbc_user`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-jdbc_user) | [string](/lsr/value-types.md#string) | Yes |
| [`jdbc_validate_connection`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-jdbc_validate_connection) | [boolean](/lsr/value-types.md#boolean) | No |
| [`jdbc_validation_timeout`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-jdbc_validation_timeout) | [number](/lsr/value-types.md#number) | No |
...
| [`record_last_run`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-record_last_run) | [boolean](/lsr/value-types.md#boolean) | No |
| [`schedule`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-schedule) | [string](/lsr/value-types.md#string) | No |
| [`sequel_opts`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-sequel_opts) | [hash](/lsr/value-types.md#hash) | No |
| [`sql_log_level`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-sql_log_level) | [string](/lsr/value-types.md#string), one of `["fatal", "error", "warn", "info", "debug"]` | No |
| [`statement`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-statement) | [string](/lsr/value-types.md#string) | No |
| [`statement_filepath`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-statement_filepath) | a valid filesystem path | No |
| [`statement_retry_attempts`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-statement_retry_attempts) | [number](/lsr/value-types.md#number) | No |
| [`statement_retry_attempts_wait_time`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-statement_retry_attempts_wait_time) | [number](/lsr/value-types.md#number) | No |
...
| [`tracking_column`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-tracking_column) | [string](/lsr/value-types.md#string) | No |
| [`tracking_column_type`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-tracking_column_type) | [string](/lsr/value-types.md#string), one of `["numeric", "timestamp"]` | No |
| [`use_column_value`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-use_column_value) | [boolean](/lsr/value-types.md#boolean) | No |
| [`use_prepared_statements`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-use_prepared_statements) | [boolean](/lsr/value-types.md#boolean) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](plugins-inputs-jdbc.md#plugins-inputs-jdbc-type) | [string](/lsr/value-types.md#string) | No |
