...
* Plugin version: v3.1.7 ([Other versions](/vpr/input-xmpp-index.md))
...
| :- | :- | :- |
| [`host`](plugins-inputs-xmpp.md#plugins-inputs-xmpp-host) | [string](/lsr/value-types.md#string) | No |
| [`password`](plugins-inputs-xmpp.md#plugins-inputs-xmpp-password) | [password](/lsr/value-types.md#password) | Yes |
| [`rooms`](plugins-inputs-xmpp.md#plugins-inputs-xmpp-rooms) | [array](/lsr/value-types.md#array) | No |
| [`user`](plugins-inputs-xmpp.md#plugins-inputs-xmpp-user) | [string](/lsr/value-types.md#string) | Yes |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-xmpp.md#plugins-inputs-xmpp-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](plugins-inputs-xmpp.md#plugins-inputs-xmpp-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-xmpp.md#plugins-inputs-xmpp-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-inputs-xmpp.md#plugins-inputs-xmpp-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](plugins-inputs-xmpp.md#plugins-inputs-xmpp-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](plugins-inputs-xmpp.md#plugins-inputs-xmpp-type) | [string](/lsr/value-types.md#string) | No |
