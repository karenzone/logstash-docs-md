...
* Plugin version: v3.0.7 ([Other versions](/vpr/filter-sleep-index.md))
...
| :- | :- | :- |
| [`every`](plugins-filters-sleep.md#plugins-filters-sleep-every) | [string](/lsr/value-types.md#string) | No |
| [`replay`](plugins-filters-sleep.md#plugins-filters-sleep-replay) | [boolean](/lsr/value-types.md#boolean) | No |
| [`time`](plugins-filters-sleep.md#plugins-filters-sleep-time) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-sleep.md#plugins-filters-sleep-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-sleep.md#plugins-filters-sleep-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-sleep.md#plugins-filters-sleep-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-sleep.md#plugins-filters-sleep-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-sleep.md#plugins-filters-sleep-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-sleep.md#plugins-filters-sleep-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-sleep.md#plugins-filters-sleep-remove_tag) | [array](/lsr/value-types.md#array) | No |
