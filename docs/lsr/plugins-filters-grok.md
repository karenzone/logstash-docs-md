...
* Plugin version: v4.4.3 ([Other versions](/vpr/filter-grok-index.md))
...
| :- | :- | :- |
| [`break_on_match`](plugins-filters-grok.md#plugins-filters-grok-break_on_match) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ecs_compatibility`](plugins-filters-grok.md#plugins-filters-grok-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`keep_empty_captures`](plugins-filters-grok.md#plugins-filters-grok-keep_empty_captures) | [boolean](/lsr/value-types.md#boolean) | No |
| [`match`](plugins-filters-grok.md#plugins-filters-grok-match) | [hash](/lsr/value-types.md#hash) | No |
| [`named_captures_only`](plugins-filters-grok.md#plugins-filters-grok-named_captures_only) | [boolean](/lsr/value-types.md#boolean) | No |
| [`overwrite`](plugins-filters-grok.md#plugins-filters-grok-overwrite) | [array](/lsr/value-types.md#array) | No |
| [`pattern_definitions`](plugins-filters-grok.md#plugins-filters-grok-pattern_definitions) | [hash](/lsr/value-types.md#hash) | No |
| [`patterns_dir`](plugins-filters-grok.md#plugins-filters-grok-patterns_dir) | [array](/lsr/value-types.md#array) | No |
| [`patterns_files_glob`](plugins-filters-grok.md#plugins-filters-grok-patterns_files_glob) | [string](/lsr/value-types.md#string) | No |
| [`tag_on_failure`](plugins-filters-grok.md#plugins-filters-grok-tag_on_failure) | [array](/lsr/value-types.md#array) | No |
| [`tag_on_timeout`](plugins-filters-grok.md#plugins-filters-grok-tag_on_timeout) | [string](/lsr/value-types.md#string) | No |
| [`timeout_millis`](plugins-filters-grok.md#plugins-filters-grok-timeout_millis) | [number](/lsr/value-types.md#number) | No |
| [`timeout_scope`](plugins-filters-grok.md#plugins-filters-grok-timeout_scope) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-grok.md#plugins-filters-grok-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-grok.md#plugins-filters-grok-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-grok.md#plugins-filters-grok-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-grok.md#plugins-filters-grok-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-grok.md#plugins-filters-grok-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-grok.md#plugins-filters-grok-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-grok.md#plugins-filters-grok-remove_tag) | [array](/lsr/value-types.md#array) | No |
