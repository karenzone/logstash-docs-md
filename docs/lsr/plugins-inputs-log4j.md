...
* Plugin version: v3.1.3 ([Other versions](/vpr/input-log4j-index.md))
...
| :- | :- | :- |
| [`host`](plugins-inputs-log4j.md#plugins-inputs-log4j-host) | [string](/lsr/value-types.md#string) | No |
| [`mode`](plugins-inputs-log4j.md#plugins-inputs-log4j-mode) | [string](/lsr/value-types.md#string), one of `["server", "client"]` | No |
| [`port`](plugins-inputs-log4j.md#plugins-inputs-log4j-port) | [number](/lsr/value-types.md#number) | No |
| [`proxy_protocol`](plugins-inputs-log4j.md#plugins-inputs-log4j-proxy_protocol) | [boolean](/lsr/value-types.md#boolean) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-log4j.md#plugins-inputs-log4j-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](plugins-inputs-log4j.md#plugins-inputs-log4j-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-log4j.md#plugins-inputs-log4j-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-inputs-log4j.md#plugins-inputs-log4j-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](plugins-inputs-log4j.md#plugins-inputs-log4j-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](plugins-inputs-log4j.md#plugins-inputs-log4j-type) | [string](/lsr/value-types.md#string) | No |
