...
* **lookups**
  ...
  2. Defines the columns, types, and indexes used to build the local database structure. The column names and types should match the external database. The order of table definitions is significant and should match that of the loader queries. See [Loader column and local_db_object order dependency](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-object_order).
...
This plugin supports the following configuration options plus the [Common options](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-common-options) described later.

| Setting | Input type | Required |
| :- | :- | :- |
| [`jdbc_connection_string`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-jdbc_connection_string) | [string](/lsr/value-types.md#string) | Yes |
| [`jdbc_driver_class`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-jdbc_driver_class) | [string](/lsr/value-types.md#string) | Yes |
...
| [`jdbc_password`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-jdbc_password) | [password](/lsr/value-types.md#password) | No |
| [`jdbc_user`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-jdbc_user) | [string](/lsr/value-types.md#string) | No |
| [`tag_on_failure`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-tag_on_failure) | [array](/lsr/value-types.md#array) | No |
| [`tag_on_default_use`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-tag_on_default_use) | [array](/lsr/value-types.md#array) | No |
| [`staging_directory`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-staging_directory) | [string](/lsr/value-types.md#string) | No |
| [`loader_schedule`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-loader_schedule) | [string](/lsr/value-types.md#string) | No |
| [`loaders`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-loaders) | [array](/lsr/value-types.md#array) | No |
| [`local_db_objects`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-local_db_objects) | [array](/lsr/value-types.md#array) | No |
| [`local_lookups`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-local_lookups) | [array](/lsr/value-types.md#array) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-jdbc_static.md#plugins-filters-jdbc_static-remove_tag) | [array](/lsr/value-types.md#array) | No |
