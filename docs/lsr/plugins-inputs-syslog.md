...
* Plugin version: v3.7.1 ([Other versions](/vpr/input-syslog-index.md))
...
| :- | :- | :- |
| [`ecs_compatibility`](plugins-inputs-syslog.md#plugins-inputs-syslog-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`facility_labels`](plugins-inputs-syslog.md#plugins-inputs-syslog-facility_labels) | [array](/lsr/value-types.md#array) | No |
| [`grok_pattern`](plugins-inputs-syslog.md#plugins-inputs-syslog-grok_pattern) | [string](/lsr/value-types.md#string) | No |
| [`host`](plugins-inputs-syslog.md#plugins-inputs-syslog-host) | [string](/lsr/value-types.md#string) | No |
| [`locale`](plugins-inputs-syslog.md#plugins-inputs-syslog-locale) | [string](/lsr/value-types.md#string) | No |
| [`port`](plugins-inputs-syslog.md#plugins-inputs-syslog-port) | [number](/lsr/value-types.md#number) | No |
| [`proxy_protocol`](plugins-inputs-syslog.md#plugins-inputs-syslog-proxy_protocol) | [boolean](/lsr/value-types.md#boolean) | No |
| [`severity_labels`](plugins-inputs-syslog.md#plugins-inputs-syslog-severity_labels) | [array](/lsr/value-types.md#array) | No |
| [`syslog_field`](plugins-inputs-syslog.md#plugins-inputs-syslog-syslog_field) | [string](/lsr/value-types.md#string) | No |
| [`timezone`](plugins-inputs-syslog.md#plugins-inputs-syslog-timezone) | [string](/lsr/value-types.md#string) | No |
| [`use_labels`](plugins-inputs-syslog.md#plugins-inputs-syslog-use_labels) | [boolean](/lsr/value-types.md#boolean) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-syslog.md#plugins-inputs-syslog-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](plugins-inputs-syslog.md#plugins-inputs-syslog-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-syslog.md#plugins-inputs-syslog-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-inputs-syslog.md#plugins-inputs-syslog-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](plugins-inputs-syslog.md#plugins-inputs-syslog-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](plugins-inputs-syslog.md#plugins-inputs-syslog-type) | [string](/lsr/value-types.md#string) | No |
