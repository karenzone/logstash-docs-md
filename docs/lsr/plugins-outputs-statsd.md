...
* Plugin version: v3.2.0 ([Other versions](/vpr/output-statsd-index.md))
...
| :- | :- | :- |
| [`count`](plugins-outputs-statsd.md#plugins-outputs-statsd-count) | [hash](/lsr/value-types.md#hash) | No |
| [`decrement`](plugins-outputs-statsd.md#plugins-outputs-statsd-decrement) | [array](/lsr/value-types.md#array) | No |
| [`gauge`](plugins-outputs-statsd.md#plugins-outputs-statsd-gauge) | [hash](/lsr/value-types.md#hash) | No |
| [`host`](plugins-outputs-statsd.md#plugins-outputs-statsd-host) | [string](/lsr/value-types.md#string) | No |
| [`increment`](plugins-outputs-statsd.md#plugins-outputs-statsd-increment) | [array](/lsr/value-types.md#array) | No |
| [`namespace`](plugins-outputs-statsd.md#plugins-outputs-statsd-namespace) | [string](/lsr/value-types.md#string) | No |
| [`port`](plugins-outputs-statsd.md#plugins-outputs-statsd-port) | [number](/lsr/value-types.md#number) | No |
| [`sample_rate`](plugins-outputs-statsd.md#plugins-outputs-statsd-sample_rate) | [number](/lsr/value-types.md#number) | No |
| [`sender`](plugins-outputs-statsd.md#plugins-outputs-statsd-sender) | [string](/lsr/value-types.md#string) | No |
| [`set`](plugins-outputs-statsd.md#plugins-outputs-statsd-set) | [hash](/lsr/value-types.md#hash) | No |
| [`timing`](plugins-outputs-statsd.md#plugins-outputs-statsd-timing) | [hash](/lsr/value-types.md#hash) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-statsd.md#plugins-outputs-statsd-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-statsd.md#plugins-outputs-statsd-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-outputs-statsd.md#plugins-outputs-statsd-id) | [string](/lsr/value-types.md#string) | No |
