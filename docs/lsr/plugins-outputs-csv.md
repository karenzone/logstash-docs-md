...
| :- | :- | :- |
| [`create_if_deleted`](plugins-outputs-csv.md#plugins-outputs-csv-create_if_deleted) | [boolean](/lsr/value-types.md#boolean) | No |
| [`csv_options`](plugins-outputs-csv.md#plugins-outputs-csv-csv_options) | [hash](/lsr/value-types.md#hash) | No |
| [`dir_mode`](plugins-outputs-csv.md#plugins-outputs-csv-dir_mode) | [number](/lsr/value-types.md#number) | No |
| [`fields`](plugins-outputs-csv.md#plugins-outputs-csv-fields) | [array](/lsr/value-types.md#array) | Yes |
| [`file_mode`](plugins-outputs-csv.md#plugins-outputs-csv-file_mode) | [number](/lsr/value-types.md#number) | No |
| [`filename_failure`](plugins-outputs-csv.md#plugins-outputs-csv-filename_failure) | [string](/lsr/value-types.md#string) | No |
| [`flush_interval`](plugins-outputs-csv.md#plugins-outputs-csv-flush_interval) | [number](/lsr/value-types.md#number) | No |
| [`gzip`](plugins-outputs-csv.md#plugins-outputs-csv-gzip) | [boolean](/lsr/value-types.md#boolean) | No |
| [`path`](plugins-outputs-csv.md#plugins-outputs-csv-path) | [string](/lsr/value-types.md#string) | Yes |
| [`spreadsheet_safe`](plugins-outputs-csv.md#plugins-outputs-csv-spreadsheet_safe) | [boolean](/lsr/value-types.md#boolean) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-csv.md#plugins-outputs-csv-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-csv.md#plugins-outputs-csv-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-outputs-csv.md#plugins-outputs-csv-id) | [string](/lsr/value-types.md#string) | No |
