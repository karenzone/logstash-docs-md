...
* Plugin version: v3.1.4 ([Other versions](/vpr/input-ganglia-index.md))
...
| :- | :- | :- |
| [`host`](plugins-inputs-ganglia.md#plugins-inputs-ganglia-host) | [string](/lsr/value-types.md#string) | No |
| [`port`](plugins-inputs-ganglia.md#plugins-inputs-ganglia-port) | [number](/lsr/value-types.md#number) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-ganglia.md#plugins-inputs-ganglia-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](plugins-inputs-ganglia.md#plugins-inputs-ganglia-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-ganglia.md#plugins-inputs-ganglia-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-inputs-ganglia.md#plugins-inputs-ganglia-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](plugins-inputs-ganglia.md#plugins-inputs-ganglia-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](plugins-inputs-ganglia.md#plugins-inputs-ganglia-type) | [string](/lsr/value-types.md#string) | No |
