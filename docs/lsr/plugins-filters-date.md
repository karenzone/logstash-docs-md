...
* Plugin version: v3.1.15 ([Other versions](/vpr/filter-date-index.md))
...
| :- | :- | :- |
| [`locale`](plugins-filters-date.md#plugins-filters-date-locale) | [string](/lsr/value-types.md#string) | No |
| [`match`](plugins-filters-date.md#plugins-filters-date-match) | [array](/lsr/value-types.md#array) | No |
| [`tag_on_failure`](plugins-filters-date.md#plugins-filters-date-tag_on_failure) | [array](/lsr/value-types.md#array) | No |
| [`target`](plugins-filters-date.md#plugins-filters-date-target) | [string](/lsr/value-types.md#string) | No |
| [`timezone`](plugins-filters-date.md#plugins-filters-date-timezone) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-date.md#plugins-filters-date-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-date.md#plugins-filters-date-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-date.md#plugins-filters-date-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-date.md#plugins-filters-date-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-date.md#plugins-filters-date-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-date.md#plugins-filters-date-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-date.md#plugins-filters-date-remove_tag) | [array](/lsr/value-types.md#array) | No |
