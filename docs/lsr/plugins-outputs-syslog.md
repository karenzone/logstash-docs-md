...
* Plugin version: v3.0.5 ([Other versions](/vpr/output-syslog-index.md))
...
| :- | :- | :- |
| [`appname`](plugins-outputs-syslog.md#plugins-outputs-syslog-appname) | [string](/lsr/value-types.md#string) | No |
| [`facility`](plugins-outputs-syslog.md#plugins-outputs-syslog-facility) | [string](/lsr/value-types.md#string) | No |
| [`host`](plugins-outputs-syslog.md#plugins-outputs-syslog-host) | [string](/lsr/value-types.md#string) | Yes |
| [`message`](plugins-outputs-syslog.md#plugins-outputs-syslog-message) | [string](/lsr/value-types.md#string) | No |
| [`msgid`](plugins-outputs-syslog.md#plugins-outputs-syslog-msgid) | [string](/lsr/value-types.md#string) | No |
| [`port`](plugins-outputs-syslog.md#plugins-outputs-syslog-port) | [number](/lsr/value-types.md#number) | Yes |
| [`priority`](plugins-outputs-syslog.md#plugins-outputs-syslog-priority) | [string](/lsr/value-types.md#string) | No |
| [`procid`](plugins-outputs-syslog.md#plugins-outputs-syslog-procid) | [string](/lsr/value-types.md#string) | No |
| [`protocol`](plugins-outputs-syslog.md#plugins-outputs-syslog-protocol) | [string](/lsr/value-types.md#string), one of `["tcp", "udp", "ssl-tcp"]` | No |
| [`reconnect_interval`](plugins-outputs-syslog.md#plugins-outputs-syslog-reconnect_interval) | [number](/lsr/value-types.md#number) | No |
| [`rfc`](plugins-outputs-syslog.md#plugins-outputs-syslog-rfc) | [string](/lsr/value-types.md#string), one of `["rfc3164", "rfc5424"]` | No |
| [`severity`](plugins-outputs-syslog.md#plugins-outputs-syslog-severity) | [string](/lsr/value-types.md#string) | No |
| [`sourcehost`](plugins-outputs-syslog.md#plugins-outputs-syslog-sourcehost) | [string](/lsr/value-types.md#string) | No |
...
| [`ssl_key_passphrase`](plugins-outputs-syslog.md#plugins-outputs-syslog-ssl_key_passphrase) | [password](/lsr/value-types.md#password) | No |
| [`ssl_verify`](plugins-outputs-syslog.md#plugins-outputs-syslog-ssl_verify) | [boolean](/lsr/value-types.md#boolean) | No |
| [`use_labels`](plugins-outputs-syslog.md#plugins-outputs-syslog-use_labels) | [boolean](/lsr/value-types.md#boolean) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-syslog.md#plugins-outputs-syslog-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-syslog.md#plugins-outputs-syslog-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-outputs-syslog.md#plugins-outputs-syslog-id) | [string](/lsr/value-types.md#string) | No |
