...
* Plugin version: v1.0.3 ([Other versions](/vpr/filter-age-index.md))
...
| :- | :- | :- |
| [`target`](plugins-filters-age.md#plugins-filters-age-target) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-age.md#plugins-filters-age-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-age.md#plugins-filters-age-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-age.md#plugins-filters-age-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-age.md#plugins-filters-age-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-age.md#plugins-filters-age-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-age.md#plugins-filters-age-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-age.md#plugins-filters-age-remove_tag) | [array](/lsr/value-types.md#array) | No |
