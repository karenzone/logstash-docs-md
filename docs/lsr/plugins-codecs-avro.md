...
* Plugin version: v3.4.1 ([Other versions](/vpr/codec-avro-index.md))
...
| :- | :- | :- |
| [`ecs_compatibility`](plugins-codecs-avro.md#plugins-codecs-avro-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`encoding`](plugins-codecs-avro.md#plugins-codecs-avro-encoding) | [string](/lsr/value-types.md#string), one of `["binary", "base64"]` | No |
| [`schema_uri`](plugins-codecs-avro.md#plugins-codecs-avro-schema_uri) | [string](/lsr/value-types.md#string) | Yes |
| [`tag_on_failure`](plugins-codecs-avro.md#plugins-codecs-avro-tag_on_failure) | [boolean](/lsr/value-types.md#boolean) | No |
| [`target`](plugins-codecs-avro.md#plugins-codecs-avro-target) | [string](/lsr/value-types.md#string) | No |
