...
* Plugin version: v6.2.8 ([Other versions](/vpr/codec-cef-index.md))
...
The ECS Compatibility mode for a specific plugin instance can be controlled by setting [`ecs_compatibility`](plugins-codecs-cef.md#plugins-codecs-cef-ecs_compatibility) when defining the codec:
...
* When the timestamp does not include UTC-offset information, we use the event’s timezone (`dtz` or `deviceTimeZone` field), or fall through to this plugin’s [`default_timezone`](plugins-codecs-cef.md#plugins-codecs-cef-default_timezone).
* Localized timestamps are parsed using the provided [`locale`](plugins-codecs-cef.md#plugins-codecs-cef-locale).
...
| :- | :- | :- |
| [`default_timezone`](plugins-codecs-cef.md#plugins-codecs-cef-default_timezone) | [string](/lsr/value-types.md#string) | No |
| [`delimiter`](plugins-codecs-cef.md#plugins-codecs-cef-delimiter) | [string](/lsr/value-types.md#string) | No |
| [`device`](plugins-codecs-cef.md#plugins-codecs-cef-device) | [string](/lsr/value-types.md#string) | No |
| [`ecs_compatibility`](plugins-codecs-cef.md#plugins-codecs-cef-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`fields`](plugins-codecs-cef.md#plugins-codecs-cef-fields) | [array](/lsr/value-types.md#array) | No |
| [`locale`](plugins-codecs-cef.md#plugins-codecs-cef-locale) | [string](/lsr/value-types.md#string) | No |
| [`name`](plugins-codecs-cef.md#plugins-codecs-cef-name) | [string](/lsr/value-types.md#string) | No |
| [`product`](plugins-codecs-cef.md#plugins-codecs-cef-product) | [string](/lsr/value-types.md#string) | No |
| [`raw_data_field`](plugins-codecs-cef.md#plugins-codecs-cef-raw_data_field) | [string](/lsr/value-types.md#string) | No |
| [`reverse_mapping`](plugins-codecs-cef.md#plugins-codecs-cef-reverse_mapping) | [boolean](/lsr/value-types.md#boolean) | No |
| [`severity`](plugins-codecs-cef.md#plugins-codecs-cef-severity) | [string](/lsr/value-types.md#string) | No |
| [`signature`](plugins-codecs-cef.md#plugins-codecs-cef-signature) | [string](/lsr/value-types.md#string) | No |
| [`vendor`](plugins-codecs-cef.md#plugins-codecs-cef-vendor) | [string](/lsr/value-types.md#string) | No |
| [`version`](plugins-codecs-cef.md#plugins-codecs-cef-version) | [string](/lsr/value-types.md#string) | No |
...
* Option has no effect when [`ecs_compatibility => disabled`](plugins-codecs-cef.md#plugins-codecs-cef-ecs_compatibility).
