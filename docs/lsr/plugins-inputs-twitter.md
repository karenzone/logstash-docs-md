...
| :- | :- | :- |
| [`consumer_key`](plugins-inputs-twitter.md#plugins-inputs-twitter-consumer_key) | [string](/lsr/value-types.md#string) | Yes |
| [`consumer_secret`](plugins-inputs-twitter.md#plugins-inputs-twitter-consumer_secret) | [password](/lsr/value-types.md#password) | Yes |
| [`ecs_compatibility`](plugins-inputs-twitter.md#plugins-inputs-twitter-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`follows`](plugins-inputs-twitter.md#plugins-inputs-twitter-follows) | [array](/lsr/value-types.md#array) | No |
| [`full_tweet`](plugins-inputs-twitter.md#plugins-inputs-twitter-full_tweet) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ignore_retweets`](plugins-inputs-twitter.md#plugins-inputs-twitter-ignore_retweets) | [boolean](/lsr/value-types.md#boolean) | No |
| [`keywords`](plugins-inputs-twitter.md#plugins-inputs-twitter-keywords) | [array](/lsr/value-types.md#array) | No |
| [`languages`](plugins-inputs-twitter.md#plugins-inputs-twitter-languages) | [array](/lsr/value-types.md#array) | No |
| [`locations`](plugins-inputs-twitter.md#plugins-inputs-twitter-locations) | [string](/lsr/value-types.md#string) | No |
| [`oauth_token`](plugins-inputs-twitter.md#plugins-inputs-twitter-oauth_token) | [string](/lsr/value-types.md#string) | Yes |
| [`oauth_token_secret`](plugins-inputs-twitter.md#plugins-inputs-twitter-oauth_token_secret) | [password](/lsr/value-types.md#password) | Yes |
| [`proxy_address`](plugins-inputs-twitter.md#plugins-inputs-twitter-proxy_address) | [string](/lsr/value-types.md#string) | No |
| [`proxy_port`](plugins-inputs-twitter.md#plugins-inputs-twitter-proxy_port) | [number](/lsr/value-types.md#number) | No |
| [`rate_limit_reset_in`](plugins-inputs-twitter.md#plugins-inputs-twitter-rate_limit_reset_in) | [number](/lsr/value-types.md#number) | No |
| [`use_proxy`](plugins-inputs-twitter.md#plugins-inputs-twitter-use_proxy) | [boolean](/lsr/value-types.md#boolean) | No |
| [`use_samples`](plugins-inputs-twitter.md#plugins-inputs-twitter-use_samples) | [boolean](/lsr/value-types.md#boolean) | No |
| [`target`](plugins-inputs-twitter.md#plugins-inputs-twitter-target) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-twitter.md#plugins-inputs-twitter-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](plugins-inputs-twitter.md#plugins-inputs-twitter-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-twitter.md#plugins-inputs-twitter-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-inputs-twitter.md#plugins-inputs-twitter-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](plugins-inputs-twitter.md#plugins-inputs-twitter-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](plugins-inputs-twitter.md#plugins-inputs-twitter-type) | [string](/lsr/value-types.md#string) | No |
