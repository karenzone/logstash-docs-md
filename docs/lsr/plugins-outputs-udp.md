...
* Plugin version: v3.2.0 ([Other versions](/vpr/output-udp-index.md))
...
| :- | :- | :- |
| [`host`](plugins-outputs-udp.md#plugins-outputs-udp-host) | [string](/lsr/value-types.md#string) | Yes |
| [`port`](plugins-outputs-udp.md#plugins-outputs-udp-port) | [string](/lsr/value-types.md#string) | Yes |
| [`retry_count`](plugins-outputs-udp.md#plugins-outputs-udp-retry_count) | [number](/lsr/value-types.md#number) | No |
| [`retry_backoff_ms`](plugins-outputs-udp.md#plugins-outputs-udp-retry_backoff_ms) | [number](/lsr/value-types.md#number) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`codec`](plugins-outputs-udp.md#plugins-outputs-udp-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-outputs-udp.md#plugins-outputs-udp-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-outputs-udp.md#plugins-outputs-udp-id) | [string](/lsr/value-types.md#string) | No |
