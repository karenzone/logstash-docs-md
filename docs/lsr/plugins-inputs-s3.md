...
| :- | :- | :- |
| [`access_key_id`](plugins-inputs-s3.md#plugins-inputs-s3-access_key_id) | [string](/lsr/value-types.md#string) | No |
| [`additional_settings`](plugins-inputs-s3.md#plugins-inputs-s3-additional_settings) | [hash](/lsr/value-types.md#hash) | No |
| [`aws_credentials_file`](plugins-inputs-s3.md#plugins-inputs-s3-aws_credentials_file) | [string](/lsr/value-types.md#string) | No |
| [`backup_add_prefix`](plugins-inputs-s3.md#plugins-inputs-s3-backup_add_prefix) | [string](/lsr/value-types.md#string) | No |
| [`backup_to_bucket`](plugins-inputs-s3.md#plugins-inputs-s3-backup_to_bucket) | [string](/lsr/value-types.md#string) | No |
| [`backup_to_dir`](plugins-inputs-s3.md#plugins-inputs-s3-backup_to_dir) | [string](/lsr/value-types.md#string) | No |
| [`bucket`](plugins-inputs-s3.md#plugins-inputs-s3-bucket) | [string](/lsr/value-types.md#string) | Yes |
| [`delete`](plugins-inputs-s3.md#plugins-inputs-s3-delete) | [boolean](/lsr/value-types.md#boolean) | No |
| [`ecs_compatibility`](plugins-inputs-s3.md#plugins-inputs-s3-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`endpoint`](plugins-inputs-s3.md#plugins-inputs-s3-endpoint) | [string](/lsr/value-types.md#string) | No |
| [`exclude_pattern`](plugins-inputs-s3.md#plugins-inputs-s3-exclude_pattern) | [string](/lsr/value-types.md#string) | No |
| [`gzip_pattern`](plugins-inputs-s3.md#plugins-inputs-s3-gzip_pattern) | [string](/lsr/value-types.md#string) | No |
| [`include_object_properties`](plugins-inputs-s3.md#plugins-inputs-s3-include_object_properties) | [boolean](/lsr/value-types.md#boolean) | No |
| [`interval`](plugins-inputs-s3.md#plugins-inputs-s3-interval) | [number](/lsr/value-types.md#number) | No |
| [`prefix`](plugins-inputs-s3.md#plugins-inputs-s3-prefix) | [string](/lsr/value-types.md#string) | No |
| [`proxy_uri`](plugins-inputs-s3.md#plugins-inputs-s3-proxy_uri) | [string](/lsr/value-types.md#string) | No |
| [`region`](plugins-inputs-s3.md#plugins-inputs-s3-region) | [string](/lsr/value-types.md#string) | No |
| [`role_arn`](plugins-inputs-s3.md#plugins-inputs-s3-role_arn) | [string](/lsr/value-types.md#string) | No |
| [`role_session_name`](plugins-inputs-s3.md#plugins-inputs-s3-role_session_name) | [string](/lsr/value-types.md#string) | No |
| [`secret_access_key`](plugins-inputs-s3.md#plugins-inputs-s3-secret_access_key) | [string](/lsr/value-types.md#string) | No |
| [`session_token`](plugins-inputs-s3.md#plugins-inputs-s3-session_token) | [string](/lsr/value-types.md#string) | No |
| [`sincedb_path`](plugins-inputs-s3.md#plugins-inputs-s3-sincedb_path) | [string](/lsr/value-types.md#string) | No |
| [`temporary_directory`](plugins-inputs-s3.md#plugins-inputs-s3-temporary_directory) | [string](/lsr/value-types.md#string) | No |
| [`use_aws_bundled_ca`](plugins-inputs-s3.md#plugins-inputs-s3-use_aws_bundled_ca) | [boolean](/lsr/value-types.md#boolean) | No |
| [`watch_for_new_files`](plugins-inputs-s3.md#plugins-inputs-s3-watch_for_new_files) | [boolean](/lsr/value-types.md#boolean) | No |
| [`web_identity_token_file`](plugins-inputs-s3.md#plugins-inputs-s3-web_identity_token_file) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-inputs-s3.md#plugins-inputs-s3-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`codec`](plugins-inputs-s3.md#plugins-inputs-s3-codec) | [codec](/lsr/value-types.md#codec) | No |
| [`enable_metric`](plugins-inputs-s3.md#plugins-inputs-s3-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-inputs-s3.md#plugins-inputs-s3-id) | [string](/lsr/value-types.md#string) | No |
| [`tags`](plugins-inputs-s3.md#plugins-inputs-s3-tags) | [array](/lsr/value-types.md#array) | No |
| [`type`](plugins-inputs-s3.md#plugins-inputs-s3-type) | [string](/lsr/value-types.md#string) | No |
