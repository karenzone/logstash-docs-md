...
* Plugin version: v3.3.5 ([Other versions](/vpr/filter-useragent-index.md))
...
| :- | :- | :- |
| [`ecs_compatibility`](plugins-filters-useragent.md#plugins-filters-useragent-ecs_compatibility) | [string](/lsr/value-types.md#string) | No |
| [`lru_cache_size`](plugins-filters-useragent.md#plugins-filters-useragent-lru_cache_size) | [number](/lsr/value-types.md#number) | No |
| [`prefix`](plugins-filters-useragent.md#plugins-filters-useragent-prefix) | [string](/lsr/value-types.md#string) | No |
| [`regexes`](plugins-filters-useragent.md#plugins-filters-useragent-regexes) | [string](/lsr/value-types.md#string) | No |
| [`source`](plugins-filters-useragent.md#plugins-filters-useragent-source) | [string](/lsr/value-types.md#string) | Yes |
| [`target`](plugins-filters-useragent.md#plugins-filters-useragent-target) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-useragent.md#plugins-filters-useragent-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-useragent.md#plugins-filters-useragent-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-useragent.md#plugins-filters-useragent-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-useragent.md#plugins-filters-useragent-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-useragent.md#plugins-filters-useragent-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-useragent.md#plugins-filters-useragent-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-useragent.md#plugins-filters-useragent-remove_tag) | [array](/lsr/value-types.md#array) | No |
