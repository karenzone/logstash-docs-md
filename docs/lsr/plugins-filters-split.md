...
* Plugin version: v3.1.8 ([Other versions](/vpr/filter-split-index.md))
...
| :- | :- | :- |
| [`field`](plugins-filters-split.md#plugins-filters-split-field) | [string](/lsr/value-types.md#string) | No |
| [`target`](plugins-filters-split.md#plugins-filters-split-target) | [string](/lsr/value-types.md#string) | No |
| [`terminator`](plugins-filters-split.md#plugins-filters-split-terminator) | [string](/lsr/value-types.md#string) | No |
...
| Setting | Input type | Required |
| :- | :- | :- |
| [`add_field`](plugins-filters-split.md#plugins-filters-split-add_field) | [hash](/lsr/value-types.md#hash) | No |
| [`add_tag`](plugins-filters-split.md#plugins-filters-split-add_tag) | [array](/lsr/value-types.md#array) | No |
| [`enable_metric`](plugins-filters-split.md#plugins-filters-split-enable_metric) | [boolean](/lsr/value-types.md#boolean) | No |
| [`id`](plugins-filters-split.md#plugins-filters-split-id) | [string](/lsr/value-types.md#string) | No |
| [`periodic_flush`](plugins-filters-split.md#plugins-filters-split-periodic_flush) | [boolean](/lsr/value-types.md#boolean) | No |
| [`remove_field`](plugins-filters-split.md#plugins-filters-split-remove_field) | [array](/lsr/value-types.md#array) | No |
| [`remove_tag`](plugins-filters-split.md#plugins-filters-split-remove_tag) | [array](/lsr/value-types.md#array) | No |
